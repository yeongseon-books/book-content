...
- **Group**: **Lifecycle** / **Messages**: StartStream, WorkerInitRequest/Response, WorkerTerminate / **Direction**: Both ways
...
![All on one screen](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-functions-deep-dive/03/03-01-all-on-one-screen.en.png)
...
- **File**: `GrpcWorkerChannel.cs` / **Role**: The handle that represents one worker. Holds SendStartStreamMessage, SendWorkerInitRequest, SendInvocationRequest, ReceiveWorkerStatusResponse, etc.
...
![The channel layout — closer to per-worker `Channel<T>` pairs than a generic event bus](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-functions-deep-dive/03/03-02-the-channel-layout-closer-to-per-worker.en.png)
...
- [Host and Worker — who actually runs your functions (101 series, Part 3)](https://github.com/yeongseon/tech-blog/blob/bf651c9/azure-functions-101/en/03-host-and-worker.md)
