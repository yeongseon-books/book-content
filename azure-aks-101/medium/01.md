...
![The big picture — one AKS cluster at a glance](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-aks-101/01/01-01-the-big-picture-one-aks-cluster-at-a-gla.en.png)
...
![What “managed” means in practice](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-aks-101/01/01-02-what-managed-means-in-practice.en.png)
...
- **Aspect**: Control plane lifecycle / **Self-managed Kubernetes**: You own it / **AKS**: Azure owns it
- **Aspect**: Upgrade burden / **Self-managed Kubernetes**: Higher / **AKS**: Lower
- **Aspect**: Azure integration / **Self-managed Kubernetes**: Hand-assembled / **AKS**: Built-in paths
- **Aspect**: Time to first cluster / **Self-managed Kubernetes**: Slower / **AKS**: Faster
- **Aspect**: Fine-grained control / **Self-managed Kubernetes**: Higher / **AKS**: Some trade-offs
...
**Related Series**
- [Azure App Service 101](https://github.com/yeongseon/tech-blog/blob/bf651c9/azure-app-service-101/en) — useful when comparing managed Kubernetes with a higher-level web app platform
- [Azure Functions 101](https://github.com/yeongseon/tech-blog/blob/bf651c9/azure-functions-101/en) — useful when comparing serverless execution with container orchestration
