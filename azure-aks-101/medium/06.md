...
- [What is Azure Kubernetes Service? — what managed Kubernetes actually gives you](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-aks-101/en/01-what-is-aks.md)
- [Cluster architecture — control plane and node pools](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-aks-101/en/02-cluster-architecture.md)
- [Your first cluster, your first deploy — Python/FastAPI](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-aks-101/en/03-first-cluster-and-deploy.md)
- [Pod, Deployment, Service — the three ways you express a workload](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-aks-101/en/04-pod-deployment-service.md)
- [Networking and Ingress — the path in and out of the cluster](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-aks-101/en/05-networking-and-ingress.md)
...
**Related Series**
- [Azure App Service 101](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-app-service-101/en/07-scaling-101.md) — useful when comparing instance scaling with Kubernetes pod and node scaling
- [Azure Functions 101](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-functions-101/en/06-scaling-and-cold-start.md) — useful when comparing orchestrated scaling with serverless scaling
