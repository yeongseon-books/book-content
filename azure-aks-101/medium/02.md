...
![Cut the cluster in half](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-aks-101/02/02-01-cut-the-cluster-in-half.en.png)
...
![System node pool vs user node pool](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-aks-101/02/02-02-system-node-pool-vs-user-node-pool.en.png)
**System node pool**
...
- [What is Azure Kubernetes Service? — what managed Kubernetes actually gives you](./01.md)
- **Cluster architecture — control plane and node pools (current)**
- [Your first cluster, your first deploy — Python/FastAPI](./03.md)
- [Pod, Deployment, Service — the three ways you express a workload](./04.md)
- [Networking and Ingress — the path in and out of the cluster](./05.md)
- [Scaling — HPA, Cluster Autoscaler, KEDA](./06.md)
- [Monitoring and ops — Container Insights, logs, alerts](./07.md)
...
**Related Series**
- [Azure App Service 101](https://github.com/yeongseon/tech-blog/blob/bf651c9/azure-app-service-101/en) — useful when contrasting AKS with a platform that has no node concept at all
- [Azure Functions 101](https://github.com/yeongseon/tech-blog/blob/bf651c9/azure-functions-101/en) — useful when comparing orchestration with event-driven execution
