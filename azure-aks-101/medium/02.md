...
**Related Series**
- [Azure App Service 101](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-app-service-101/en) — useful when contrasting AKS with a platform that has no node concept at all
- [Azure Functions 101](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-functions-101/en) — useful when comparing orchestration with event-driven execution
