...
**Related Series**
- [Azure App Service 101](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-app-service-101/en/02-request-lifecycle.md) — useful when comparing Kubernetes service routing with a more opinionated PaaS request path
- [Azure Functions 101](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-functions-101/en/02-triggers-and-bindings.md) — useful when comparing pod-centric workloads with event-triggered execution
