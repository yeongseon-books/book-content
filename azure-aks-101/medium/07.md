...
- [Scaling — HPA, Cluster Autoscaler, KEDA](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-aks-101/en/06-scaling-hpa-ca-keda.md)
...
**Related Series**
- [Azure Functions 101](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-functions-101/en/07-monitoring-and-ops.md) — useful when comparing AKS operations with Application Insights-centric serverless operations
- [Azure App Service 101](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-app-service-101/en/06-logging-monitoring.md) — useful when comparing AKS observability with a simpler web platform model
