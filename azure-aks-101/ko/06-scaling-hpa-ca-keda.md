...
![먼저 한 장으로 정리](../../assets/azure-aks-101/06/06-01-one-diagram-first.ko.png)
...
![HPA의 결정 루프](../../assets/azure-aks-101/06/06-02-the-hpa-loop.ko.png)
...
![HPA와 CA가 같이 움직이는 모습](../../assets/azure-aks-101/06/06-03-hpa-and-cluster-autoscaler-together.ko.png)
...
![KEDA는 HPA 위에 올라간다](../../assets/azure-aks-101/06/06-04-keda-sits-on-top-of-hpa.ko.png)
이 관계를 정확히 잡아야 합니다.
