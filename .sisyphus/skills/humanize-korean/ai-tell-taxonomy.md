...
> **출처**: [epoko77-ai/im-not-ai](https://github.com/epoko77-ai/im-not-ai) — MIT License. v1.5.1 미러본.
> 이 repo에서의 적용 범위는 [`README.md`](./README.md), 빠른 참조는 [`quick-rules.md`](./quick-rules.md) 참조.
