"""Verify publication export artifacts — Medium HTML only.

Checks medium/ artifacts (.html files generated from en/ posts).

Note: This script validates Medium exports specifically. Tistory exports are validated
by check_drift.py (untracked files), and Hashnode exports use exports/hashnode/.
Asset URL correctness is verified by check_public_assets.py.
"""
