...
- [Azure Functions Deep Dive part 4 — dispatcher and invocation](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-functions-deep-dive/en/04-dispatcher-and-invocation.md)
