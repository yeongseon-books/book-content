...
![The execution path in one picture](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-aks-deep-dive/02/02-01-the-execution-path-in-one-picture.en.png)
---
...
![kubelet talks to a Unix socket](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-aks-deep-dive/02/02-02-kubelet-talks-to-a-unix-socket.en.png)
...
![Startup path as control flow](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-aks-deep-dive/02/02-03-startup-path-as-control-flow.en.png)
---
...
- [CNI and Azure CNI Overlay — where Pod IPs come from](./03.md)
- [Scheduler and Pod placement — who decides which node](./04.md)
- [HPA and Cluster Autoscaler internals — two control loops](./05.md)
- [KEDA internals — how a ScaledObject builds an HPA](./06.md)
...
- [Azure Functions Deep Dive part 3 — one bidirectional RPC stream](https://github.com/yeongseon/tech-blog/blob/bf651c9/azure-functions-deep-dive/en/03-grpc-event-stream.md)
