...
- `status`: 시리즈 상태 (planned, draft, active, complete, needs-update)

### Series Status Lifecycle

| Status | Meaning |
| --- | --- |
| `planned` | 기획 단계, 글 미작성 |
| `draft` | 초안 작성 중 |
| `active` | 본문 작성 완료, 발행 진행 중 |
| `complete` | 모든 에피소드 발행 완료 |
| `needs-update` | 내용 갱신 또는 후속 시리즈로 흡수 예정 |
- `path`: 시리즈 디렉토리 경로
