...
**핵심 질문**: *확률을 계산하기 전* 에 우리는 *무엇을 정의* 해야 할까요? *집합* 만 잘 다뤄도 확률의 *절반* 은 끝납니다.

> *모든 확률 문제는 *표본공간을 명확히 적는 순간* 절반 풀린다.*
...
1. *카드 한 장* 의 표본공간(52)을 적고 *그림카드* 사건의 확률을 구하세요.
2. *상호배반* 이지만 *독립이 아닌* 예를 적으세요.
3. *순서가 있는/없는* 추출의 표본공간 크기 차이를 적으세요.
