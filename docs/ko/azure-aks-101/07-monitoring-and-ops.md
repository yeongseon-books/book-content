...
### 관련 시리즈
- [Azure Functions 101](../azure-functions-101/07-monitoring-and-ops.md) — Application Insights 중심 운영과 비교할 때
- [Azure App Service 101](../azure-app-service-101/06-logging-monitoring.md) — 더 단순한 PaaS 운영 모델과 비교할 때
