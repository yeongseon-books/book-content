...
- 클러스터 아키텍처 — Control Plane과 Node Pool (예정)
...
### 관련 시리즈
- [Azure App Service 101](../azure-app-service-101/) — Kubernetes까지 필요하지 않은 웹 앱 운영 모델과 비교할 때
- [Azure Functions 101](../azure-functions-101/) — 서버리스와 관리형 Kubernetes의 책임 경계를 비교할 때
