...
![세 가지 AKS 네트워크 모델 비교](https://yeongseon-books.github.io/book-public-assets/assets/azure-aks-101/05/05-02-three-models-on-one-diagram.ko.png)
...
![NGINX와 AGIC의 배치 위치 차이](https://yeongseon-books.github.io/book-public-assets/assets/azure-aks-101/05/05-03-nginx-and-agic-feel-different-because-th.ko.png)
...
- [Azure App Service 101](../azure-app-service-101/02-request-lifecycle.md) — 외부 요청이 애플리케이션 인스턴스로 들어가는 경로를 비교할 때
- [Azure Functions 101](../azure-functions-101/01-what-is-azure-functions.md) — HTTP 엔드포인트 노출이 플랫폼에 더 많이 추상화된 모델과 비교할 때
