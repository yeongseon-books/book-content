...
### 관련 시리즈
- [Azure App Service 101](../azure-app-service-101/07-scaling-101.md) — 인스턴스 스케일과 Kubernetes 스케일의 차이를 비교할 때
- [Azure Functions 101](../azure-functions-101/06-scaling-and-cold-start.md) — 서버리스 스케일 모델과 비교할 때
