...
### 관련 시리즈
- [Azure Functions 101 — Host와 Worker](../azure-functions-101/03-host-and-worker.md)
- [Azure Functions 101 — 스케일링과 콜드 스타트](../azure-functions-101/06-scaling-and-cold-start.md)
- [Azure App Service Deep Dive — App Service 플랫폼 아키텍처](../azure-app-service-deep-dive/01-platform-architecture.md)
