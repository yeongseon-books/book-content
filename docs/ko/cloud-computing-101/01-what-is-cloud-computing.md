...
**핵심 질문**: *왜 우리는 직접 서버를 사지 않고* *클라우드* 를 쓰게 되었을까요?

> *클라우드 컴퓨팅 은 *컴퓨팅 자원* 을 *필요할 때 인터넷으로 빌려 쓰고 사용량만큼 지불* 하는 모델입니다.*
...
- **Elasticity**: *수요* 에 따른 *자동 확장/축소*.
- **On-demand**: *원할 때 즉시* 프로비저닝.
- **Pay-as-you-go**: *사용량 기반* 과금.
- **Shared Responsibility**: *CSP* 와 *고객* 의 *책임 경계*.
...
1. 위 코드에 *버킷 삭제* 함수를 추가하세요.
2. *리전이 가까울수록 빠른 이유* 를 한 문장으로 설명하세요.
3. *온프레미스가 더 적합한 워크로드* 를 한 가지 들어 보세요.
