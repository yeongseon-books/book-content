...
### Related Series
- [Azure App Service 101](../azure-app-service-101/) — useful when comparing managed Kubernetes with a higher-level web app platform
- [Azure Functions 101](../azure-functions-101/) — useful when comparing serverless execution with container orchestration
