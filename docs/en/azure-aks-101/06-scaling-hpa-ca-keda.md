...
### Related Series
- [Azure App Service 101](../azure-app-service-101/07-scaling-101.md) — useful when comparing instance scaling with Kubernetes pod and node scaling
- [Azure Functions 101](../azure-functions-101/06-scaling-and-cold-start.md) — useful when comparing orchestrated scaling with serverless scaling
