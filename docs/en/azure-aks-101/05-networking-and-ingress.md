...
### Related Series
- [Azure App Service 101](../azure-app-service-101/02-request-lifecycle.md) — useful when comparing cluster ingress paths with a simpler platform request path
- [Azure Functions 101](../azure-functions-101/01-what-is-azure-functions.md) — useful when comparing HTTP exposure on a more abstract execution model
