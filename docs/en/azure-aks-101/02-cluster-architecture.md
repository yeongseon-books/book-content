...
### Related Series
- [Azure App Service 101](../azure-app-service-101/) — useful when contrasting AKS with a platform that has no node concept at all
- [Azure Functions 101](../azure-functions-101/) — useful when comparing orchestration with event-driven execution
