...
### Related Series
- [Azure App Service 101](../azure-app-service-101/04-first-deploy.md) — useful when comparing the same FastAPI app on a higher-level PaaS
- [Azure Functions 101](../azure-functions-101/) — useful when comparing container deployment with function deployment
