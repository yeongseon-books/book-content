...
### Related Series
- [Azure Functions 101](../azure-functions-101/07-monitoring-and-ops.md) — useful when comparing AKS operations with Application Insights-centric serverless operations
- [Azure App Service 101](../azure-app-service-101/06-logging-monitoring.md) — useful when comparing AKS observability with a simpler web platform model
