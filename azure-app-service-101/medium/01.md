...
- **Plane**: **Management Plane** / **Role**: Configuration and settings / **Key Tools**: Azure Portal, CLI, ARM/Bicep
- **Plane**: **Runtime Plane** / **Role**: Actual request processing / **Key Tools**: Frontend + Worker instances
- **Plane**: **SCM Plane** / **Role**: Deployment and diagnostics / **Key Tools**: Kudu (`.scm.azurewebsites.net`)
...
![App Service 3-Plane architecture](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-app-service-101/01/01-three-plane-architecture.en.png)
...
![App Service request flow](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-app-service-101/01/02-request-flow.en.png)
...
- **Feature**: ZIP Deploy / **Endpoint**: `/api/zipdeploy`
- **Feature**: Deployment History / **Endpoint**: `/api/deployments`
- **Feature**: Environment Info / **Endpoint**: `/api/environment`
- **Feature**: Log Stream / **Endpoint**: `/api/logstream`
- **Feature**: File Browser / **Endpoint**: `/api/vfs/`
...
- **Aspect**: **Startup** / **Windows Code**: IIS/platform starts / **Linux Built-in**: Built-in image + command / **Linux Custom Container**: Image pull then start
- **Aspect**: **Port** / **Windows Code**: Platform managed / **Linux Built-in**: `PORT` env variable / **Linux Custom Container**: `WEBSITES_PORT` setting
- **Aspect**: **Storage** / **Windows Code**: Persistent / **Linux Built-in**: `/home` persistent / **Linux Custom Container**: Depends on config
- **Aspect**: **Diagnostics** / **Windows Code**: Rich Kudu / **Linux Built-in**: Rich Kudu / **Linux Custom Container**: SSH is primary
...
![App Service file system layout](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-app-service-101/01/03-file-system-layout.en.png)
...
- **Path**: `/home/site/wwwroot` / **Purpose**: Deployed app code
- **Path**: `/home/LogFiles` / **Purpose**: App/platform logs
- **Path**: `/home/data` / **Purpose**: App data
