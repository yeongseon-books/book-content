...
![App Service 요청 수명주기 전체 흐름](../../assets/azure-app-service-101/02/01-full-request-lifecycle.ko.png)
...
![Frontend 라우팅 결정 흐름](../../assets/azure-app-service-101/02/02-frontend-routing-decision.ko.png)
...
![Health Check 상태 전이](../../assets/azure-app-service-101/02/03-health-check-state-machine.ko.png)
...
![오류 코드와 실패 레이어 매핑](../../assets/azure-app-service-101/02/04-failure-pattern-map.ko.png)
