...
![App Service 선택 흐름도](./assets/azure-app-service-101/03/01-decision-flow.png)
...
![공유 플랜과 전용 플랜 비교](./assets/azure-app-service-101/03/03-shared-vs-dedicated.png)
...
![티어별 기능 해금 매트릭스](./assets/azure-app-service-101/03/02-tier-feature-matrix.png)
