...
![일반 LLM과 RAG의 차이](../assets/ai-web-dev-101/04/plain-llm-vs-rag.png)
...
![임베딩을 통한 의미 유사도 표현](../assets/ai-web-dev-101/04/embedding-similarity-concept.png)
...
![벡터 DB의 의미 기반 검색 원리](../assets/ai-web-dev-101/04/vector-search-flow.png)
...
![RAG 파이프라인 5단계](../assets/ai-web-dev-101/04/rag-five-step-pipeline.png)
...
![FAQ 챗봇의 RAG 동작 흐름](../assets/ai-web-dev-101/04/faq-bot-example-flow.png)
