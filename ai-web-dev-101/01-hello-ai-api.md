...
![AI API 호출의 기본 흐름](../assets/ai-web-dev-101/01/api-call-overview.png)
...
![API 응답 JSON의 핵심 필드](../assets/ai-web-dev-101/01/request-response-anatomy.png)
...
![토큰과 비용의 관계](../assets/ai-web-dev-101/01/tokens-and-cost-flow.png)
...
![번역기의 프롬프트 구성](../assets/ai-web-dev-101/01/translation-exercise-flow.png)
