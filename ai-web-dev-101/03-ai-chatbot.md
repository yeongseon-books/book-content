...
![AI 챗봇 서비스의 전체 구조](../assets/ai-web-dev-101/03/chatbot-architecture-overview.png)
...
![API Route의 요청 처리 흐름](../assets/ai-web-dev-101/03/api-route-handler-flow.png)
...
![사용자 메시지가 AI 답변으로 변환되는 과정](../assets/ai-web-dev-101/03/chat-message-roundtrip.png)
...
![useChat 훅의 상태 관리 흐름](../assets/ai-web-dev-101/03/usechat-state-flow.png)
...
![스트리밍 방식으로 답변이 전달되는 흐름](../assets/ai-web-dev-101/03/streaming-response-flow.png)
...
## 시리즈 목차
1. [Hello AI API: 터미널에서 첫 인사 나누기](./01-hello-ai-api.md)
2. [프롬프트 엔지니어링 기초: AI를 조종하는 법](./02-prompt-engineering.md)
3. **AI 챗봇 만들기: 실시간 채팅 UI 구현 (현재 글)**
4. RAG의 이해: 내 데이터를 학습한 AI 만들기 (예정)
5. 멀티모달 AI: 이미지 분석하고 생성하기 (예정)
6. AI 에이전트: 도구를 사용하는 AI (예정)
...
**Tags:** `AI` `Next.js` `Vercel AI SDK` `Chatbot` `React` `Tutorial`
