...
![HTTP request waking a function](https://yeongseon-books.github.io/book-public-assets/assets/azure-functions-101/01/01-01-start-with-the-smallest-example-hello-fu.en.png)
...
Four words run through this entire series. For now, just learn the names; later chapters unpack how each one behaves in practice.
...
- **Ultra-low-latency APIs where cold starts are unacceptable** — If hundreds of milliseconds added to the first call is a non-starter for the business, you should use the Always Ready option on Premium / Flex Consumption or look at a different model. The scaling and cold-start chapter covers that trade-off in detail.
...
This chapter focused on getting the mental model right. One-line summary:
