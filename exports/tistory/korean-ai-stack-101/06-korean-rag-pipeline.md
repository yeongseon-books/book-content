...
한국어 RAG 파이프라인을 어떻게 조합해야 정확도와 운영 안정성을 동시에 잡을까요?

이 글은 그 질문에 답하기 위해 한국어 RAG 파이프라인의 핵심 결정과 운영 함정을 살펴봅니다.
...
![핵심 흐름](https://yeongseon-books.github.io/book-public-assets/assets/korean-ai-stack-101/06/06-01-core-flow.ko.png)
...
![단순한 RAG 파이프라인의 단계별 구성](https://yeongseon-books.github.io/book-public-assets/assets/korean-ai-stack-101/06/06-01-diagram.ko.png)
...
![최소 실행 예제](https://yeongseon-books.github.io/book-public-assets/assets/korean-ai-stack-101/06/06-02-diagram-2.ko.png)
...
![이 코드에서 봐야 할 것](https://yeongseon-books.github.io/book-public-assets/assets/korean-ai-stack-101/06/06-03-diagram-3.ko.png)
...
![실무에서 헷갈리는 지점](https://yeongseon-books.github.io/book-public-assets/assets/korean-ai-stack-101/06/06-04-diagram-4.ko.png)
...
- **한국어 형태소 분석이 retrieval에 영향** — 토크나이저 정렬이 품질을 결정합니다.
- **청킹은 한국어 문장 구조에 맞춘다** — 고정 크기는 의미를 깹니다.
- **hybrid retrieval이 한국어에 강하다** — BM25와 dense embedding 결합이 효과적입니다.
- **rerank로 정밀도 보강** — 한국어 reranker 선택이 차이를 만듭니다.
- **평가 데이터셋을 한국어로** — 영어 benchmark는 한국어 신호를 못 줍니다.
