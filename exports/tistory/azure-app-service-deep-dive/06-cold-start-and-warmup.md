...
![첫 요청이 ready worker를 기다리는 경로](https://yeongseon-books.github.io/book-public-assets/assets/azure-app-service-deep-dive/06/06-01-the-cold-path-and-the-warm-path.ko.png)

*첫 요청이 ready worker를 기다리는 경로*
이 한 그림이 핵심입니다.
사용자가 느끼는 첫 요청 비용은,
