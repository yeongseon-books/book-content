...
![한 워커의 동시 호출 처리 구조](https://yeongseon-books.github.io/book-public-assets/assets/azure-functions-deep-dive/04/04-02-concurrent-invocations-one-worker-handle.ko.png)
