...
![Few-shot과 Chain-of-Thought: 더 나은 답변 유도하기](https://yeongseon-books.github.io/book-public-assets/assets/llm-app-foundations-101/04/04-01-few-shot-and-chain-of-thought-steering-b.ko.png)
...
![예시 쌍이 최종 답을 유도하는 흐름](https://yeongseon-books.github.io/book-public-assets/assets/llm-app-foundations-101/04/04-01-few-shot-prompting-teaches-by-example-in.ko.png)
...
![zero-shot과 few-shot 안정성 비교](https://yeongseon-books.github.io/book-public-assets/assets/llm-app-foundations-101/04/04-02-zero-shot-versus-few-shot-on-the-same-re.ko.png)
...
![약한 예시와 강한 예시의 차이](https://yeongseon-books.github.io/book-public-assets/assets/llm-app-foundations-101/04/04-03-example-quality-can-help-or-hurt.ko.png)
...
![단계적 판단이 최종 답에 닿는 흐름](https://yeongseon-books.github.io/book-public-assets/assets/llm-app-foundations-101/04/04-04-chain-of-thought-helps-the-model-decompo.ko.png)
...
![프롬프트 기법을 접어야 하는 판단 분기](https://yeongseon-books.github.io/book-public-assets/assets/llm-app-foundations-101/04/04-05-where-these-techniques-stop-helping.ko.png)
...
- [ ] few-shot 예시는 입력만이 아니라 원하는 출력 형식까지 포함하고 있다
- [ ] 예시 수를 1, 3, 5개로 바꿔보고 출력 안정성과 토큰 비용을 비교해 보았다
- [ ] 잘못된 답을 유도하는 "독이 되는" 예시가 섞여 있는지 검토했다
- [ ] 복합 추론 작업에는 chain-of-thought 지시어(예: "단계별로 설명")를 명시적으로 넣었다
- [ ] few-shot과 CoT를 동시에 쓸 때 토큰 사용량이 한 번의 호출 한도를 넘지 않는지 확인했다
