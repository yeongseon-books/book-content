...
![토큰 이해하기: 비용, 한계, 컨텍스트 창](https://yeongseon-books.github.io/book-public-assets/assets/llm-app-foundations-101/02/02-01-understanding-tokens-cost-limits-and-con.ko.png)
...
토큰의 본질을 이해하면 어떤 비용·한계·컨텍스트 사고를 예방할 수 있을까요?

이 글은 그 질문에 답하기 위해 토큰 이해의 핵심 결정과 운영 함정을 살펴봅니다.
...
![텍스트가 모델 토큰으로 쪼개지는 흐름](https://yeongseon-books.github.io/book-public-assets/assets/llm-app-foundations-101/02/02-01-what-a-token-actually-is.ko.png)
...
![비슷한 입력 길이와 다른 토큰 비용 비교](https://yeongseon-books.github.io/book-public-assets/assets/llm-app-foundations-101/02/02-02-why-tokens-matter-so-much.ko.png)
...
![입력 출력 총합을 나누는 usage 구조](https://yeongseon-books.github.io/book-public-assets/assets/llm-app-foundations-101/02/02-03-revisiting-usage-prompt-tokens-completio.ko.png)
...
![전송 전 토큰 수를 가늠하는 단계](https://yeongseon-books.github.io/book-public-assets/assets/llm-app-foundations-101/02/02-04-estimating-token-count-with-tiktoken.ko.png)
...
![컨텍스트 초과와 length 종료 분기](https://yeongseon-books.github.io/book-public-assets/assets/llm-app-foundations-101/02/02-05-detecting-long-prompt-problems-with-fini.ko.png)
...
- **토큰은 단어가 아니다** — tokenizer가 실제 단위입니다.
- **언어별 비용 차이를 의식** — 한국어는 영어보다 토큰이 더 듭니다.
- **입출력 토큰 가격이 다르다** — 프롬프트 길이가 비용을 좌우합니다.
- **컨텍스트 한도는 하드 리밋** — 넘으면 잘리는 게 아니라 오류입니다.
- **토큰 카운트를 사전 측정** — 사후 청구서가 사고로 다가옵니다.
