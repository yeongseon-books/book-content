...
![ACA rule과 hidden scaler 오브젝트 관계](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/04/04-01-the-short-version-a-scale-rule-is-not-th.ko.png)
...
![ACA scale fields와 KEDA 입력 대응](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/04/04-02-what-aca-exposes-versus-what-keda-needs.ko.png)
...
![Revision별 독립 스케일 제어 구조](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/04/04-03-the-first-key-behavior-scaling-is-per-re.ko.png)
...
![ScaledObject와 HPA 제어 관계](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/04/04-04-a-scaledobject-creates-hpa-behavior-not.ko.png)
...
![minReplicas 0과 scale-to-zero 활성화 경로](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/04/04-05-minreplicas-can-be-zero-and-that-changes.ko.png)
...
![Custom rule에서 replica까지 제어 루프](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/04/04-06-the-control-loop-how-a-custom-rule-becom.ko.png)
...
![HTTP concurrency와 KEDA형 스케일 모델](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/04/04-07-http-scaling-is-built-in-but-the-shape-s.ko.png)
...
![Custom rule과 KEDA scaler 번역 구조](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/04/04-08-custom-rules-are-the-clearest-keda-shape.ko.png)
...
![Scale rule auth와 제품 번역 경계](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/04/04-09-authentication-for-scale-rules-is-anothe.ko.png)
...
![HPA와 metrics adapter 연결 경로](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/04/04-10-why-the-metrics-adapter-matters-even-whe.ko.png)
...
![여러 scale rule의 개별 활성화 경로](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/04/04-11-one-rule-can-wake-the-revision-up.ko.png)
...
![Revision template에 붙는 scale rule 구조](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/04/04-12-scale-rules-belong-to-the-revision-templ.ko.png)
...
![ACA autoscaling 전체 제어 흐름](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/04/04-13-the-whole-autoscaling-picture-in-one-dia.ko.png)
