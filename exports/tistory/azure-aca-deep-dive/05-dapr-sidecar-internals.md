...
![앱 로컬 호출과 sidecar 외부 호출 구조](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-01-the-shortest-accurate-sentence.ko.png)
...
![Pod mutation 기반 sidecar 주입 흐름](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-02-start-with-the-pod-mutation-model.ko.png)
...
![주입된 daprd 프로세스와 컨테이너 구조](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-01-the-sidecar-container-is-literally-daprd.ko.png)
...
![main.go에서 runtime까지 부팅 경로](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-04-boot-path-main-go-to-app-run-to-runtime.ko.png)
...
![Dapr HTTP·gRPC 포트와 로컬 계약](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-05-the-sidecar-ports-are-concrete-and-impor.ko.png)
...
![앱과 sidecar의 localhost API 경계](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-06-why-localhost-matters-so-much.ko.png)
...
![Environment component와 sidecar 로딩 범위](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-07-component-loading-is-where-aca-s-environ.ko.png)
...
![App enablement와 environment 의존성 관계](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-08-enabling-dapr-in-aca-is-an-app-level-swi.ko.png)
...
![Building block과 운영 API의 이중 표면](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-09-dapr-is-not-only-the-building-block-apis.ko.png)
...
![App 호출과 sidecar 콜백의 양방향 채널](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-10-app-to-sidecar-and-sidecar-to-app-are-se.ko.png)
...
![Sidecar 로그와 장애 타임라인 연결](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-11-why-sidecar-logs-belong-in-your-incident.ko.png)
...
![Dapr sidecar의 전체 생명주기](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-12-putting-the-whole-sidecar-lifecycle-in-o.ko.png)
