...
![Environment 기준 격리와 공유 평면](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/02/02-01-the-environment-is-the-platform-s-isolat.ko.png)
...
![Environment 경계 안의 앱별 ingress 선택](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/02/02-02-network-scope-begins-at-the-environment.ko.png)
...
![External·internal ingress의 공통 환경 경계](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/02/02-03-external-versus-internal-ingress-still-s.ko.png)
...
![Environment 단위 로그 수집 구조](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/02/02-04-observability-is-centralized-at-the-envi.ko.png)
...
![공유 workspace와 개별 신호 생산자 관계](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/02/02-05-shared-logs-do-not-mean-all-signals-are.ko.png)
...
![Environment component와 app 소비자 관계](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/02/02-06-dapr-components-are-environment-resource.ko.png)
...
![Dapr app ID 기반 component scope 매핑](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/02/02-07-scope-means-dapr-app-id-not-container-ap.ko.png)
...
![Environment 안의 앱 간 Dapr 호출 경계](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/02/02-08-cross-app-dapr-communication-only-makes.ko.png)
...
![Environment에서 끝나는 공유 제어 루프](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/02/02-09-control-loops-that-terminate-at-the-envi.ko.png)
