...
![클라이언트부터 Pod까지 전체 ingress 경로](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/06/06-01-start-with-the-full-path-not-with-the-ap.ko.png)

*클라이언트부터 Pod까지 전체 ingress 경로*
...
![관리형 edge와 Envoy 라우팅 분리](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/06/06-02-the-load-balancer-is-the-first-managed-e.ko.png)

*관리형 edge와 Envoy 라우팅 분리*
...
![TLS 종료와 내부 HTTP 전달 경로](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/06/06-03-tls-ends-at-ingress-not-at-your-containe.ko.png)

*TLS 종료와 내부 HTTP 전달 경로*
...
![Forwarded header와 원본 요청 맥락 복원](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/06/06-04-forwarded-headers-are-part-of-the-ingres.ko.png)

*Forwarded header와 원본 요청 맥락 복원*
...
![Service 홉 이전의 Revision 라우팅 선택](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/06/06-05-the-routing-step-happens-before-the-serv.ko.png)

*Service 홉 이전의 Revision 라우팅 선택*
...
![Revision upstream에 적용되는 Envoy 가중치](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/06/06-06-envoy-weight-means-upstream-cluster-weig.ko.png)

*Revision upstream에 적용되는 Envoy 가중치*
...
![Ingress 뒤의 service-style upstream 분기](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/06/06-07-the-service-hop-is-easy-to-forget-becaus.ko.png)

*Ingress 뒤의 service-style upstream 분기*
...
![Revision readiness와 ready replica 연결](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/06/06-08-readiness-is-part-of-the-ingress-path-wh.ko.png)

*Revision readiness와 ready replica 연결*
...
![Scale-to-zero 첫 요청의 깨우기 경로](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/06/06-09-the-first-request-to-a-scale-to-zero-rev.ko.png)

*Scale-to-zero 첫 요청의 깨우기 경로*
...
![첫 요청 지연을 만드는 숨은 단계](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/06/06-10-why-the-first-request-can-feel-slower-ev.ko.png)
...
![Ingress 뒤 Pod 내부의 Dapr 참여 경로](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/06/06-11-dapr-adds-another-runtime-participant-be.ko.png)

*Ingress 뒤 Pod 내부의 Dapr 참여 경로*
...
![Internal ingress의 축약된 동일 경로](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/06/06-12-internal-ingress-follows-the-same-broad.ko.png)

*Internal ingress의 축약된 동일 경로*
...
![Ingress 장애 확인 순서](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/06/06-13-a-practical-ingress-debugging-ladder.ko.png)
...
![ACA 요청 경로의 전체 연결 구조](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/06/06-14-the-whole-request-path-in-one-diagram.ko.png)
