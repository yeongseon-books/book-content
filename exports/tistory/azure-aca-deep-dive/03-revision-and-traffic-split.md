...
Revision과 트래픽 분할은 내부적으로 어떻게 동작하고, 점진 배포 전략에 어떻게 활용해야 할까요?

이 글은 그 질문에 답하기 위해 Revision과 트래픽 분할 내부의 핵심 결정과 운영 함정을 살펴봅니다.
...
![Revision 불변 스냅샷과 트래픽 대상 구조](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/03/03-01-a-revision-is-an-immutable-runtime-snaps.ko.png)

*Revision 불변 스냅샷과 트래픽 대상 구조*
...
![Template와 configuration 변경 범위 대비](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/03/03-02-revision-scope-versus-application-scope.ko.png)

*Template와 configuration 변경 범위 대비*
...
![Revision mode별 upstream 후보 집합 차이](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/03/03-03-single-revision-mode-and-multiple-revisi.ko.png)

*Revision mode별 upstream 후보 집합 차이*
...
![Label direct path와 weight 분산 경로](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/03/03-04-labels-and-weights-solve-different-routi.ko.png)

*Label direct path와 weight 분산 경로*
운영 의미도 분명히 다릅니다.
...
![Revision weight와 Envoy weight 대응](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/03/03-05-from-revision-weight-to-envoy-weight.ko.png)

*Revision weight와 Envoy weight 대응*
...
![Ingress 앞단의 Revision 선택 지점](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/03/03-06-why-the-weight-belongs-at-the-ingress-la.ko.png)

*Ingress 앞단의 Revision 선택 지점*
...
![Readiness 이후 트래픽 전환 조건](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/03/03-07-zero-downtime-rollout-depends-on-readine.ko.png)

*Readiness 이후 트래픽 전환 조건*
...
![Multiple revision rollout의 가중치 이동 구조](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/03/03-08-multiple-revision-mode-turns-rollout-int.ko.png)

*Multiple revision rollout의 가중치 이동 구조*
...
![latestRevision과 명시적 revision 제어 차이](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/03/03-09-latestrevision-true-is-convenient-but-it.ko.png)

*latestRevision과 명시적 revision 제어 차이*
...
![Active 상태와 트래픽 수신 상태 분리](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/03/03-10-a-hidden-but-important-split-active-revi.ko.png)

*Active 상태와 트래픽 수신 상태 분리*
...
![Traffic weight와 replica scale의 관계](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/03/03-11-revision-weight-and-scale-are-related-bu.ko.png)

*Traffic weight와 replica scale의 관계*
...
![Envoy weighted cluster의 Revision 연결 구조](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/03/03-12-where-envoy-s-weighted-cluster-model-mat.ko.png)

*Envoy weighted cluster의 Revision 연결 구조*
...
![불변 Revision 기반 rollback 경로](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/03/03-13-the-rollback-story-is-better-because-rev.ko.png)

*불변 Revision 기반 rollback 경로*
...
- **Revision은 불변 단위로 보존된다** — 롤백은 새 Revision 생성이 아니라 트래픽 재배분으로 합니다.
- **트래픽 분할은 weight 기반** — 라우팅이 라벨이 아닌 비율 기반임을 이해해야 카나리 설계가 정확해집니다.
- **multiple revisions 모드는 의식적으로** — 기본 single 모드를 벗어날 때는 운영 부담이 따라옵니다.
- **자동 활성화 정책을 명시한다** — 비활성 Revision의 정리 정책이 비용과 보안에 영향을 줍니다.
- **배포 자동화에 트래픽 단계가 들어가야 한다** — 수기 슬라이딩은 사고를 만들기 쉬우므로 파이프라인화합니다.
