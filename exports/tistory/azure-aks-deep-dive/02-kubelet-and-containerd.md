...
![API server에서 runc까지 이어지는 실행 경로](https://yeongseon-books.github.io/book-public-assets/assets/azure-aks-deep-dive/02/02-01-the-execution-path-in-one-picture.ko.png)
...
![Pod 시작 순서를 따라가는 kubelet 제어 흐름](https://yeongseon-books.github.io/book-public-assets/assets/azure-aks-deep-dive/02/02-03-startup-path-as-control-flow.ko.png)

*Pod 시작 순서를 따라가는 kubelet 제어 흐름*
---
