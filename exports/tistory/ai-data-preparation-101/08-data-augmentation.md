...
- **증강은 일반화의 보조 도구** — 원본 부족을 완전히 대체하지는 못합니다.
- **task별로 적절한 기법이 다르다** — 분류·번역·생성에서 효과가 다릅니다.
- **의미 보존이 핵심 제약** — label-preserving 변환만 안전합니다.
- **증강 비율을 ablation으로** — 맹목적 증강은 성능을 떨어뜨립니다.
- **학습 시점에 동적으로** — 사전 생성보다 다양성이 큽니다.
