...
**핵심 질문**: 기술부채는 항상 나쁜 것인가요?

> 아니요. 의도적인 부채는 도구입니다. 무의식적인 부채는 사고입니다.

<!-- a-grade-intro:end -->

## 이 글에서 배울 것

- 기술부채의 4가지 유형(Martin Fowler 매트릭스)
- 부채 갚기의 우선순위 정하는 법
- 안전한 리팩터링 절차
- Deprecation을 단계적으로 제거하는 법
- 부채를 측정 가능한 지표로 다루는 법
...
- **Deliberate-Prudent**: 의식적 결정, 갚을 계획.
- **Deliberate-Reckless**: 알고도 무책임.
- **Inadvertent-Prudent**: 몰라서 생긴 부채, 학습으로 해소.
- **Inadvertent-Reckless**: 몰라서 무책임 — 가장 위험.
- **Deprecation**: 점진적 폐기 절차.
...
1. 본인 저장소에서 부채 5건을 라벨로 표시해 보세요.
2. 가장 위험한 부채 1건을 Strangler Fig로 분해 안 적어 보세요.
3. 부채 지표 대시보드 항목 5개를 정의해 보세요.
