...
**핵심 질문**: *숫자* 가 *결정* 으로 바뀌려면 무엇이 필요할까요? *대시보드* 는 *왜 자주 무시* 받을까요?

> *대시보드는 *질문에 답* 해야 한다. *데이터를 자랑* 하는 곳이 아니다.*
...
- **BI Tool**: Tableau, Looker, Power BI 등 *시각화 도구*.
- **Semantic Layer**: *지표 정의* 를 *팀이 공유* 하는 중간층.
- **KPI**: 핵심 *성과 지표* — 한 줄로 측정.
- **Drill-down**: 요약에서 *세부* 로 들어가는 분석.
- **Refresh cadence**: 대시보드가 *얼마나 자주* 갱신되는지.
...
1. *팀 대시보드* 의 KPI *3개* 를 정해 보세요.
2. *너무 많은 차트* 가 든 대시보드를 *간소화* 해 보세요.
3. *지표 정의 충돌* 을 *해결한 경험* 을 적어 보세요.
