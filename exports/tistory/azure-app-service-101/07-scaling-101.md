...
![인스턴스 크기 확장과 수평 확장의 차이](https://yeongseon-books.github.io/book-public-assets/assets/azure-app-service-101/07/01-scale-up-vs-scale-out.ko.png)
...
![병목 유형에 따른 스케일링 선택 흐름](https://yeongseon-books.github.io/book-public-assets/assets/azure-app-service-101/07/04-scaling-decision-tree.ko.png)
...
![인스턴스 증가가 의존성 부하로 번지는 흐름](https://yeongseon-books.github.io/book-public-assets/assets/azure-app-service-101/07/03-dependency-cascade.ko.png)
...
![메트릭 기반 Autoscale 판단과 조정 흐름](https://yeongseon-books.github.io/book-public-assets/assets/azure-app-service-101/07/02-autoscale-feedback-loop.ko.png)
