...
![OS와 배포 모델을 거친 플랜 선택 흐름](https://yeongseon-books.github.io/book-public-assets/assets/azure-app-service-101/03/01-decision-flow.ko.png)

*OS와 배포 모델을 거친 플랜 선택 흐름*
...
![공유 리소스와 전용 리소스의 차이](https://yeongseon-books.github.io/book-public-assets/assets/azure-app-service-101/03/03-shared-vs-dedicated.ko.png)
...
![티어별 운영 기능 해금 관계](https://yeongseon-books.github.io/book-public-assets/assets/azure-app-service-101/03/02-tier-feature-matrix.ko.png)
