...
![설정 값이 앱 환경 변수로 들어가는 흐름](https://yeongseon-books.github.io/book-public-assets/assets/azure-app-service-101/05/configuration-flow.ko.png)
...
![환경별 설정 저장 방식의 분리 전략](https://yeongseon-books.github.io/book-public-assets/assets/azure-app-service-101/05/environment-strategy.ko.png)
...
![Key Vault 비밀 값이 앱으로 들어오는 흐름](https://yeongseon-books.github.io/book-public-assets/assets/azure-app-service-101/05/key-vault-reference-flow.ko.png)
...
![슬롯 스왑 때 설정이 유지되는 조건](https://yeongseon-books.github.io/book-public-assets/assets/azure-app-service-101/05/slot-settings-behavior.ko.png)
