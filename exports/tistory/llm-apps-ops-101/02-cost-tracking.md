...
## 이 코드에서 봐야 할 것
![반복 프롬프트가 캐시 후보로 분리되는 구조](https://yeongseon-books.github.io/book-public-assets/assets/llm-apps-ops-101/02/02-02-what-to-notice-in-this-code.ko.png)
...
## 실무에서 헷갈리는 지점
![최적화 레버와 품질 확인이 맞물리는 구조](https://yeongseon-books.github.io/book-public-assets/assets/llm-apps-ops-101/02/02-03-where-engineers-get-confused.ko.png)
