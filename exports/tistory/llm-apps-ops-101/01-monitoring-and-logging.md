...
- [LLM Apps Ops 101 (3/6): LLM 출력 품질 평가](https://yeongseonchoe.tistory.com/286)
...
- [AI Evaluation 101](https://yeongseonchoe.tistory.com/116) — 이 시리즈가 운영 단계에서 추적하는 "LLM 품질"을 릴리스 전 단계에서 어떻게 측정할지 다룹니다. 모니터링 지표가 흔들릴 때, 어떤 평가 방식으로 회귀 여부를 확인할지 결정하는 데 도움이 됩니다.
