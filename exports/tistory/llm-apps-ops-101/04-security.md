...
## 이 코드에서 봐야 할 것
![인젝션 탐지와 PII 마스킹이 갈라지는 구조](https://yeongseon-books.github.io/book-public-assets/assets/llm-apps-ops-101/04/04-02-what-to-notice-in-this-code.ko.png)
...
## 실무에서 헷갈리는 지점
![입력 방어와 출력 방어가 역할을 나누는 구조](https://yeongseon-books.github.io/book-public-assets/assets/llm-apps-ops-101/04/04-03-where-engineers-get-confused.ko.png)
