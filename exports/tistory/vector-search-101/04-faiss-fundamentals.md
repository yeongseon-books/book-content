...
![FAISS 인덱스 유형 비교 구조](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/04/04-01-faiss-fundamentals-fast-approximate-near.ko.png)
...
![FAISS 인덱스 유형 비교 구조](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/04/04-01-understanding-index-types.ko.png)
...
![임베딩에서 인덱스 생성까지의 흐름](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/04/04-02-exact-search-with-indexflatip.ko.png)
...
![질의가 FAISS 검색 결과로 가는 경로](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/04/04-03-running-queries.ko.png)
...
![float64 입력에서 생기는 오류 경로](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/04/04-04-choosing-an-index.ko.png)
...
- **Flat 베이스라인** — 정확도 기준선으로 Flat을 항상 두고 비교합니다.
- **IVF/HNSW 트레이드오프** — 재현율·속도·메모리 삼각형 안에서 선택합니다.
- **학습 데이터** — IVF는 적절한 학습 표본이 있어야 품질이 나옵니다.
- **저장·로딩** — 인덱스 직렬화/버전 호환을 운영 절차로 명문화합니다.
- **GPU vs CPU** — 데이터 규모가 작으면 GPU 이득이 작다는 점을 인지합니다.
