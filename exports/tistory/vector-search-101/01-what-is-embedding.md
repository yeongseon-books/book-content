...
![키워드 검색과 임베딩 검색의 차이](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/01/01-01-what-is-an-embedding-converting-text-int.ko.png)
...
![키워드 검색과 임베딩 검색의 차이](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/01/01-01-the-ceiling-of-keyword-search.ko.png)
...
![텍스트가 벡터 공간으로 들어가는 흐름](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/01/01-02-vector-space-intuition.ko.png)
...
![긍정 쌍과 부정 쌍 학습 구조](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/01/01-03-how-embedding-models-learn.ko.png)
...
![문장 세 개를 벡터로 인코딩하는 실행 경로](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/01/01-04-creating-your-first-vectors.ko.png)
...
![정확 문자열과 긴 문서에서 생기는 한계](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/01/01-05-where-embeddings-fall-short.ko.png)
...
- **의미 공간** — 임베딩은 의미를 좌표로 만든 결과라는 직관이 가장 중요합니다.
- **모델 선택** — 도메인·언어·차원·비용을 동시에 고려해 모델을 고릅니다.
- **정규화 일관성** — 인덱싱과 쿼리에서 동일한 normalize를 강제합니다.
- **차원이 비용** — 차원이 클수록 저장·검색 비용이 늘어남을 잊지 않습니다.
- **재현성** — 모델·버전·전처리를 함께 기록해 결과를 재현 가능하게 둡니다.
