...
![코사인 내적 유클리드 비교 구조](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/03/03-01-cosine-similarity-and-vector-search-comp.ko.png)
...
![코사인 내적 유클리드 비교 구조](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/03/03-01-three-distance-metrics.ko.png)
...
![같은 문장 쌍에 세 척도를 적용하는 흐름](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/03/03-02-comparing-all-three-metrics.ko.png)
...
![정규화 전후 점수 해석 차이](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/03/03-03-why-normalization-matters.ko.png)
...
![브루트 포스 최근접 이웃 실행 경로](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/03/03-04-brute-force-nearest-neighbor-search.ko.png)
...
![거리 척도 선택 기준 흐름](https://yeongseon-books.github.io/book-public-assets/assets/vector-search-101/03/03-05-when-to-use-each-metric.ko.png)
...
- **Cosine 가정** — 정규화 가정과 함께 써야 의미 있는 결과가 나옵니다.
- **Inner product 차이** — 비정규화 벡터에서 inner product와 cosine은 다릅니다.
- **임계값 직관** — 도메인 데이터로 임계값을 정해야 신뢰할 수 있습니다.
- **순위와 점수 분리** — 절대 점수가 아닌 상대 순위를 우선 신뢰합니다.
- **이상값 검사** — 비정상적으로 높은/낮은 점수는 전처리 문제일 가능성이 큽니다.
