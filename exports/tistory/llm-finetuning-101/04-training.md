...
![이 글에서 답할 질문](https://yeongseon-books.github.io/book-public-assets/assets/llm-finetuning-101/04/04-01-questions-this-post-answers.ko.png)
...
- learning rate, batch size, gradient accumulation은 서로 어떻게 묶어 결정해야 하나요?
...
![축소 가능한 요소와 유지해야 할 요소 비교](https://yeongseon-books.github.io/book-public-assets/assets/llm-finetuning-101/04/04-02-what-you-can-shrink-and-what-you-cannot.ko.png)
...
![학습 루프에서 줄여도 되는 것과 줄이면 안 되는 것](https://yeongseon-books.github.io/book-public-assets/assets/llm-finetuning-101/04/04-01-what-you-can-shrink-and-what-you-cannot.ko.png)
...
![배치 크기와 gradient accumulation 관계 구조](https://yeongseon-books.github.io/book-public-assets/assets/llm-finetuning-101/04/04-03-what-to-notice-in-this-code.ko.png)
...
![학습 디버깅 출력 우선순위 판단 흐름](https://yeongseon-books.github.io/book-public-assets/assets/llm-finetuning-101/04/04-04-where-engineers-get-confused.ko.png)
