...
![가장 작은 예시부터 — Hello, Function](../../assets/azure-functions-101/01/01-01-start-with-the-smallest-example-hello-fu.ko.png)
...
![기존 웹 앱과 뭐가 다른가](../../assets/azure-functions-101/01/01-02-how-is-this-different-from-a-traditional.ko.png)
...
![Azure Functions의 4가지 핵심 개념](../../assets/azure-functions-101/01/01-03-the-four-core-concepts-of-azure-function.ko.png)
...
이 글은 Azure Functions 101 시리즈의 1화입니다. 여기서 멘탈 모델을 잡아 두면 2화의 Trigger와 Binding, 3화의 Host와 Worker 구조가 훨씬 자연스럽게 이어집니다. 이후 글에서는 배포, 플랜 선택, 스케일링과 콜드 스타트, 운영까지 차례로 연결합니다.
