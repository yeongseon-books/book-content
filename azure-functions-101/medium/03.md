...
![The big picture — two processes](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-functions-101/03/03-01-the-big-picture-two-processes.en.png)
...
![What happens inside a single instance](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-functions-101/03/03-02-what-happens-inside-a-single-instance.en.png)
...
- **Term**: **Function App** / **What it is**: The unit of deployment, billing, and scaling. A container concept that groups multiple functions / **Unit**: The Azure resource you actually see
- **Term**: **Host** / **What it is**: The .NET runtime process running on a Function App instance / **Unit**: One per instance
- **Term**: **Worker** / **What it is**: The language runtime process the Host spawns / **Unit**: One or more per instance (tunable via `FUNCTIONS_WORKER_PROCESS_COUNT`)

![Function App, Host, Worker — the hierarchy of three terms](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-functions-101/03/03-03-function-app-host-worker-the-hierarchy-o.en.png)
...
**Related Series**
- [Azure Functions Deep Dive](https://github.com/yeongseon/tech-blog/blob/bf651c9/azure-functions-deep-dive/en) — a deeper series that traces the Host/Worker split at the code level
