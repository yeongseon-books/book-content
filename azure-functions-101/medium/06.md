...
![Scaling Has Two Axes — Instance Count and In-Instance Concurrency](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-functions-101/06/06-01-scaling-has-two-axes-instance-count-and.en.png)
...
![How the Plans React to a Traffic Spike](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-functions-101/06/06-02-how-the-plans-react-to-a-traffic-spike.en.png)
...
![What a Cold Start Actually Includes](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-functions-101/06/06-03-what-a-cold-start-actually-includes.en.png)
...
![1) Downstream systems do not scale with your function app](https://raw.githubusercontent.com/yeongseon/tech-blog/bf651c9/assets/azure-functions-101/06/06-04-1-downstream-systems-do-not-scale-with-y.en.png)
...
If you want the implementation details behind those behaviors, pair this post with [Deep Dive Part 5](https://github.com/yeongseon/tech-blog/blob/bf651c9/azure-functions-deep-dive/en/05-scaling-internals.md) and [Part 6](https://github.com/yeongseon/tech-blog/blob/bf651c9/azure-functions-deep-dive/en/06-cold-start-placeholder.md). The 101 series is about operational judgment; the deep-dive series shows how those behaviors are implemented in the host.
...
- [What Is Azure Functions? — A World Where Events Call Your Code](./01.md)
- [Triggers and Bindings — Everything About Function I/O](./02.md)
- [Host and Worker — Who Actually Runs Your Functions?](./03.md)
- [Deploy a Function App — From Localhost to Azure](./04.md)
- [Which Plan Should You Pick? — Consumption / Flex / Premium / Dedicated](./05.md)
- **Scaling and Cold Starts — When Serverless Feels Fast and When It Doesn’t (current)**
- [Monitoring and Operations Fundamentals](./07.md)
...
**Related Series**
- [Azure Functions 101 Part 5 — Choosing a plan](https://github.com/yeongseon/tech-blog/blob/bf651c9/azure-functions-101/en/05-choosing-a-plan.md)
- [Azure Functions 101 Part 7 — Monitoring and operations fundamentals](https://github.com/yeongseon/tech-blog/blob/bf651c9/azure-functions-101/en/07-monitoring-and-ops.md)
