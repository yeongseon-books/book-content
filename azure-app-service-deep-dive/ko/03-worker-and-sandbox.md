...
![큰 그림 — worker의 두 얼굴](../../assets/azure-app-service-deep-dive/03/03-01-the-two-worker-models-that-matter.ko.png)
...
![Linux: container가 실행 경계다](../../assets/azure-app-service-deep-dive/03/03-01-linux-the-container-is-the-execution-bou.ko.png)
...
![sandbox는 보안 이야기이면서 동시에 품질 이야기다](../../assets/azure-app-service-deep-dive/03/03-06-the-sandbox-is-a-security-feature-and-a.ko.png)
