...
![큰 그림 — 요청 라우팅의 세 단계](../../assets/azure-app-service-deep-dive/02/02-01-the-routing-path-in-three-stages.ko.png)
...
![Front-End가 먼저 결정하는 것들](../../assets/azure-app-service-deep-dive/02/02-02-what-the-front-end-decides-first.ko.png)
...
![ARR Affinity가 켜져 있을 때의 요청 경로](../../assets/azure-app-service-deep-dive/02/02-03-request-flow-with-arr-affinity-enabled.ko.png)
...
![ARR Affinity가 꺼져 있을 때의 요청 경로](../../assets/azure-app-service-deep-dive/02/02-04-request-flow-with-arr-affinity-disabled.ko.png)
...
![일부 사용자만 문제를 겪는 이유](../../assets/azure-app-service-deep-dive/02/02-05-why-only-some-users-fail-sometimes.ko.png)
Worker 2가 메모리 압박,
느린 dependency,
비정상 재시작 루프를 겪고 있는데,
