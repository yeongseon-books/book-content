...
- [Front-End and ARR — how a request reaches a worker](./02.md)
- [Workers and the sandbox — where user code actually runs](./03.md)
- [Deployment and Kudu — build, sync, release from the inside](./04.md)
- [Scaling internals — how Scale Out decisions become new workers](./05.md)
