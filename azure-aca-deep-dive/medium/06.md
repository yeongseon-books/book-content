...
![Start with the full path, not with the app](https://raw.githubusercontent.com/yeongseon/tech-blog/e8dca42/assets/azure-aca-deep-dive/06/06-01-start-with-the-full-path-not-with-the-ap.en.png)
...
- [Revisions and traffic splitting — where Envoy weights come from](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-aca-deep-dive/en/03-revision-and-traffic-split.md)
- [KEDA inside ACA — what a scale rule actually creates](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-aca-deep-dive/en/04-keda-in-aca.md)
- [Dapr sidecar internals — the Go process that lives next to your container](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-aca-deep-dive/en/05-dapr-sidecar-internals.md)
