...
|---|---|---|---|
| 1 | Azure App Service란? - 플랫폼 아키텍처 이해하기 | [ko](./azure-app-service-101/ko/01-what-is-app-service.md) | [en](./azure-app-service-101/en/01-what-is-app-service.md) |
| 2 | Request Lifecycle: 3am에 터진 502를 어디서부터 봐야 할까 | [ko](./azure-app-service-101/ko/02-request-lifecycle.md) | [en](./azure-app-service-101/en/02-request-lifecycle.md) |
| 3 | Hosting Models: 어떤 플랜을 선택해야 할까? | [ko](./azure-app-service-101/ko/03-hosting-models.md) | [en](./azure-app-service-101/en/03-hosting-models.md) |
| 4 | 첫 번째 배포: 로컬에서 Azure까지 (Python/Flask) | [ko](./azure-app-service-101/ko/04-first-deploy.md) | [en](./azure-app-service-101/en/04-first-deploy.md) |
| 5 | Configuration 마스터하기: App Settings & 환경변수 | [ko](./azure-app-service-101/ko/05-configuration.md) | [en](./azure-app-service-101/en/05-configuration.md) |
| 6 | 로그와 모니터링 기초 | [ko](./azure-app-service-101/ko/06-logging-monitoring.md) | [en](./azure-app-service-101/en/06-logging-monitoring.md) |
| 7 | Scaling 101: 언제 Scale Up vs Scale Out? | [ko](./azure-app-service-101/ko/07-scaling-101.md) | [en](./azure-app-service-101/en/07-scaling-101.md) |
...
| # | 제목 | 한국어 (Tistory) | English (Medium) |
|---|---|---|---|
| 1 | 글자를 숫자로 바꾸기 | [ko](./llm-from-scratch-101/ko/01-tokenizer.md) | [en](./llm-from-scratch-101/en/01-tokenizer.md) |
| 2 | 정수에서 벡터로, 그리고 위치 | [ko](./llm-from-scratch-101/ko/02-embedding.md) | [en](./llm-from-scratch-101/en/02-embedding.md) |
| 3 | 어떤 토큰을 얼마나 볼지 스스로 정하기 | [ko](./llm-from-scratch-101/ko/03-attention.md) | [en](./llm-from-scratch-101/en/03-attention.md) |
| 4 | 블록 하나, 깊이의 단위 | [ko](./llm-from-scratch-101/ko/04-transformer-block.md) | [en](./llm-from-scratch-101/en/04-transformer-block.md) |
| 5 | 조립: GPT 모델 클래스 완성 | [ko](./llm-from-scratch-101/ko/05-gpt-model.md) | [en](./llm-from-scratch-101/en/05-gpt-model.md) |
| 6 | 기울기로 배우기 | [ko](./llm-from-scratch-101/ko/06-training-loop.md) | [en](./llm-from-scratch-101/en/06-training-loop.md) |
| 7 | 샘플링 — 학습된 모델에서 글 뽑아내기 | [ko](./llm-from-scratch-101/ko/07-inference.md) | [en](./llm-from-scratch-101/en/07-inference.md) |
| 8 | 베이스 모델을 우리 작업에 맞추기 | [ko](./llm-from-scratch-101/ko/08-finetuning.md) | [en](./llm-from-scratch-101/en/08-finetuning.md) |
| 9 | 직접 만든 LLM을 챗봇으로 — FastAPI + 스트리밍 | [ko](./llm-from-scratch-101/ko/09-chatbot-wrapper.md) | [en](./llm-from-scratch-101/en/09-chatbot-wrapper.md) |
...
| # | 제목 | 한국어 (Tistory) | English (Medium) |
|---|---|---|---|
| 1 | Azure Kubernetes Service란? — 직접 운영하지 않아도 되는 Kubernetes | [ko](./azure-aks-101/ko/01-what-is-aks.md) | [en](./azure-aks-101/en/01-what-is-aks.md) |
