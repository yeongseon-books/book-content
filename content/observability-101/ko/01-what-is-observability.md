...
- 왜 세 신호를 함께 봐야 할까요?
- trace_id는 왜 관측성의 연결 고리일까요?
- 작은 서비스에 첫 신호를 붙이려면 어디서 시작하면 될까요?

> 메트릭은 추세를 보여 주고, 로그는 사건의 맥락을 남기고, 트레이스는 요청의 경로를 드러냅니다. 관측성은 이 세 신호를 따로 모으는 일이 아니라, 하나의 질문으로 엮어 읽는 능력입니다.
