...
![이 글에서 답할 질문](../../../assets/rag-deep-dive/06/06-01-questions-this-post-answers.en.png)
...
예제 파일: `/root/Github/rag-deep-dive/en/06-evaluation-and-quality-gates/main.py`
...
![평가 샘플이 메트릭 입력을 결정하는 구조](../../../assets/rag-deep-dive/06/06-01-ragas-dataset-schema-and-sample-fields.en.png)
...
![답변 주장 분해와 근거 검증 흐름](../../../assets/rag-deep-dive/06/06-02-faithfulness-claim-decomposition-and-verification.en.png)
...
![역질문 생성으로 응답 초점을 재는 흐름](../../../assets/rag-deep-dive/06/06-03-answer-relevancy-reverse-question-flow.en.png)
...
![순서 가중치가 들어간 precision at k 계산](../../../assets/rag-deep-dive/06/06-04-context-precision-at-k-ranking.en.png)
...
![CI에서 faithfulness 임계값을 거는 품질 게이트](../../../assets/rag-deep-dive/06/06-05-quality-gate-pipeline-integration.en.png)
