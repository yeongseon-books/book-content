...
- [kubelet and containerd — how a container actually starts on a node](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-aks-deep-dive/en/02-kubelet-and-containerd.md)
- [CNI and Azure CNI Overlay — where Pod IPs come from](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-aks-deep-dive/en/03-cni-and-azure-cni-overlay.md)
- [Scheduler and Pod placement — who decides which node](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-aks-deep-dive/en/04-scheduler-and-pod-placement.md)
- [HPA and Cluster Autoscaler internals — two control loops](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-aks-deep-dive/en/05-hpa-and-cluster-autoscaler-internals.md)
...
- [Azure Functions Deep Dive part 5 — reading control loops](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-deep-dive/en/05-scaling-internals.md)
