...
![KEDA structure linking event sources to HPA](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-aks-deep-dive/06/06-01-the-keda-structure.en.png)
---
...
![External metrics path into HPA decisions](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-aks-deep-dive/06/06-02-the-external-metrics-path.en.png)
---
...
![Scale-to-zero boundary between KEDA and HPA](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-aks-deep-dive/06/06-03-the-scale-to-zero-boundary.en.png)
---
...
- [Control plane anatomy — what AKS hides from you](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-aks-deep-dive/en/01-control-plane-anatomy.md)
- [kubelet and containerd — how a container actually starts on a node](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-aks-deep-dive/en/02-kubelet-and-containerd.md)
- [CNI and Azure CNI Overlay — where Pod IPs come from](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-aks-deep-dive/en/03-cni-and-azure-cni-overlay.md)
- [Scheduler and Pod placement — who decides which node](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-aks-deep-dive/en/04-scheduler-and-pod-placement.md)
- [HPA and Cluster Autoscaler internals — two control loops](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-aks-deep-dive/en/05-hpa-and-cluster-autoscaler-internals.md)
...
**Related Series**
- [Azure AKS 101](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-aks-101/en)
- [Azure Functions Deep Dive part 5 — reading control loops](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-deep-dive/en/05-scaling-internals.md)
