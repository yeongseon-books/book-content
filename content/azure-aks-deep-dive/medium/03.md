...
- [Azure Functions Deep Dive part 1 — start with the big picture](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-deep-dive/en/01-host-bootstrap.md)
