...
- control plane 장애와 data plane 장애를 구분할 때 가장 먼저 잡아야 할 기준점은 무엇일까요?
- `kubectl` 한 번이 실제로 어떤 경로를 거쳐 노드 실행으로 이어지는지 어떻게 읽는 편이 가장 정확할까요?
...
## AKS control plane을 이해하는 가장 좋은 방법: 보이는 API 표면과 숨겨진 수렴 루프를 분리해서 보는 것입니다
...
![관리형 control plane과 노드 data plane 경계](https://yeongseon-books.github.io/book-public-assets/assets/azure-aks-deep-dive/01/01-01-aks-control-vs-data-plane.ko.png)
