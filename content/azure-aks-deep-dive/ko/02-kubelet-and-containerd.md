...
![kubelet은 Unix socket으로 CRI를 부른다](../../../assets/azure-aks-deep-dive/02/02-02-kubelet-talks-to-a-unix-socket.ko.png)
...
![Pod 생성 경로를 코드 기준으로 다시 쓰면](../../../assets/azure-aks-deep-dive/02/02-03-startup-path-as-control-flow.ko.png)
---
