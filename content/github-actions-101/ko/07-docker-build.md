...
![Dockerfile이 Buildx와 GitHub Actions 캐시를 거쳐 GHCR 이미지로 이어지는 빌드 흐름](https://yeongseon-books.github.io/book-public-assets/assets/github-actions-101/07/07-01-docker.ko.png)

*Dockerfile이 Buildx와 GitHub Actions 캐시를 거쳐 GHCR 이미지로 이어지는 빌드 흐름*
