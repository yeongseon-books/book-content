...
그리디 알고리즘은 구현이 간결하고 실행 속도가 빠릅니다. 정렬 후 한 번만 순회해도 끝나는 문제가 많아서, 복잡한 동적 계획법보다 훨씬 가볍게 풀리는 경우가 자주 있습니다.

다만 그리디가 항상 최적해를 주는 것은 아닙니다. 어떤 문제는 통하고 어떤 문제는 틀리는 이유를 구분할 수 있어야 제대로 쓸 수 있습니다.

이 글은 Algorithms with Python 101 시리즈의 9번째 글입니다. 여기서는 그리디 선택 속성과 최적 부분 구조를 기준으로, 언제 탐욕적 선택이 정답이 되는지 대표 문제로 확인해 보겠습니다.
