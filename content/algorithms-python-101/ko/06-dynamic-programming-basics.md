...
어떤 문제는 같은 부분 문제를 반복해서 풀면 끝없이 느려집니다. 동적 계획법이 중요한 이유는 그 낭비를 재사용 가능한 계산으로 바꿔 주기 때문입니다. 이 글은 Algorithms with Python 101 시리즈의 여섯 번째 글입니다. 여기서는 메모이제이션, 테뷸레이션, 그리고 대표적인 Python 예제로 동적 계획법을 소개합니다.
