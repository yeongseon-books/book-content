...
tags:
  ...
  - DP
  - 메모이제이션
seo_description: Python으로 동적 계획법의 탑다운·바텀업 접근법을 이해하고 구현합니다.
last_reviewed: '2026-05-04'
---

# 동적 계획법 기초

재귀만으로는 지수 시간이 걸리는 문제를 동적 계획법으로 다항 시간에 풀 수 있습니다. 피보나치 수열의 단순 재귀는 O(2^n)이지만, DP를 적용하면 O(n)으로 줄일 수 있습니다.

동적 계획법은 코딩 면접에서 가장 자주 등장하는 유형 중 하나입니다. 패턴을 익혀 두면 다양한 최적화 문제에 훨씬 안정적으로 접근할 수 있습니다.

이 글은 Algorithms with Python 101 시리즈의 6번째 글입니다. 여기서는 메모이제이션과 바텀업 테이블링을 통해, 중복 계산을 제거하는 사고방식을 Python 코드로 익혀 보겠습니다.
