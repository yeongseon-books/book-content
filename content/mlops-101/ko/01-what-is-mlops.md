...
많은 ML 프로젝트가 프로덕션에 도달하지 못합니다. MLOps는 그 격차를 메우는 체계입니다.
...
- 예측 로그가 모니터링의 원천 데이터입니다.

## 자주 하는 실수 5가지

1. ***모델 만 버전 관리* 하고 *데이터/코드* 무시.**
2. **모니터링 없이 배포합니다.**
3. **Notebook에서 바로 배포합니다.**
4. **재학습 트리거를 수동으로 돌립니다.**
...
MLOps는 모델 한 줄이 아니라 시스템입니다. 다음 글에서는 실험 관리부터 시작합니다.
