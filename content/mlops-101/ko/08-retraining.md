...
수동 재학습은 느리고 판단도 편향되기 쉽습니다. 자동화하면 더 빠르고 근거 기반으로 움직일 수 있습니다.
...
**Before**: 분기마다 수동으로 재학습하고, 결정 근거도 부족합니다.
...
- 트리거는 명시적으로 정의해야 합니다.
- 마진을 두면 우연한 우세로 승급하는 일을 막을 수 있습니다.
- 섀도우 평가는 운영 위험 없이 비교할 수 있습니다.
...
추천 모델은 매일 야간 재학습 뒤 AUC와 CTR을 비교하고, 마진을 넘기면 카나리로 5% 트래픽을 흘립니다.
