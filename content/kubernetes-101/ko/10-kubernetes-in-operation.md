...
이 글에서 다룬 핵심은 세 가지입니다. 첫째 liveness, readiness, startup probe는 어떤 역할을 나눌, 둘째 RBAC와 NetworkPolicy는 왜 운영의 기본 경계일, 셋째 메트릭, 로그, 트레이스는 왜 함께 봐야 할입니다. 한눈에 보는 구조에서 시작해 실무 적용까지 이어지는 흐름을 따라가면 이 주제의 전체 그림이 잡힙니다.
