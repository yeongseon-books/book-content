...
- 단계별로 첫 클러스터 둘러보기의 핵심 원리를 한 문장으로 설명하면 무엇일까요?
...
이 글에서 다룬 핵심은 세 가지입니다. 첫째 오케스트레이션이라는 말은 실제로 무엇을 대신해 줄, 둘째 컨트롤 플레인과 워커 노드는 어떤 식으로 역할을 나눌, 셋째 원하는 상태 모델이 왜 Kubernetes의 핵심 철학일입니다. 한눈에 보는 구조에서 시작해 실무 적용까지 이어지는 흐름을 따라가면 이 주제의 전체 그림이 잡힙니다.

## 처음 질문으로 돌아가기

- **오케스트레이션이라는 말은 실제로 무엇을 대신해 줄까요?**
  - 오케스트레이션이라는 말은 실제로 무엇을 대신해 줄까요 — 본문에서 단계별로 설명합니다.
- **컨트롤 플레인과 워커 노드는 어떤 식으로 역할을 나눌까요?**
  - 컨트롤 플레인과 워커 노드는 어떤 식으로 역할을 나눌까요 — 본문에서 단계별로 설명합니다.
- **원하는 상태 모델이 왜 Kubernetes의 핵심 철학일까요?**
  - 원하는 상태 모델이 왜 Kubernetes의 핵심 철학일까요 — 본문에서 단계별로 설명합니다.
- **한눈에 보는 구조에서 가장 흔한 실수는 무엇일까요?**
...
- **단계별로 첫 클러스터 둘러보기의 핵심 원리를 한 문장으로 설명하면 무엇일까요?**
  - 단계별로 첫 클러스터 둘러보기의 핵심 원리를 한 문장으로 설명하면 무엇일까요 — 본문에서 단계별로 설명합니다.
