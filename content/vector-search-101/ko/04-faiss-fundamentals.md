...
![FAISS 입문: 고속 근사 최근접 이웃 검색](../../../assets/vector-search-101/04/04-01-faiss-fundamentals-fast-approximate-near.ko.png)
<!-- ebook-only:start -->
...
<!-- blog-only:start -->
다음 글: [청크 전략 — 긴 문서를 어떻게 나눌 것인가](./05-chunking-strategies.md)
<!-- blog-only:end -->
