...
![FAISS index type comparison structure](../../../assets/vector-search-101/04/04-01-faiss-fundamentals-fast-approximate-near.ko.png)
...
![FAISS index type comparison structure](../../../assets/vector-search-101/04/04-01-understanding-index-types.ko.png)
...
![Flow from embeddings to index creation](../../../assets/vector-search-101/04/04-02-exact-search-with-indexflatip.ko.png)
...
![Query to FAISS result path](../../../assets/vector-search-101/04/04-03-running-queries.ko.png)
...
![float64 input error path](../../../assets/vector-search-101/04/04-04-choosing-an-index.ko.png)
