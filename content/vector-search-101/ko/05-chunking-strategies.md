...
![청크 크기와 오버랩의 구조](../../../assets/vector-search-101/05/05-01-chunking-strategies-how-to-split-long-do.ko.png)
...
긴 문서를 어떻게 잘라야 검색·답변 품질이 가장 잘 나오나요?

이 글은 그 질문에 답하기 위해 청크 전략의 핵심 결정과 운영 함정을 살펴봅니다.
...
앞 장에서는 **FAISS 입문 — 고속 근사 최근접 이웃 검색**을 다뤘습니다.
이 장을 마치면 다음 장에서 **벡터 검색 파이프라인 — 문서 수집부터 쿼리까지**으로 이어집니다.
<!-- ebook-only:end -->
...
![고정 크기 청킹 실행 흐름](../../../assets/vector-search-101/05/05-02-fixed-size-chunking-from-scratch.ko.png)
...
![분리자 우선순위 탐색 경로](../../../assets/vector-search-101/05/05-03-recursivecharactertextsplitter.ko.png)
...
![청킹에서 FAISS 검색까지의 실행 경로](../../../assets/vector-search-101/05/05-04-full-pipeline-chunking-to-faiss.ko.png)
...
![청크 크기에 따른 검색 품질 비교](../../../assets/vector-search-101/05/05-05-how-chunk-size-affects-retrieval.ko.png)
