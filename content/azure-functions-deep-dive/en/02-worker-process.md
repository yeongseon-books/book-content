...
The previous chapter covered **Host Bootstrap — Following `WebJobsScriptHostService`**.
After this chapter, the next one moves on to **The gRPC Event Stream — What Do the Host and Worker Actually Exchange?**.
<!-- ebook-only:end -->
