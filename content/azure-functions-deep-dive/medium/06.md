...
![Why Cold Start Is Expensive — Decomposing the Bootstrap Cost](https://raw.githubusercontent.com/yeongseon/tech-writing/cb179c5/assets/azure-functions-deep-dive/06/06-01-why-cold-start-is-expensive-decomposing.en.png)
...
![The Whole Picture — The Life of an Instance](https://raw.githubusercontent.com/yeongseon/tech-writing/cb179c5/assets/azure-functions-deep-dive/06/06-02-the-whole-picture-the-life-of-an-instanc.en.png)
---
...
- **Plan**: Consumption / **Cold start frequency**: Frequent (scale 0 → 1, or every new instance) / **Mechanism**: placeholder → specialization every time
- **Plan**: Flex Consumption (on-demand) / **Cold start frequency**: Frequent (scale 0 → 1) / **Mechanism**: placeholder → specialization every time
- **Plan**: Flex Consumption (Always Ready) / **Cold start frequency**: Almost none / **Mechanism**: Always-specialized instances kept around
- **Plan**: Premium (pre-warmed) / **Cold start frequency**: Almost none (small on scale-out) / **Mechanism**: Pre-warmed instances play a role similar to the placeholder pool
- **Plan**: Dedicated / **Cold start frequency**: Only at instance boot / **Mechanism**: App Service always-on, no placeholders involved
...
- **Lever**: Always Ready instances / **Stage affected**: Skips specialization entirely / **Rationale**: Flex Consumption docs + the code flow above
- **Lever**: Premium pre-warmed / **Stage affected**: Owns a specialization pool directly / **Rationale**: Same
- **Lever**: Lighter dependencies / **Stage affected**: User-code load time during `RestartHostAsync` / **Rationale**: `FunctionAssemblyLoadContext.ResetSharedContext`
- **Lever**: Smaller deployment package / **Stage affected**: Content injection time / **Rationale**: Outside this code; platform layer
- **Lever**: Latest Functions runtime / **Stage affected**: Improved JIT trace / **Rationale**: `WarmUpConstants.JitTraceFileName`
- **Lever**: Application Initialization (Premium/Dedicated) / **Stage affected**: Time from host-ready to first request / **Rationale**: App Service layer
...
- [Scaling Internals — Scale Controller, ScaleMonitor, and What Differs Across Plans](https://github.com/yeongseon/tech-writing/blob/cb179c5/content/azure-functions-deep-dive/en/05-scaling-internals.md)
...
- [Intro Part 6 — Scaling and Cold Start](https://github.com/yeongseon/tech-writing/blob/cb179c5/content/azure-functions-101/en/06-scaling-and-cold-start.md)
- [Deep Dive Part 1 — Host Bootstrap](https://github.com/yeongseon/tech-writing/blob/cb179c5/content/azure-functions-deep-dive/en/01-host-bootstrap.md)
- [Deep Dive Part 5 — Scaling Internals](https://github.com/yeongseon/tech-writing/blob/cb179c5/content/azure-functions-deep-dive/en/05-scaling-internals.md)
