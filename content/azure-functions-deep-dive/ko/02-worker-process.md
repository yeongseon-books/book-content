...
![워커 설정 provider를 합치는 해석 구조](../../../assets/azure-functions-deep-dive/02/02-01-one-level-up-workerconfigfactory.ko.png)
...
![워커 프로세스와 채널 준비 단계](../../../assets/azure-functions-deep-dive/02/02-02-worker-lifecycle-within-a-single-instanc.ko.png)
...
![한 인스턴스의 다중 워커 배치 구조](../../../assets/azure-functions-deep-dive/02/02-03-functions-worker-process-count-multiple.ko.png)
---
...
![워커 종료 뒤 감지와 복구 흐름](../../../assets/azure-functions-deep-dive/02/02-04-what-happens-when-a-worker-dies.ko.png)
---
