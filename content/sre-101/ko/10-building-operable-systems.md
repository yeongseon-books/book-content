...
이 글에서 다룬 핵심은 세 가지입니다. 첫째 operability는 왜 기능 뒤에 붙이는 옵션이 아니라 설계 요소일, 둘째 관측성, 자동화, 안전한 변경, 회복력은 왜 함께 봐야 할, 셋째 운영 가능한 시스템을 점검할 때 어떤 질문부터 던져야 할입니다. 왜 이 주제가 중요한가에서 시작해 실무 적용까지 이어지는 흐름을 따라가면 이 주제의 전체 그림이 잡힙니다.
