...
운영성은 출시 후에 덧붙이는 장식이 아니라, 처음부터 기능과 함께 설계해야 하는 품질 속성입니다. 이 글에서는 왜 이 주제가 중요한가부터 운영 가능한 시스템 설계 원칙까지 이 원칙을 구체적으로 살펴봤습니다. 핵심은 개념을 외우는 것이 아니라 실무에서 어떤 판단을 바꾸는지 이해하는 데 있습니다.
