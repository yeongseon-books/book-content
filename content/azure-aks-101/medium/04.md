...
![Pod, Deployment, and Service](https://raw.githubusercontent.com/yeongseon/tech-writing/cb179c5/assets/azure-aks-101/04/04-01-one-picture-first.en.png)
...
- **Type**: ClusterIP / **Reachability**: inside the cluster / **Main use**: service-to-service traffic / **AKS feel**: default
- **Type**: NodePort / **Reachability**: node IP + port / **Main use**: learning, special access patterns / **AKS feel**: operationally rougher
- **Type**: LoadBalancer / **Reachability**: outside the cluster / **Main use**: simple external exposure / **AKS feel**: integrates with Azure LB
...
![Deployment becomes clearer when you imagine an update](https://raw.githubusercontent.com/yeongseon/tech-writing/cb179c5/assets/azure-aks-101/04/04-02-deployment-becomes-clearer-when-you-imag.en.png)
...
**Related Series**
- [Azure App Service 101](https://github.com/yeongseon/tech-writing/blob/cb179c5/content/azure-app-service-101/en/02-request-lifecycle.md) — useful when comparing Kubernetes service routing with a more opinionated PaaS request path
- [Azure Functions 101](https://github.com/yeongseon/tech-writing/blob/cb179c5/content/azure-functions-101/en/02-triggers-and-bindings.md) — useful when comparing pod-centric workloads with event-triggered execution
