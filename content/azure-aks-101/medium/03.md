...
**Related Series**
- [Azure App Service 101](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-app-service-101/en/04-first-deploy.md) — useful when comparing the same FastAPI app on a higher-level PaaS
- [Azure Functions 101](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-functions-101/en) — useful when comparing container deployment with function deployment
