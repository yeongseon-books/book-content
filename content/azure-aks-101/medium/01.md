...
- Self-managed Kubernetes: You own it
- AKS: Azure owns it

**Upgrade burden**
- Self-managed Kubernetes: Higher
- AKS: Lower

**Azure integration**
- Self-managed Kubernetes: Hand-assembled
- AKS: Built-in paths

**Time to first cluster**
- Self-managed Kubernetes: Slower
- AKS: Faster
