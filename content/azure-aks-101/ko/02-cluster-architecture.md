...
- Spot node pool은 언제 도움이 되고 언제 위험할까요?
- Control Plane 업그레이드와 Node Pool 업그레이드는 왜 같은 말이 아닐까요?
...
## 클러스터를 이해하는 가장 좋은 방법: 결정 계층과 실행 계층을 분리해서 보는 것입니다
...
![Control Plane과 Node Pool의 책임 경계](https://yeongseon-books.github.io/book-public-assets/assets/azure-aks-101/02/02-01-cut-the-cluster-in-half.ko.png)
