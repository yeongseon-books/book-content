...
- **여기서 말하는 일관성은 정확히 무엇이며 트랜잭션의 C와 어떻게 다를까요?**
  - 여기서 말하는 일관성은 정확히 무엇이며 트랜잭션의 C와 어떻게 다를까요 — 본문에서 구체적으로 다룹니다.
- **linearizable, sequential, causal, eventual은 어떤 스펙트럼을 이룰까요?**
  - linearizable, sequential, causal, eventual은 어떤 스펙트럼을 이룰까요 — 본문에서 구체적으로 다룹니다.
- **CAP 정리는 무엇을 말하며, 어디서 자주 오해될까요?**
  - 1. **CAP의 C를 ACID의 C와 혼동합니다.** 두 개념은 다릅니다.
- **적용 전후 비교에서 가장 흔한 실수는 무엇일까요?**
  - 화면과 데이터셋별로 비용을 다르게 배분할 수 있습니다.
...
- **Distributed Systems 101 (4/10): 일관성과 CAP (현재 글)**
