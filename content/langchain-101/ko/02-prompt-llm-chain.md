...
![이 글에서 답할 질문](../../../assets/langchain-101/02/02-01-questions-this-post-answers.en.png)
...
![전체 흐름 한눈에 보기](../../../assets/langchain-101/02/02-02-the-flow-at-a-glance.en.png)
...
![system human ai 메시지 역할](../../../assets/langchain-101/02/02-01-chatprompttemplate-structure.en.png)
...
![여러 변수가 하나의 프롬프트로 들어가는 흐름](../../../assets/langchain-101/02/02-02-prompts-with-multiple-variables.en.png)
...
![문자열 파서와 JSON 파서 출력 비교](../../../assets/langchain-101/02/02-03-stroutputparser-vs-jsonoutputparser.en.png)
...
![기본 경로 실패 시 대체 경로로 전환](../../../assets/langchain-101/02/02-04-adding-a-fallback-to-a-chain.en.png)
