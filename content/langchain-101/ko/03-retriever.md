...
![이 글에서 답할 질문](../../../assets/langchain-101/03/03-01-questions-this-post-answers.en.png)
...
![전체 흐름 한눈에 보기](../../../assets/langchain-101/03/03-02-the-flow-at-a-glance.en.png)
...
![문서가 벡터 인덱스로 바뀌는 흐름](../../../assets/langchain-101/03/03-01-creating-a-faiss-vectorstore.en.png)
...
![similarity mmr threshold 검색 경로](../../../assets/langchain-101/03/03-02-creating-a-retriever.en.png)
...
![검색된 문서가 프롬프트 컨텍스트가 되는 흐름](../../../assets/langchain-101/03/03-03-connecting-a-retriever-to-a-chain.en.png)
...
![인덱스 저장과 재로딩 생명주기](../../../assets/langchain-101/03/03-04-saving-and-reloading-a-vectorstore.en.png)
