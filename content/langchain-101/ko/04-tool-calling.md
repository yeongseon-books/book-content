...
![이 글에서 답할 질문](../../../assets/langchain-101/04/04-01-questions-this-post-answers.en.png)
...
![전체 흐름 한눈에 보기](../../../assets/langchain-101/04/04-02-the-flow-at-a-glance.en.png)
...
![함수 정의가 도구 메타데이터로 바뀌는 흐름](../../../assets/langchain-101/04/04-01-defining-tools.en.png)
...
![도구 메타데이터를 모델에 바인딩하는 흐름](../../../assets/langchain-101/04/04-02-connecting-tools-with-bind-tools.en.png)
...
![도구 요청 실행 후 다시 주입하는 루프](../../../assets/langchain-101/04/04-03-a-minimal-tool-call-loop.en.png)
...
![잘못된 도구 요청을 막는 가드레일](../../../assets/langchain-101/04/04-04-what-to-watch-out-for.en.png)
