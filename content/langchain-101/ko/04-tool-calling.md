...
**출력 결과**
    ...
    [{'name': 'add_numbers', 'args': {'a': 13, 'b': 29}, 'id': 'z8c2s5drf', 'type': 'tool_call'}]
...
![함수 정의가 도구 메타데이터로 바뀌는 구조](../../../assets/langchain-101/04/04-01-defining-tools.ko.png)

*함수 정의가 도구 메타데이터로 바뀌는 구조*
...
![모델에 도구 목록이 바인딩되는 흐름](../../../assets/langchain-101/04/04-02-connecting-tools-with-bind-tools.ko.png)
...
**출력 결과**
    ...
    응답 타입: AIMessage
    content: ''
    tool_calls: [{'name': 'add_numbers', 'args': {'a': 15, 'b': 27}, 'id': 'na62hmny0', 'type': 'tool_call'}]
...
![도구 호출과 결과 재주입 반복 흐름](../../../assets/langchain-101/04/04-03-a-minimal-tool-call-loop.ko.png)
...
**출력 결과**
      ...
      get_current_time({}) = 2026-05-02 00:31:41
      get_current_time({}) = 2026-05-02 00:31:42
      get_current_time({}) = 2026-05-02 00:31:42
      get_current_time({}) = 2026-05-02 00:31:42
    예상치 못한 결과가 발생했습니다. 결과를 다시 확인해 보세요.

    혹시 'brave_search'로 정보를 검색해 볼까요?
      calculate_bmi({'height_m': 1.75, 'weight_kg': 70}) = 22.86
     BMI는 70kg 과 1.75m 인 사람의 경우 22.86입니다.
...
![잘못된 도구 호출을 막는 안전 경로](../../../assets/langchain-101/04/04-04-what-to-watch-out-for.ko.png)
