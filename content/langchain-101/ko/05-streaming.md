...
이 글은 LangChain 101 시리즈의 5번째 글입니다.
...
![이 글에서 답할 질문](../../../assets/langchain-101/05/05-01-questions-this-post-answers.en.png)
...
![전체 흐름 한눈에 보기](../../../assets/langchain-101/05/05-02-the-flow-at-a-glance.en.png)
...
![모델 직접 스트리밍과 체인 스트리밍 비교](../../../assets/langchain-101/05/05-01-basic-streaming.en.png)
...
![청크를 다시 최종 텍스트로 조립하는 흐름](../../../assets/langchain-101/05/05-02-collecting-streamed-output.en.png)
...
![async for 기반 스트리밍 실행 경로](../../../assets/langchain-101/05/05-03-astream-async-streaming.en.png)
...
![체인 이벤트를 선택적으로 보는 흐름](../../../assets/langchain-101/05/05-04-astream-events-for-fine-grained-control.en.png)
