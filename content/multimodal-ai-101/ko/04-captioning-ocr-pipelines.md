...
- OCR 결과와 장면 설명을 결합하는 hybrid pipeline은 어떤 순서로 설계하는 편이 안전할까요?
- 회전, confidence threshold, 한국어 지원, PII 노출 문제는 어디서 먼저 막아야 할까요?
...
## Captioning과 OCR을 이해하는 가장 좋은 방법: 하나가 다른 하나를 대체하는 것이 아니라 서로 다른 손실을 메우는 단계로 보는 것입니다
