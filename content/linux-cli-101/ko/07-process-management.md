...
![프로세스 점검과 종료 대응 순서](https://yeongseon-books.github.io/book-public-assets/assets/linux-cli-101/07/07-01-mental-model.ko.png)

*문제 프로세스를 확인하고 종료하는 기본 대응 순서를 보여 주는 그림*
