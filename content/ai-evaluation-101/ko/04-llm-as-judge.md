...
def judge_pairwise_debiased(question: str, ans_a: str, ans_b: str) -> str:
    ...
    v2 = judge_pairwise(question, ans_b, ans_a)  # A=ans_b, B=ans_a (순서 교체)

    # v2의 A는 실제로 ans_b이므로 결과를 뒤집어서 비교
