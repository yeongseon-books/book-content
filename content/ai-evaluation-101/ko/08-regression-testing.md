...
Prompt 한 줄을 고치면 다른 케이스가 깨질 수 있습니다.

이 글은 AI Evaluation 101 시리즈의 8번째 글입니다. 여기서는 CI에 통합되는 LLM 회귀 테스트 suite, 골든 데이터셋, threshold 기반 fail 정책을 다룹니다.
...
THRESHOLDS_WITH_TOLERANCE = {
    "exact_match":  (0.80, 0.02),  # 0.78 이상이면 통과 (허용 오차 0.02)
    "judge_score":  (4.0,  0.1),
