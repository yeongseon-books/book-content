---
title: "AI Evaluation 101 (7/10): 에이전트 평가하기 — 단일 응답이 아닌 trajectory"
...
이 그림에서는 agent 평가가 최종 답변이 아니라 trajectory, tool 선택, step 효율, 회복 여부를 함께 보는 구조를 보여 줍니다. agent는 실행 경로가 제품 비용과 위험을 만들기 때문에 경로 자체가 평가 대상입니다.
