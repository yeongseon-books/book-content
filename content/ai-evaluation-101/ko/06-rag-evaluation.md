...
RAG는 retrieval과 generation 두 단계 모두를 평가해야 합니다.

이 글은 AI Evaluation 101 시리즈의 6번째 글입니다. 여기서는 retrieval recall, context precision, faithfulness, answer relevance 같은 RAG 전용 지표를 다룹니다.
