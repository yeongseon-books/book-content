...
이 글에서 다룬 핵심은 세 가지입니다. 첫째 왜 같은 숫자를 보고도 팀마다 다른 결론을 내릴, 둘째 BI 도구와 대시보드는 각각 어떤 역할을 맡을, 셋째 좋은 대시보드는 어떤 질문 구조를 가져야 할입니다. 이 글에서 배울 것에서 시작해 실무 적용까지 이어지는 흐름을 따라가면 이 주제의 전체 그림이 잡힙니다.

## 처음 질문으로 돌아가기

- **왜 같은 숫자를 보고도 팀마다 다른 결론을 내릴까요?**
  - 왜 같은 숫자를 보고도 팀마다 다른 결론을 내릴까요 — 본문에서 구체적으로 다룹니다.
- **BI 도구와 대시보드는 각각 어떤 역할을 맡을까요?**
  - 대표적인 BI 도구는 비용, 셋프서비스 역량, 임베디드 지원에서 차이를 보입니다.
- **좋은 대시보드는 어떤 질문 구조를 가져야 할까요?**
  - 좋은 대시보드는 많은 차트를 모아 놓은 화면이 아니라, 질문에 필요한 정보만 남긴 화면입니다. 아래 원칙을 따르면 해석 비용이 낮고 빠른 의사결정을 도울 수 있습니다.
...
- **Data Warehouse 101 (7/10): BI와 Dashboard (현재 글)**
