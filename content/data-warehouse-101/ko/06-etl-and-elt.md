...
이 글에서 다룬 핵심은 세 가지입니다. 첫째 ETL과 ELT는 변환을 어디에서 다르게 수행할, 둘째 현대 Warehouse가 ELT를 선호하는 이유는 무엇일, 셋째 staging을 건너뛰면 어떤 문제가 생길입니다. 이 글에서 배울 것에서 시작해 실무 적용까지 이어지는 흐름을 따라가면 이 주제의 전체 그림이 잡힙니다.
