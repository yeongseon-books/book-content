...
이 글에서 다룬 핵심은 세 가지입니다. 첫째 Star Schema는 왜 분석에서 가장 자주 보일, 둘째 Snowflake Schema와는 어떤 점이 다를, 셋째 조인 홉 수가 성능과 가독성에 왜 중요할입니다. 이 글에서 배울 것에서 시작해 실무 적용까지 이어지는 흐름을 따라가면 이 주제의 전체 그림이 잡힙니다.
