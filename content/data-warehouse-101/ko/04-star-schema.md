...
이 글은 데이터 웨어하우스 101 시리즈의 4번째 글입니다.
...
Star Schema는 중앙의 Fact 테이블과 그 주변의 여러 Dimension 테이블로 구성됩니다. 이 구조로 조인 성능을 예측 가능하게 만들고 비즈니스 관점의 쿼리를 자연스럽게 구성할 수 있습니다.
...
Star Schema의 장점은 설명이 쉬운 구조라는 점입니다. 중심 fact 하나와 주변 dimension 몇 개만 합의되면 대부분의 BI 질의가 예측 가능한 조인 경로를 가집니다. 아래는 전자상거래 기준 최소 스키마입니다.
