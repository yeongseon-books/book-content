...
로컬에서만 머물던 Git이 협업 도구가 되는 순간은 remote가 생길 때입니다. 내 컴퓨터 안의 history를 GitHub와 연결해 두면 비로소 다른 사람과 다른 기기까지 같은 흐름에 들어옵니다.

이 글은 Git & GitHub 101 시리즈의 여섯 번째 글입니다. 여기서는 로컬 저장소를 GitHub에 연결하고 push, fetch, pull, clone 흐름을 순서대로 익힙니다.
