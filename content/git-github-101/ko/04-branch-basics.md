...
브랜치를 이해하는 순간 Git은 "백업 도구"에서 "병렬 작업 도구"로 바뀝니다. 같은 폴더 안에서 여러 줄기의 작업을 안전하게 나눠서 진행할 수 있다는 점이 Git 협업의 출발점입니다.

이 글은 Git & GitHub 101 시리즈의 네 번째 글입니다. 여기서는 branch를 만들고, 옮기고, 비교하는 기본 흐름을 먼저 익힙니다.
