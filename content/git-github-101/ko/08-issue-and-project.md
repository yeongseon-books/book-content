...
코드 이력만으로는 팀의 일이 어떻게 시작되고 어디까지 왔는지 설명되지 않습니다. Issue와 Project는 "무엇을 해야 하는지"와 "지금 어디쯤 왔는지"를 코드 옆에서 함께 관리하게 해 주는 도구입니다.

이 글은 Git & GitHub 101 시리즈의 여덟 번째 글입니다. 여기서는 issue, PR, project board를 한 흐름으로 연결해 일감을 추적하는 방법을 살펴봅니다.
