...
좋은 commit message는 사소한 예절이 아니라 미래의 비용을 줄이는 기록입니다. 코드만 다시 봐서는 잘 떠오르지 않는 변경의 이유를, 한 줄과 몇 문단으로 history 안에 남겨 두는 일이라고 생각하면 됩니다.

이 글은 Git & GitHub 101 시리즈의 아홉 번째 글입니다. 여기서는 좋은 subject, 필요한 body, 그리고 Conventional Commits 형식을 어떻게 실무에 녹이는지 다룹니다.
