...
- `TypeDecorator`는 어떤 공통 변환 로직을 모델 밖으로 빼내 줄까요?
- 엔진 이벤트와 세션 이벤트는 관측성과 outbox 패턴에 어떻게 연결될까요?

## 왜 중요한가

![핵심 개념](https://yeongseon-books.github.io/book-public-assets/assets/sqlalchemy-101/08/08-02-why-this-matters.ko.png)
