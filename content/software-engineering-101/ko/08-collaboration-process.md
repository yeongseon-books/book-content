...
**핵심 질문**: 회의가 줄면 왜 결과가 더 좋아지나요?

> 비동기 의사결정은 모두에게 시간을 돌려주고, 결정의 흔적을 남깁니다.

<!-- a-grade-intro:end -->

## 이 글에서 배울 것

- RFC(Request for Comments) 작성법
- 동기 vs 비동기 의사결정 기준
- 회의를 줄이는 4가지 패턴
- 의사결정 기록(DACI / RAPID)
- 분산 팀에서의 핸드오프
...
- **Async-first**: 글이 먼저, 회의는 마지막.
- **Decision log**: 누가 언제 무엇을 결정했나.
- **Handoff**: 시간대 간 작업 인계.
...
1. 이번 주 회의 1개를 RFC + 비동기 코멘트로 대체해 보세요.
2. 최근 결정 5개를 결정 로그 표로 옮겨 보세요.
3. 본인 팀의 핸드오프 노트 양식을 1페이지로 만들어 보세요.
