...
**핵심 질문**: "좋은 코드"와 "좋은 소프트웨어"는 같은 말인가요?

> 코드는 수단입니다. 소프트웨어는 사람이 오래 쓰는 시스템입니다.

<!-- a-grade-intro:end -->

## 이 글에서 배울 것

- 품질 속성(ISO/IEC 25010 요약)
- SOLID 원칙의 한 줄 의미
- 단순성과 지속 가능성의 관계
- 좋은 시스템의 4가지 외부 신호
- 마지막에 시니어가 보는 한 가지
...
- **Functional suitability**: 요구를 정확히 충족.
- **Reliability**: 예상 가능한 실패 빈도.
- **Maintainability**: 변경 비용.
- **Performance efficiency**: 자원당 처리량.
- **SOLID**: 객체지향 설계 5원칙.
...
1. 본인 프로젝트의 DORA 4 metrics 현재 값을 추정해 보세요.
2. SOLID 위반 1건을 찾아 SRP/DIP 관점으로 다시 써 보세요.
3. 본인 시스템의 외부 신호 4개를 정의해 보세요.
