...
- **TestPyPI 우선** — 릴리스 절차는 TestPyPI에서 먼저 검증합니다.
- **API 토큰** — 비밀번호 대신 토큰을 씁니다.
- **OIDC 배포** — GitHub Actions OIDC로 키 노출을 줄입니다.
- **롤백 불가** — 한 번 올린 파일은 못 바꾼다는 점을 인지합니다.
- **CHANGELOG** — 릴리스마다 변경 사항을 기록합니다.
