...
```bash
pip install mylib
# 다운로드 파일: mylib-0.1.0-py3-none-any.whl
# 설치 완료: mylib  ← 빌드 없이 바로 설치 (빠름)
```
...
# * sdist 생성 중...
# * wheel 생성 중...
# 빌드 완료: mylib-0.1.0.tar.gz, mylib-0.1.0-py3-none-any.whl

ls dist/
# 생성 파일: mylib-0.1.0-py3-none-any.whl
# 생성 파일: mylib-0.1.0.tar.gz
```
...
# 포함 파일: mylib/__init__.py
# 포함 파일: mylib/core.py
# 포함 파일: mylib-0.1.0.dist-info/METADATA
# 포함 파일: mylib-0.1.0.dist-info/WHEEL
# 포함 파일: mylib-0.1.0.dist-info/RECORD
```
...
# 포함 경로: mylib-0.1.0/
# 포함 경로: mylib-0.1.0/pyproject.toml
# 포함 경로: mylib-0.1.0/src/mylib/__init__.py
# 포함 경로: mylib-0.1.0/src/mylib/core.py
# 포함 경로: mylib-0.1.0/PKG-INFO
```
