...
도메인 코드 안에서 직접 객체를 만들면 그 도메인은 어떻게 만들지도 알게 됩니다. Factory와 DI는 "무엇을 쓸지"와 "어떻게 만들지"를 분리합니다.
...
```python
# 예시 파일: 5_container.py
# 작은 수제 컨테이너입니다 — 정말 필요할 때만 씁니다.
class Container:
