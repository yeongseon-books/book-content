...
Observer 패턴은 '무슨 일이 일어났다'와 '누가 그것에 반응하는가'를 떼어 놓아, 송신자는 수신자를 모르고 수신자는 송신자를 소유하지 않습니다. 이 글에서는 Observer가 풀려는 진짜 문제: 발신자와 수신자의 결합 끊기부터 Observer의 비용: 무엇을 잃는가까지 이 원칙을 구체적으로 살펴봤습니다. 핵심은 개념을 외우는 것이 아니라 실무에서 어떤 판단을 바꾸는지 이해하는 데 있습니다.
