...
- Singleton은 왜 자주 남용될까요?
- Prototype은 어떤 상황에서 생성보다 복제가 더 유리할까요?

> 멘탈 모델: Creational 패턴의 핵심은 객체 자체가 아니라 생성 책임의 위치입니다. 생성 로직이 퍼질수록 결합은 굳어지고, 생성 로직을 모을수록 교체와 테스트가 쉬워집니다.
...
![한눈에 보는 개념](https://yeongseon-books.github.io/book-public-assets/assets/design-patterns-101/02/02-01-concept-at-a-glance.ko.png)
*Creational 패턴은 생성 위치를 통제해 교체, 테스트, 확장을 쉽게 만드는 대표적인 네 가지 구조를 보여 줍니다.*
