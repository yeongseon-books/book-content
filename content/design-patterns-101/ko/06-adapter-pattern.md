...
published_to:
  tistory:
    url: "https://yeongseonchoe.tistory.com/188"
...
Adapter 패턴은 어느 한쪽도 다시 쓰지 않고, 거의 맞지만 정확히는 다른 두 인터페이스 사이에 얇은 번역기를 끼워 넣는 도구입니다. 이 글에서는 외부 SDK를 도메인이 원하는 모양으로 바꾸기부터 예외 번역은 Adapter의 책임이다까지 이 원칙을 구체적으로 살펴봤습니다. 핵심은 개념을 외우는 것이 아니라 실무에서 어떤 판단을 바꾸는지 이해하는 데 있습니다.
