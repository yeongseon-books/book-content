...
![클라이언트부터 앱 응답까지의 요청 경로](../../../assets/azure-app-service-101/02/01-full-request-lifecycle.ko.png)
...
![Frontend의 요청 차단과 전달 조건](../../../assets/azure-app-service-101/02/02-frontend-routing-decision.ko.png)
...
![Health Check 결과에 따른 인스턴스 상태 전이](../../../assets/azure-app-service-101/02/03-health-check-state-machine.ko.png)
...
![상태 코드별 실패 레이어 추적 관계](../../../assets/azure-app-service-101/02/04-failure-pattern-map.ko.png)
