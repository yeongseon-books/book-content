...
앞 장에서는 **Hosting Models: 어떤 플랜을 선택해야 할까?**을 다뤘습니다.
이 장을 마치면 다음 장에서 **Configuration 마스터하기: App Settings & 환경변수**으로 이어집니다.
<!-- ebook-only:end -->
...
<!-- blog-only:start -->
다음 글: [Configuration 마스터하기: App Settings & 환경변수](./05-configuration.md)
<!-- blog-only:end -->
