...
- Key Tools: Azure Portal, CLI, ARM/Bicep

**Runtime Plane**
- Role: Actual request processing
- Key Tools: Frontend + Worker instances

**SCM Plane**
- Role: Deployment and diagnostics
- Key Tools: Kudu (`.scm.azurewebsites.net`)
...
**`/home/site/wwwroot`**
- Purpose: Deployed app code

**`/home/LogFiles`**
- Purpose: App/platform logs
