...
**TLS Termination**
- Description: Decrypts HTTPS

**Host Validation**
- Description: Verifies request goes to correct app

**Access Restriction Evaluation**
- Description: IP restrictions, auth checks

**Instance Selection**
- Description: Routes to healthy Worker
...
**`403`**
- Meaning: Blocked by access restrictions

**`502`**
- Meaning: Backend connection failed
...
**CPU/Memory usage**
- Description: Instance resource saturation

**External dependencies**
- Description: DB, API call latency

**Threads/Event loop**
- Description: Concurrency limits

**Connection pools**
- Description: Outbound connection management
...
- Impact: Long-running requests → 504 Gateway Timeout

**Idle connection timeout**
- Impact: Idle sockets closed

**Slow dependencies**
- Impact: Queue buildup, tail latency increase
...
**Supports legacy session code**
- Cons: Uneven load distribution

**Utilizes in-memory cache**
- Cons: Vulnerable to instance failure
...
**Healthy**
- Traffic: Included in the routing pool

**Unhealthy**
- Traffic: Removed from the routing pool

**Recovering**
- Traffic: Re-included after probes pass
...
**Request logs**
- Purpose: Status code distribution

**Frontend diagnostics**
- Purpose: Platform-level errors

**Instance restarts**
- Purpose: Stability issues

**Dependency timing**
- Purpose: External call bottlenecks

**Correlation ID**
- Purpose: Per-request tracing
...
- First Check: Access restrictions, auth settings

**502/503 spike**
- Suspected Layer: Worker/app startup
- First Check: Restart events, Health probe

**504 responses**
- Suspected Layer: Long request path
- First Check: Dependency latency, request design

**Intermittent timeouts**
- Suspected Layer: Outbound
- First Check: SNAT, connection pools
