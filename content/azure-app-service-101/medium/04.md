...
**Python**
- Version/Requirement: 3.11 or higher

**Azure CLI**
- Version/Requirement: Latest version, logged in

**Azure Subscription**
- Version/Requirement: Active subscription
...
**Port binding error**
- Solution: Verify `$PORT` environment variable usage

**Startup command error**
- Solution: Check path and module name

**Dependency install failed**
- Solution: Check deployment logs for pip errors
