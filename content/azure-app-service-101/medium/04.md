...
![From local development to Azure deployment](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-app-service-101/04/01-deployment-pipeline.en.png)

---

## Prerequisites

- **Item**: Python / **Version/Requirement**: 3.11 or higher
- **Item**: Azure CLI / **Version/Requirement**: Latest version, logged in
- **Item**: Azure Subscription / **Version/Requirement**: Active subscription
...
![Azure resource hierarchy from subscription to web app](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-app-service-101/04/02-resource-hierarchy.en.png)
...
![Stepwise path to isolate 502 causes](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-app-service-101/04/03-troubleshooting-502.en.png)

- **Cause**: Port binding error / **Solution**: Verify `$PORT` environment variable usage
- **Cause**: Startup command error / **Solution**: Check path and module name
- **Cause**: Dependency install failed / **Solution**: Check deployment logs for pip errors
