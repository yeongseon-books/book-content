...
**CPU/Memory**
- Description: Resources available per instance

**Max Instance Count**
- Description: Scale out limit

**Feature Set**
- Description: Autoscale, Slots, VNet, etc.

**Pricing & SLA**
- Description: Cost and availability guarantees
...
- Key Limitations: Shared resources, limited features

**Basic**
- Use Case: Low traffic
- Key Limitations: Limited operational features

**Standard**
- Use Case: Basic production
- Key Limitations: Medium scale limits
...
**Isolated**
- Use Case: Compliance, network isolation
- Key Limitations: Highest cost, complexity
...
**Existing standards**
- Description: Environment your team knows

**Dependency compatibility**
- Description: Specific library requirements
...
**Startup speed**
- Linux: Generally faster
- Windows: Slightly slower
...
- Plan Dependent: No
- Deployment Model Dependent: Yes (Container)

**Platform Build**
- Plan Dependent: No
- Deployment Model Dependent: Yes (Code)
...
**Traffic**
- Question: Peak vs average request rate?

**Resources**
- Question: CPU-intensive vs IO-intensive?

**Memory**
- Question: Memory per request, background workers?

**Startup time**
- Question: Cold start frequency?
