...
- Connection Strings: DB connections only

**Format**
- App Settings: `KEY=VALUE`
- Connection Strings: Type can be specified

**App Access**
- App Settings: `os.environ["KEY"]`
- Connection Strings: `os.environ["SQLAZURECONNSTR_NAME"]`
...
**`APP_ENV`**
- Sticky?: Yes
- Reason: Staging is staging, production is production

**`DATABASE_URL`**
- Sticky?: Yes
- Reason: Different DB per environment

**`LOG_LEVEL`**
- Sticky?: No
- Reason: Usually the same

**`FEATURE_FLAG_X`**
- Sticky?: Depends
- Reason: Sticky when testing per slot
...
**Values visible in Portal**
- Key Vault Reference: Values hidden

**No version control**
- Key Vault Reference: Automatic versioning

**No audit logs**
- Key Vault Reference: Access audit logs

**Hard to share**
- Key Vault Reference: Reference from multiple apps
