...
![Configuration resolution flow](https://raw.githubusercontent.com/yeongseon/tech-blog/e8dca42/assets/azure-app-service-101/05/configuration-flow.en.png)
...
![Per-environment configuration strategies](https://raw.githubusercontent.com/yeongseon/tech-blog/e8dca42/assets/azure-app-service-101/05/environment-strategy.en.png)
...
- **Item**: Purpose / **App Settings**: General settings / **Connection Strings**: DB connections only
- **Item**: Format / **App Settings**: `KEY=VALUE` / **Connection Strings**: Type can be specified
- **Item**: App Access / **App Settings**: `os.environ["KEY"]` / **Connection Strings**: `os.environ["SQLAZURECONNSTR_NAME"]`
...
- **Setting**: `APP_ENV` / **Sticky?**: Yes / **Reason**: Staging is staging, production is production
- **Setting**: `DATABASE_URL` / **Sticky?**: Yes / **Reason**: Different DB per environment
- **Setting**: `LOG_LEVEL` / **Sticky?**: No / **Reason**: Usually the same
- **Setting**: `FEATURE_FLAG_X` / **Sticky?**: Depends / **Reason**: Sticky when testing per slot

![Slot setting behavior during swap](https://raw.githubusercontent.com/yeongseon/tech-blog/e8dca42/assets/azure-app-service-101/05/slot-settings-behavior.en.png)
...
![Key Vault Reference resolution flow](https://raw.githubusercontent.com/yeongseon/tech-blog/e8dca42/assets/azure-app-service-101/05/key-vault-reference-flow.en.png)

**Why Key Vault?**

- **Direct App Settings**: Values visible in Portal / **Key Vault Reference**: Values hidden
- **Direct App Settings**: No version control / **Key Vault Reference**: Automatic versioning
- **Direct App Settings**: No audit logs / **Key Vault Reference**: Access audit logs
- **Direct App Settings**: Hard to share / **Key Vault Reference**: Reference from multiple apps
