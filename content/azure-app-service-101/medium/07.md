...
- Cons: Triggers restart

**Feature upgrade**
- Cons: Cost can spike

**-**
- Cons: Upper limit exists
...
- Stateful Anti-pattern: Store sessions in memory

**Store state in DB**
- Stateful Anti-pattern: Store state in local files

**Use distributed cache**
- Stateful Anti-pattern: Per-instance cache
...
**Database**
- Check: Connection pool limit, max connections
...
**CPU Percentage**
- Purpose: Compute load
- Example Alert Threshold: > 80% for 5min

**Memory Percentage**
- Purpose: Memory pressure
- Example Alert Threshold: > 85% for 5min

**HTTP Queue Length**
- Purpose: Request backlog
- Example Alert Threshold: > 100

**Response Time**
- Purpose: User experience
- Example Alert Threshold: p95 > 2s

**Instance Count**
- Purpose: Cost
- Example Alert Threshold: > 8
...
**Memory shortage**
- Recommended Approach: Consider Scale Up

**Traffic increase**
- Recommended Approach: Scale Out first

**Both**
- Recommended Approach: Scale Up then Scale Out
...
**Availability**
- Strategy: Minimum 2 instances

**Cost control**
- Strategy: Maximum setting + Schedule

**Automation**
- Strategy: Autoscale + Alerts
