...
**`/home/LogFiles/*_docker.log`**
- Retention: ~35MB rolling
- Purpose: Container crashes, startup errors

**`/home/LogFiles/Application/`**
- Retention: Max 100MB/7 days
- Purpose: Short-term log archive

**Application Insights**
- Retention: 90 days default
- Purpose: Long-term analysis, alerts, KQL
