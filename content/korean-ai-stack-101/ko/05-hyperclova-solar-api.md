...
~~~
출력 결과
벡터 검색과 키워드 검색은 두 가지 다른 검색 방법입니다. 각각의 특징과 차이를 설명해 드리겠습니다.

**벡터 검색**

벡터 검색은 문서나 텍스트의 의미를 벡터로 표현하여 검색하는 방법입니다. 벡터는 문서의 내용을 숫자로 표현한 것입니다. 벡터 검색은 문서의 벡터와 사용자의 검색 쿼리 벡터를 비교하여 유사한 문서를 찾습니다.

벡터 검색의 특징은 다음과 같습니다.

* 문서의 의미를 숫자로 표현하여 검색할 수 있습니다.
* 문서의 내용을 파악하여 유사한 문서를 찾을 수 있습니다.
* 검색 쿼리와 문서의 벡터를 비교하여 유사한 문서를 찾을 수 있습니다.

**키워드 검색**

키워드 검색은 문서에 포함된 특정 키워드를 검색하는 방법입니다. 키워드는 문서의 내용을 대표하는 단어입니다. 키워드 검색은 문서에 포함된 키워드와 사용자의 검색 쿼리 키워드를 비교하여 유사한 문서를 찾습니다.

키워드 검색의 특징은 다음과 같습니다.

* 문서에 포함된 특정 키워드를 검색할 수 있습니다.
* 문서의 내용을 파악하여 유사한 문서를 찾을 수 없습니다.
* 검색 쿼리 키워드
~~~
