...
**핵심 질문**: *데이터 사이언스* 는 *분석* 과 무엇이 다르고, *왜 한 직업* 이 되었을까요?

> *데이터 사이언스는 *문제* 와 *데이터* 사이를 잇는 *직업* 이다.*
...
- **Data Analyst**: *지표/대시보드* 를 통해 *비즈니스 질문* 에 답한다.
- **Data Scientist**: *모델* 을 만들고 *실험* 으로 답한다.
- **ML Engineer**: 모델을 *서비스* 에 *얹는* 사람.
- **Data Engineer**: *파이프라인* 과 *warehouse* 를 만든다.
...
1. *최근 본 대시보드* 가 *어떤 결정* 으로 이어졌는지 적어 보세요.
2. *분석가* 와 *사이언티스트* 의 *공통점* 3가지를 적어 보세요.
3. *문제 정의* 한 줄짜리 예제를 *3개* 만들어 보세요.
