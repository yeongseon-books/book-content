...
`b"..."`는 byte 리터럴입니다. ASCII 범위 안에서만 쓸 수 있습니다.
...
파일이나 네트워크에서 들어오는 데이터는 일단 `bytes`입니다. UTF-8을 가정하고 `decode`하면 `str`이 됩니다.
...
f-string(PEP 498)은 가장 짧고 빠른 포매팅 방법입니다. 변수와 식을 중괄호 안에 그대로 넣습니다.
