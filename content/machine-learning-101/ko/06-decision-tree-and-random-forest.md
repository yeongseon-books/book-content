...
이 글에서 다룬 핵심은 세 가지입니다. 첫째, 결정 트리는 피처 공간을 어떤 기준으로 나눌까요. 둘째, Gini와 entropy는 무엇을 측정하고, 언제 결과가 달라질까요. 셋째, 단일 트리는 왜 쉽게 과적합되고, 어디서 멈춰야 할까요. 이 기초를 잡아 두면 다음 단계로 넘어갈 때 훨씬 안정적입니다.

## 처음 질문으로 돌아가기

- **결정 트리는 피처 공간을 어떤 기준으로 나눌까요?**
  - 결정 트리는 피처 공간을 어떤 기준으로 나눌까요 — 본문에서 단계별로 설명합니다.
- **Gini와 entropy는 무엇을 측정할까요?**
  - Gini와 entropy는 무엇을 측정할까요 — 본문에서 단계별로 설명합니다.
- **단일 트리는 왜 쉽게 과적합될까요?**
  - 단일 트리는 왜 쉽게 과적합될까요 — 본문에서 단계별로 설명합니다.
