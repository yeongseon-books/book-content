...
![프롬프트 엔지니어링 기초: System·User·Assistant 역할](../../../assets/llm-app-foundations-101/03/03-01-prompt-engineering-basics-system-user-an.ko.png)
...
![역할별 메시지가 한 배열로 모이는 구조](../../../assets/llm-app-foundations-101/03/03-01-understanding-the-three-roles.ko.png)
...
![system 유무에 따라 달라지는 답변 흐름](../../../assets/llm-app-foundations-101/03/03-02-how-a-system-message-changes-the-answer.ko.png)
...
![assistant 응답이 다음 턴에 재사용되는 흐름](../../../assets/llm-app-foundations-101/03/03-03-building-multi-turn-history-with-assista.ko.png)
...
![낮은 샘플링과 높은 샘플링 비교](../../../assets/llm-app-foundations-101/03/03-04-temperature-and-top-p-consistency-versus.ko.png)
...
![프롬프트 실수가 출력을 흔드는 관계](../../../assets/llm-app-foundations-101/03/03-05-common-prompt-design-mistakes.ko.png)
