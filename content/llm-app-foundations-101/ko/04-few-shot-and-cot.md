...
핵심은 예시가 “관련 주제”가 아니라 “원하는 출력 패턴”을 보여 줘야 한다는 점입니다. few-shot은 상식을 더하는 도구가 아니라 형식과 해석 리듬을 안정화하는 도구입니다.
...
나쁜 예시는 라벨이 일관되지 않거나, 답변 형식이 매번 바뀌거나, 실제 업무 입력과 너무 멀리 떨어져 있습니다. 반대로 좋은 예시는 짧고, 서로 일관되고, 실제로 들어올 요청과 닮아 있습니다. 예시 수보다 패턴의 선명함이 더 중요하다는 뜻입니다.
