...
category: billing
priority: high
reason: 팀 요금제 청구 금액이 예상보다 두 배 가까이 높아 예상치 못한 비용이 발생했습니다.

[few-shot]
category: billing
priority: high
reason: 팀 요금제 청구 금액 오류는 비정상적인 요금 청구로 인한 경제적 손실을 야기할 수 있다.
~~~
...
category: account
priority: high
reason: 비밀번호 재설정 메일이 오지 않으면 계정 사용이 불가하므로 즉시 대응이 필요하다.
~~~
