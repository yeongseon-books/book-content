...
앞 장에서는 **LLM API 첫걸음 — 모델에게 첫 번째 요청 보내기**을 다뤘습니다.
이 장을 마치면 다음 장에서 **프롬프트 엔지니어링 기초 — System·User·Assistant 역할**으로 이어집니다.
<!-- ebook-only:end -->
...
<!-- blog-only:start -->
다음 글: [프롬프트 엔지니어링 기초 — System·User·Assistant 역할](./03-prompt-engineering-basics.md)
<!-- blog-only:end -->
