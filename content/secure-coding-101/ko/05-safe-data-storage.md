...
법적으로도(GDPR, 개인정보보호법) 사고 비용 면에서도, *민감 데이터 누출* 은 가장 비싼 사고입니다. 평문 저장은 시한폭탄입니다.
...
**Before**: 주민번호와 카드번호를 그대로 DB 에 저장합니다. log 에도 그대로 남깁니다.

**After**: 주민번호는 해시로 처리하고, 카드번호는 *tokenize* 하고, 저장은 *KMS 키* 로 암호화합니다.
