...
- Dependabot이나 Renovate는 왜 작은 업데이트를 자주 만드는 편이 유리할까요?
- 전이 의존성은 왜 직접 추가한 패키지보다 더 위험할 수 있을까요?

> dependency는 우리 코드 바깥에 있는 부속품이 아니라, 결국 우리 서비스와 함께 배포되는 우리 코드의 일부입니다.
...
![매니페스트, lockfile, SCA, 업데이트 PR로 이어지는 공급망 방어 흐름](https://yeongseon-books.github.io/book-public-assets/assets/secure-coding-101/09/09-01-concept-at-a-glance.ko.png)

*매니페스트, lockfile, SCA, 업데이트 PR로 이어지는 공급망 방어 흐름*
