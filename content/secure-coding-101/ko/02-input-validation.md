...
- 타입, 범위, 길이, 형식 검사는 어떤 순서로 보는 편이 좋을까요?
- 오류 메시지와 국제화 입력은 왜 검증 설계에 함께 들어와야 할까요?

> 입력값 검증은 공격을 막는 첫 번째 방어선이면서, 시스템 동작을 예측 가능하게 만드는 첫 번째 품질 장치입니다.
...
![입력 검증을 경계, 스키마, 비즈니스 규칙으로 나눈 흐름](https://yeongseon-books.github.io/book-public-assets/assets/secure-coding-101/02/02-01-concept-at-a-glance.ko.png)
