...
![사용자가 인터넷을 통해 클라우드 제공자의 추상화된 자원을 요청하는 기본 흐름](https://yeongseon-books.github.io/book-public-assets/assets/cloud-computing-101/01/01-01-concept-at-a-glance.ko.png)

*사용자가 인터넷을 통해 클라우드 제공자의 추상화된 자원을 요청하는 기본 흐름*
