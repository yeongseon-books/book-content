...
운영 중인 시스템을 보지 못하면 문제가 생겼을 때 가장 먼저 알려 주는 사람은 늘 고객이 됩니다. 반대로 잘 설계된 알람 하나는 장애 대응 시간을 크게 줄여 주고, 주말 한 번을 통째로 지켜 주기도 합니다. 이 글은 Cloud Computing 101 시리즈의 8번째 글입니다. 여기서는 메트릭, 로그, 트레이스가 각각 어떤 질문에 답하는지부터 시작해 CloudWatch 알람까지 정리해 보겠습니다.
