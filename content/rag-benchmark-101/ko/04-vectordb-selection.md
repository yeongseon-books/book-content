...
![같은 벡터를 flat과 IVF에 넣는 비교 구조](../../../assets/rag-benchmark-101/04/04-01-same-vector-flat-and-ivf-comparison-stru.ko.png)
...
![임베딩 시간과 검색 시간을 분리하는 경계](../../../assets/rag-benchmark-101/04/04-02-boundary-between-embedding-and-search-ti.ko.png)
...
![실제 운영 조건으로 인덱스를 고르는 판단 축](../../../assets/rag-benchmark-101/04/04-04-index-decision-axes-for-real-workloads.ko.png)
