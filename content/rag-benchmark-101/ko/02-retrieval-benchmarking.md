...
![질의와 지연 시간을 함께 묶는 검색 벤치마크 루프](../../../assets/rag-benchmark-101/02/02-01-benchmark-loop-for-queries-and-latency.ko.png)
...
![Hit rate와 MRR를 함께 읽는 검색 품질 축](../../../assets/rag-benchmark-101/02/02-02-retrieval-quality-axes-with-hit-rate-and.ko.png)
...
![질문과 정답 ID를 함께 남기는 벤치마크 기록](../../../assets/rag-benchmark-101/02/02-04-benchmark-record-with-gold-ids-and-logs.ko.png)
