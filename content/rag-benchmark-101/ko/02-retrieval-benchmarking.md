...
![이 글에서 답할 질문](../../../assets/rag-benchmark-101/02/02-01-questions-this-post-answers.en.png)
...
![질의와 지연 시간을 함께 묶는 검색 벤치마크 루프](../../../assets/rag-benchmark-101/02/02-01-benchmark-loop-for-queries-and-latency.en.png)
...
![Hit rate와 MRR를 함께 읽는 검색 품질 축](../../../assets/rag-benchmark-101/02/02-02-retrieval-quality-axes-with-hit-rate-and.en.png)
...
![Hit rate는 높지만 순위 품질은 약한 실패 패턴](../../../assets/rag-benchmark-101/02/02-03-high-hit-rate-with-weak-ranking.en.png)
...
![질문과 정답 ID를 함께 남기는 벤치마크 기록](../../../assets/rag-benchmark-101/02/02-04-benchmark-record-with-gold-ids-and-logs.en.png)
