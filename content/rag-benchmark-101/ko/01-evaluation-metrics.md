...
retrieval 지표는 정답 문서 집합과 검색 결과 리스트를 비교하는 일입니다. 이 두 집합을 분리해서 보면 Precision@k, Recall@k, MRR가 각각 무엇을 드러내는지 훨씬 선명하게 읽힙니다.

이 글은 RAG 평가와 벤치마크 101 시리즈의 첫 번째 글입니다.
...
![쿼리당·평균 리포트를 함께 읽는 흐름](../../../assets/rag-benchmark-101/01/01-05-per-query-and-average-report-reading-flo.ko.png)

*쿼리당·평균 리포트를 함께 읽는 흐름*
