...
![Questions this post answers](../../../assets/document-ingestion-101/04/04-01-questions-this-post-answers.ko.png)
...
![Incremental scan and change detection flow](../../../assets/document-ingestion-101/04/04-01-incremental-scan-and-change-detection.ko.png)
...
![State store and hash comparison flow](../../../assets/document-ingestion-101/04/04-02-state-store-and-hash-comparison.ko.png)
...
![Added updated and deleted decision flow](../../../assets/document-ingestion-101/04/04-01-added-updated-and-deleted-paths.ko.png)
...
![Index version and run history flow](../../../assets/document-ingestion-101/04/04-02-index-version-and-run-history-flow.ko.png)
