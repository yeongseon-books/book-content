...
대시보드의 *모든 숫자* 는 *몇 가지 패턴* 의 변주입니다. 이 패턴을 익혀 두면 *새 요청이 와도* *몇 분* 안에 초안을 쓸 수 있습니다. 그리고 *팀의 SQL 자산* 이 됩니다.

> *분석 SQL 은 *시리즈의 마지막 시험* 이자 시작점이다.*
...
**After**: *cohort, funnel, retention* 의 템플릿을 조립만 한다.
...
4. **Funnel 의 *순서 무시*.** 단계는 *시간 순* 으로 체크해야.
