...
- `ORDER BY`, `LIMIT`, `DISTINCT`는 각각 어떤 비용을 가질까요?
- `SELECT *`는 언제부터 위험해질까요?

> SELECT는 단순히 읽는 문장이 아니라, 어떤 결과를 어떤 모양으로 보여 줄지 설계하는 문장입니다.
...
![SELECT 평가 흐름](https://yeongseon-books.github.io/book-public-assets/assets/sql-101/02/02-01-select-evaluation-flow.ko.png)
