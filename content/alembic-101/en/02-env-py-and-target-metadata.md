...
- The difference between online and offline mode and when each one matters
- The two or three options you almost always need on SQLite + Alembic
...
![where env.py assembles metadata and connectivity](https://yeongseon-books.github.io/book-public-assets/assets/alembic-101/02/02-01-diagram-where-env-py-assembles-metadata.en.png)
