---
title: "Alembic 101 (3/10): Your first revision: writing upgrade and downgrade by hand"
series: alembic-101
episode: 3
language: en
...
A revision file ultimately comes down to how well you write `upgrade()` and `downgrade()`. Until you have done one by hand, it is hard to read an autogenerated migration critically.

This is the 3rd post in the Alembic 101 series. Here we will walk through the structure of a first revision and the rules for writing safe upgrade and downgrade paths.
