...
![다이어그램: schema와 data를 분리하는 3단계](https://yeongseon-books.github.io/book-public-assets/assets/alembic-101/06/06-01-diagram-the-three-stage-split-for-data-m.ko.png)
*느린 row 변환을 가운데 단계로 분리하면 lock 시간과 실패 복구 범위를 제어하기 쉽습니다*
