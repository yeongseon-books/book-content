...
- “downgrade 금지” 정책을 코드로 어떻게 표현할까요?
- 사고가 났을 때 forward-fix와 downgrade 중 무엇을 선택해야 할까요?
...
![다이어그램: reversible과 irreversible 판단 흐름](https://yeongseon-books.github.io/book-public-assets/assets/alembic-101/08/08-01-diagram-deciding-between-reversible-and.ko.png)
*변경 성격을 먼저 분류해야 downgrade를 쓸지 막을지 정직하게 결정할 수 있습니다*
