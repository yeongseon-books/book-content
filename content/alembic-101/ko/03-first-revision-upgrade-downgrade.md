...
![다이어그램: revision 파일의 양방향 계약](https://yeongseon-books.github.io/book-public-assets/assets/alembic-101/03/03-01-diagram-the-two-way-contract-inside-a-re.ko.png)
*좋은 revision은 `upgrade`와 `downgrade`가 같은 변경을 정확히 왕복하게 만듭니다*
