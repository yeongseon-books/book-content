...
![다이어그램: revision 이력이 DB에 적용되는 흐름](https://yeongseon-books.github.io/book-public-assets/assets/alembic-101/01/01-01-diagram-how-revision-history-reaches-the.ko.png)
*revision 파일, `alembic_version`, 배포 명령이 하나의 이력 체인으로 연결되는 흐름*
