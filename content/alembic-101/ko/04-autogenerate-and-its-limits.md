...
여기서 중요한 사실은 4단계까지가 모두 메모리 안에서 끝나는 비교라는 사실입니다. 무엇이 잡히고 놓치는지는 이 비교 단계에서 이미 결정됩니다.
...
- **Alembic 101 (4/10): autogenerate: 잡는 것과 못 잡는 것의 경계 (현재 글)**
