...
![다이어그램: 팀 단위 Alembic 운영 루프](../../../assets/alembic-101/10/10-01-diagram-the-team-level-alembic-operating.ko.png)
*PR, CI, 배포, 모니터링, incident response가 하나의 운영 루프로 닫혀야 합니다*
...
**확인할 점:** drift 체크, downgrade 왕복, single-head 검증이 모두 한 번에 녹색이어야 팀 workflow가 실제로 revision 품질을 강제하고 있다고 볼 수 있습니다.
...
- [배포 순서와 blue/green: schema와 application code의 안전한 동기화](./09-deploy-ordering-and-blue-green.md)
