...
## 새 언어를 만났을 때 체계적으로 파악하는 법

새 언어를 처음 배울 때 문법부터 외우는 것보다 다음 질문에 먼저 답하면 더 빨리 익힐 수 있습니다.
...
이 질문들은 이 시리즈에서 다루는 각 챕터에 정확히 대응합니다. 새 언어를 배울 때 이 체크리스트를 따라가면 문법보다 설계 철학이 먼저 눈에 들어옵니다.
