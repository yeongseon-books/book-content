...
동적 계획법은 공식을 외우는 주제가 아니라 상태를 잘 정의하는 연습에 가깝습니다. 같은 부분 문제를 반복해서 푼다는 신호를 읽을 수 있으면 DP는 훨씬 덜 막연해집니다.

이 글은 Algorithms 101 시리즈의 6번째 글입니다. 여기서는 동적 계획법의 두 조건, 메모이제이션과 타뷸레이션의 차이, 그리고 상태 정의의 감각을 다룹니다.
