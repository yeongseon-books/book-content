...
그리디 알고리즘은 가장 단순해 보이지만, 통하는 조건을 놓치면 가장 위험해지기도 합니다. 지금의 최선이 전체의 최선으로 이어지는지 증명해야 비로소 안심할 수 있습니다.

이 글은 Algorithms 101 시리즈의 7번째 글입니다. 여기서는 그리디 알고리즘이 통하는 조건과 교환 논증의 사고법, 그리고 대표적인 그리디 문제의 판단 기준을 정리합니다.
