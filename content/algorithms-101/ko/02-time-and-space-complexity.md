...
복잡도는 "이 코드가 지금 빠른가"보다 "입력이 커져도 버틸 수 있는가"를 판단하는 언어입니다. 빅오를 이해하면 측정 결과가 없어도 비용의 방향을 먼저 읽을 수 있습니다.

이 글은 Algorithms 101 시리즈의 2번째 글입니다. 여기서는 빅오 표기법과 평균·최악·분할 상환의 차이, 그리고 이론과 측정을 함께 보는 비용 분석법을 다룹니다.
