...
알고리즘을 잘 푼다는 말은 답을 많이 외운다는 뜻이 아닙니다. 새로운 문제를 봤을 때 제약을 읽고, 패턴을 고르고, 검증 순서를 세우는 절차가 더 중요합니다.

이 글은 Algorithms 101 시리즈의 마지막 글입니다. 여기서는 문제 풀이에서 패턴을 인식하고 도구를 선택하는 사고 절차를 정리하며 시리즈를 마무리합니다.
