...
![비용 추적 흐름과 최적화 지점](../../../assets/llm-apps-ops-101/02/02-01-big-picture.en.png)

*비용 추적 흐름과 최적화 지점*

## 왜 이 레이어가 중요한가

![호출별 토큰이 누적 비용으로 모이는 흐름](../../../assets/llm-apps-ops-101/02/02-01-why-this-layer-matters.en.png)
...
예제 파일: `/root/Github/llm-apps-ops-101/en/02-cost-tracking/main.py`
...
![반복 프롬프트가 캐시 후보가 되는 구조](../../../assets/llm-apps-ops-101/02/02-02-what-to-notice-in-this-code.en.png)
...
![최적화 레버에 품질 검증이 함께 필요한 구조](../../../assets/llm-apps-ops-101/02/02-03-where-engineers-get-confused.en.png)
