...
![self-test가 헬스체크와 채팅 요청을 검증하는 흐름](../../../assets/llm-apps-ops-101/05/05-01-big-picture.en.png)

*self-test가 헬스체크와 채팅 요청을 검증하는 흐름*

## 왜 이 레이어가 중요한가

![서버 기동 확인이 헬스체크로 이어지는 흐름](../../../assets/llm-apps-ops-101/05/05-02-why-this-layer-matters.en.png)
...
예제 파일: `/root/Github/llm-apps-ops-101/en/05-deployment/main.py`
...
![비동기 엔드포인트가 동기 모델 호출을 분리하는 구조](../../../assets/llm-apps-ops-101/05/05-03-what-to-notice-in-this-code.en.png)
...
![self-test가 기동과 종료를 함께 검증하는 구조](../../../assets/llm-apps-ops-101/05/05-04-where-engineers-get-confused.en.png)
