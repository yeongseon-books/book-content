...
![공통 로그 스키마가 운영 질문을 하나로 묶는 구조](../../../assets/llm-apps-ops-101/01/01-02-what-to-notice-in-this-code.ko.png)
...
![메트릭과 로그가 함께 실패 범위를 좁히는 구조](../../../assets/llm-apps-ops-101/01/01-03-where-engineers-get-confused.ko.png)
