...
![메모리와 상태 분리](../../../assets/ai-agent-101/05/05-01-memory-and-state-split.ko.png)
## 핵심 개념

### memory와 state를 한 장의 흐름으로 보면 설계 경계가 선명해집니다

![memory와 state를 한 장의 흐름으로 보면 설계 경계가 선명해집니다](../../../assets/ai-agent-101/05/05-01-short-term-memory-vs-long-term-memory.ko.png)
