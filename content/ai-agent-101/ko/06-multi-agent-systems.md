...
![멀티 에이전트 handoff 그래프](../../../assets/ai-agent-101/06/06-01-multi-agent-handoff-graph.ko.png)
## 핵심 개념

### 먼저 위임 그래프를 그리면 multi-agent가 필요한지 더 빨리 판단할 수 있습니다

![위임 그래프로 multi-agent 필요성을 빠르게 판단](../../../assets/ai-agent-101/06/06-01-multi-agent-patterns.ko.png)
