...
![First request waiting for a ready worker](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-app-service-deep-dive/06/06-01-the-cold-path-and-the-warm-path.en.png)
...
![Linux warm-up path and startup limit](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-app-service-deep-dive/06/06-02-linux-apps.en.png)
...
![Periodic pings reducing idle coldness](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-app-service-deep-dive/06/06-03-what-always-on-really-does.en.png)
...
![Extra warm-up path beyond the root ping](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-app-service-deep-dive/06/06-04-when-windows-needs-applicationinitializa.en.png)
...
![Warm-up responses and startup timeout contract](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-app-service-deep-dive/06/06-05-linux-warm-up-path-and-startup-timeout.en.png)
...
![Costs stacked inside a cold start](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-app-service-deep-dive/06/06-06-what-makes-cold-start-expensive.en.png)
...
![Traffic switching after staging warm-up completes](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-app-service-deep-dive/06/06-07-why-deployment-slots-help-so-much.en.png)
...
![Different roles of Always On, warm-up, and health](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-app-service-deep-dive/06/06-08-always-on-warm-up-and-health-are-not-the.en.png)
...
- [App Service platform architecture — Front-End, Worker, File Server](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-app-service-deep-dive/en/01-platform-architecture.md)
- [Front-End and ARR — how a request reaches a worker](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-app-service-deep-dive/en/02-front-end-and-arr.md)
- [Workers and the sandbox — where user code actually runs](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-app-service-deep-dive/en/03-worker-and-sandbox.md)
- [Deployment and Kudu — build, sync, release from the inside](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-app-service-deep-dive/en/04-deployment-and-kudu.md)
- [Scaling internals — how Scale Out decisions become new workers](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-app-service-deep-dive/en/05-scaling-internals.md)
...
**Related Series**
- [Azure App Service 101 — Request Lifecycle](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-app-service-101/en/02-request-lifecycle.md)
- [Azure Functions Deep Dive — Cold start and Placeholder Mode](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-deep-dive/en/06-cold-start-placeholder.md)
