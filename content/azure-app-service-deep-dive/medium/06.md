...
- [Deployment and Kudu — build, sync, release from the inside](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-app-service-deep-dive/en/04-deployment-and-kudu.md)
- [Scaling internals — how Scale Out decisions become new workers](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-app-service-deep-dive/en/05-scaling-internals.md)
...
- [Azure Functions Deep Dive — Cold start and Placeholder Mode](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-functions-deep-dive/en/06-cold-start-placeholder.md)
