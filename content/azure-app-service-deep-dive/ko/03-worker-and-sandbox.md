...
로컬에서는 되는데 App Service에서는 실패하는 문제는 프레임워크 내부 미스터리인 경우보다 실행 경계 문제인 경우가 더 많습니다. Windows code app은 sandbox 안에서 움직이고, Linux 앱은 container 계약 안에서 움직인다는 차이를 먼저 이해해야 장애 원인이 정리됩니다.

이 글은 Azure App Service Deep Dive 시리즈의 3번째 글입니다.
...
이 한 그림이 Windows App Service에서 “왜 PDF 변환기 하나만 유독 안 되지?”라는 질문이 어디서 시작되는지 보여 줍니다.
...
이건 “Azure가 이상하다”는 뜻이 아니라,
웹 워크로드에 맞춰 의도적으로 좁혀 둔 Windows sandbox의 결과입니다.
...
공개 문서도 그런 방식으로 설명하지 않습니다.
대신 컨테이너 시작 계약,
포트 바인딩,
스토리지 마운트,
시작 시간 제한이 더 중요한 축입니다.
...
- [ ] Always On 사용 여부의 비용/안정성 균형을 결정했다
