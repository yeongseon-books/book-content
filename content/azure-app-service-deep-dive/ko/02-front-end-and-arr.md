...
이 글은 Azure App Service Deep Dive 시리즈의 2번째 글입니다.
...
- **Front-End는 단순 로드밸런서를 넘어 실제로 어떤 종류의 결정을 먼저 내릴까요?**
  - Front-End는 단순 로드밸런서를 넘어 실제로 어떤 종류의 결정을 먼저 내릴까요 — 본문에서 구체적으로 다룹니다.
- **ARR Affinity 쿠키는 애플리케이션 세션 쿠키와 무엇이 다를까요?**
  - ARR Affinity 쿠키는 애플리케이션 세션 쿠키와 무엇이 다를까요 — 본문에서 구체적으로 다룹니다.
- **요청이 어느 앱과 어느 슬롯에 속하는지 정하는 단계와 worker를 고르는 단계는 어떻게 다를까요?**
  - 요청이 어느 앱과 어느 슬롯에 속하는지 정하는 단계와 worker를 고르는 단계는 어떻게 다를까요 — 본문에서 구체적으로 다룹니다.
- **왜 이 글이 중요한가에서 가장 흔한 실수는 무엇일까요?**
  - Front-End와 ARR을 이해하지 못하면 App Service의 많은 증상이 우연처럼 보입니다.
- **핵심 관점을 실무에 적용할 때 주의할 점은 무엇일까요?**
  - 이 주제를 가장 명확하게 이해하는 방법은 Front-End 라우팅을 한 번에 뭉개지 않는 것입니다.
- **핵심 개념의 핵심 원리를 한 문장으로 설명하면 무엇일까요?**
  - 이 주제를 가장 명확하게 이해하는 방법은 Front-End 라우팅을 한 번에 뭉개지 않는 것입니다.
...
- [Azure App Service Deep Dive (6/6): 콜드 스타트와 Warmup — 첫 요청이 비싼 이유](./06-cold-start-and-warmup.md)
