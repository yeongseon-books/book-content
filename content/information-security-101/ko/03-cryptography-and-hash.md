...
암호화와 해시는 이름이 자주 함께 나오지만 맡는 일이 다릅니다. 어떤 상황에서 어떤 도구를 써야 하는지 구분할 수 있어야 “암호화는 했는데 왜 여전히 취약하지?” 같은 질문에 답할 수 있습니다.

> 암호화는 비밀을 지키고, 해시는 무결성을 확인하고, 서명은 출처를 증명합니다.

- 대칭키와 공개키 암호화는 어떻게 다를까요?
- 해시와 HMAC은 어디서 갈릴까요?
- 왜 단순 암호화만으로는 충분하지 않고 AEAD가 필요할까요?
- nonce와 IV는 왜 키만큼 중요할까요?
- 어떤 상황에 어떤 알고리즘을 써야 할까요?
