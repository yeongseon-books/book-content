...
- sinusoidal positional embedding과 learned positional embedding은 어떻게 다를까요?
- `token_emb + pos_emb`라는 한 줄이 왜 GPT 입력부의 핵심일까요?
...
## 임베딩을 이해하는 가장 좋은 방법: 의미를 담은 거대한 룩업 테이블 두 개를 더하는 것으로 보는 것입니다
