...
이 글은 시리즈 9편 중 4번째 장입니다.
앞 장에서는 **어떤 토큰을 얼마나 볼지 스스로 정하기**을 다뤘습니다.
이 장을 마치면 다음 장에서 **조립: GPT 모델 클래스 완성**으로 이어집니다.
<!-- ebook-only:end -->
...
![Pre-norm과 post-norm LayerNorm 배치 차이](../../../assets/llm-from-scratch-101/04/04-01-layernorm-pre-norm-vs-post-norm.ko.png)
