...
이 글은 시리즈 9편 중 7번째 장입니다.
앞 장에서는 **기울기로 배우기**을 다뤘습니다.
이 장을 마치면 다음 장에서 **베이스 모델을 우리 작업에 맞추기**으로 이어집니다.
<!-- ebook-only:end -->
...
![다음 토큰을 붙여 가는 생성 흐름](../../../assets/llm-from-scratch-101/07/07-01-autoregressive-generation-one-token-at-a.ko.png)
