...
- top-k와 top-p는 각각 어떤 방식으로 후보 토큰을 제한할까요?
- 모델의 `block_size`보다 긴 문맥은 어떻게 처리해야 할까요?
...
## 생성 루프를 이해하는 가장 좋은 방법: 다음 토큰 분포를 반복해서 소비하는 자기회귀 피드백 루프로 보는 것입니다
...
![한 토큰씩 이어 붙이는 자기회귀 생성 루프](https://yeongseon-books.github.io/book-public-assets/assets/llm-from-scratch-101/07/07-01-autoregressive-generation-one-token-at-a.ko.png)

*현재 문맥에서 마지막 위치의 분포를 읽고 새 토큰을 붙이는 과정이 반복됩니다.*
