...
### Step 1. `train.py` 하나로 학습 전 과정을 묶습니다
...
### Step 2. 로그가 어떻게 내려가야 정상인지 먼저 알고 시작합니다
...
### Step 3. train loss만 보면 절반만 본 것입니다
...
### Step 4. 한 배치만 과적합시키는 빠른 디버그 루프를 따로 둡니다
...
### Step 5. 체크포인트는 실험 맥락까지 함께 저장해야 합니다
