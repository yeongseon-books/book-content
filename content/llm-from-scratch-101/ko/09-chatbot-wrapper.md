...
- `/chat`과 `/chat/stream`은 어떤 UX 차이를 만들까요?
- SSE streaming은 왜 작은 모델에서도 체감 품질을 올려 줄까요?
...
## 챗봇을 이해하는 가장 좋은 방법: 모델, 히스토리, 스트리밍, UI가 묶인 작은 시스템으로 보는 것입니다
...
![모델, 히스토리, 스트리밍, UI를 잇는 챗봇 파이프라인](https://yeongseon-books.github.io/book-public-assets/assets/llm-from-scratch-101/09/09-01-chatbot-model-history-streaming-ui.ko.png)

*생성 모델을 실제 대화형 애플리케이션으로 바꾸는 최소 구성 요소를 보여 주는 그림입니다.*
