...
이 글은 시리즈 9편 중 1번째 장입니다.
이 장을 마치면 다음 장에서 **정수에서 벡터로, 그리고 위치**으로 이어집니다.
<!-- ebook-only:end -->
...
![단어 단위와 서브워드의 절충 관계](../../../assets/llm-from-scratch-101/01/01-01-vs.ko.png)
...
<!-- blog-only:start -->
다음 글: [정수에서 벡터로, 그리고 위치](./02-embedding.md)
<!-- blog-only:end -->
