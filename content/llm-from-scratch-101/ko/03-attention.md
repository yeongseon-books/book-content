...
> 어텐션은 모든 토큰을 똑같이 섞는 장치가 아닙니다. 현재 토큰이 지금 필요한 정보에 더 큰 가중치를 주도록 만드는 동적 조회 계층입니다.
...
![미래 토큰을 보지 못하게 막는 causal mask](https://yeongseon-books.github.io/book-public-assets/assets/llm-from-scratch-101/03/03-01-causal-mask.ko.png)
