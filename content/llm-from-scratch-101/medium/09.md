...
![Chatbot = Model + History + Streaming + UI](https://raw.githubusercontent.com/yeongseon/tech-blog/e8dca42/assets/llm-from-scratch-101/09/09-01-chatbot-model-history-streaming-ui.en.png)
...
- [Deciding Which Tokens to Focus On](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/llm-from-scratch-101/en/03-attention.md)
- [The Transformer Block: A Unit of Depth](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/llm-from-scratch-101/en/04-transformer-block.md)
- [Assembly: Completing the GPT Model Class](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/llm-from-scratch-101/en/05-gpt-model.md)
- [Learning via Gradients](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/llm-from-scratch-101/en/06-training-loop.md)
- [Sampling — Generating Text from a Trained Model](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/llm-from-scratch-101/en/07-inference.md)
- [Adapting the Base Model to Specific Tasks](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/llm-from-scratch-101/en/08-finetuning.md)
