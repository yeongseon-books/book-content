...
이 글에서 다룬 핵심은 세 가지입니다. 첫째 더 나은 인터페이스는 무엇으로 판단할 수 있을, 둘째 추상화 수준이 너무 낮거나 높으면 어떤 문제가 생길, 셋째 다형성은 분기문을 어떻게 줄여 줄입니다. 전체 그림에서 시작해 실무 적용까지 이어지는 흐름을 따라가면 이 주제의 전체 그림이 잡힙니다.

## 처음 질문으로 돌아가기

- **더 나은 인터페이스는 무엇으로 판단할 수 있을까요?**
  - 더 나은 인터페이스는 무엇으로 판단할 수 있을까요 — 본문에서 단계별로 설명합니다.
- **추상화 수준이 너무 낮거나 높으면 어떤 문제가 생길까요?**
  - 추상화 수준이 너무 낮거나 높으면 어떤 문제가 생길까요 — 본문에서 단계별로 설명합니다.
- **다형성은 분기문을 어떻게 줄여 줄까요?**
  - 다형성은 분기문을 어떻게 줄여 줄까요 — 본문에서 단계별로 설명합니다.
- **전체 그림에서 가장 흔한 실수는 무엇일까요?**
  - 호출자는 하나의 모양만 알고, 여러 구현은 그 뒤에 놓입니다. 이 구조가 잘 작동하려면 인터페이스가 호출자의 관심사와 같은 높이에서 설계되어야 합니다.
- **기본 용어을 실무에 적용할 때 주의할 점은 무엇일까요?**
