...
이 글에서 다룬 핵심은 세 가지입니다. 첫째 관심사란 정확히 무엇일, 둘째 한 모듈이 너무 많은 일을 하는지 어떻게 알아낼 수 있을, 셋째 결합도와 응집도는 관심사 분리와 어떤 관계가 있을입니다. 전체 그림에서 시작해 실무 적용까지 이어지는 흐름을 따라가면 이 주제의 전체 그림이 잡힙니다.

## 처음 질문으로 돌아가기

- **관심사란 정확히 무엇일까요?**
  - 관심사란 정확히 무엇일까요 — 본문에서 단계별로 설명합니다.
- **한 모듈이 너무 많은 일을 하는지 어떻게 알아낼 수 있을까요?**
  - 한 모듈이 너무 많은 일을 하는지 어떻게 알아낼 수 있을까요 — 본문에서 단계별로 설명합니다.
- **결합도와 응집도는 관심사 분리와 어떤 관계가 있을까요?**
  - 결합도와 응집도는 관심사 분리와 어떤 관계가 있을까요 — 본문에서 단계별로 설명합니다.
- **전체 그림에서 가장 흔한 실수는 무엇일까요?**
  - UI, 도메인, 인프라는 바뀌는 속도도 이유도 다릅니다. 이 셋을 같은 상자에 넣으면 작은 변경도 넓게 번집니다. 분리를 잘하면 세 관심사가 서로 다른 속도로 움직일 수 있습니다.
- **기본 용어을 실무에 적용할 때 주의할 점은 무엇일까요?**
