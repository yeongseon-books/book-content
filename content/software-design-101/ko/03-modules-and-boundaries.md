...
이 글에서 다룬 핵심은 세 가지입니다. 첫째 좋은 모듈 경계는 어떤 조건을 갖춰야 할, 둘째 깊은 모듈과 얕은 모듈은 무엇이 다를, 셋째 공개 API는 어디까지 드러내야 할입니다. 전체 그림에서 시작해 실무 적용까지 이어지는 흐름을 따라가면 이 주제의 전체 그림이 잡힙니다.

## 처음 질문으로 돌아가기

- **좋은 모듈 경계는 어떤 조건을 갖춰야 할까요?**
  - 좋은 모듈 경계는 어떤 조건을 갖춰야 할까요 — 본문에서 단계별로 설명합니다.
- **깊은 모듈과 얕은 모듈은 무엇이 다를까요?**
  - 깊은 모듈과 얕은 모듈은 무엇이 다를까요 — 본문에서 단계별로 설명합니다.
- **공개 API는 어디까지 드러내야 할까요?**
  - 공개 API는 어디까지 드러내야 할까요 — 본문에서 단계별로 설명합니다.
- **전체 그림에서 가장 흔한 실수는 무엇일까요?**
  - 좋은 모듈은 표면이 작고 내부가 깊습니다. 외부에는 간단한 약속만 보이지만, 내부에서는 의미 있는 일을 많이 처리합니다.
- **기본 용어을 실무에 적용할 때 주의할 점은 무엇일까요?**
