...
이 글에서 다룬 핵심은 세 가지입니다. 첫째 한 번의 변경이 얼마나 넓게 퍼지는지 어떻게 가늠할, 둘째 OCP는 실제 코드에서 어떤 모습으로 나타날, 셋째 새 경로를 추가할 때 왜 기존 경로를 바로 지우지 않을입니다. 전체 그림에서 시작해 실무 적용까지 이어지는 흐름을 따라가면 이 주제의 전체 그림이 잡힙니다.

## 처음 질문으로 돌아가기

- **한 번의 변경이 얼마나 넓게 퍼지는지 어떻게 가늠할까요?**
  - 한 번의 변경이 얼마나 넓게 퍼지는지 어떻게 가늠할까요 — 본문에서 단계별로 설명합니다.
- **OCP는 실제 코드에서 어떤 모습으로 나타날까요?**
  - OCP는 실제 코드에서 어떤 모습으로 나타날까요 — 본문에서 단계별로 설명합니다.
- **새 경로를 추가할 때 왜 기존 경로를 바로 지우지 않을까요?**
  - 새 경로를 추가할 때 왜 기존 경로를 바로 지우지 않을까요 — 본문에서 단계별로 설명합니다.
- **전체 그림에서 가장 흔한 실수는 무엇일까요?**
  - 흐름은 보통 확장하고, 나란히 돌려 보고, 점진적으로 갈아탄 뒤, 마지막에 옛 경로를 정리하는 순서로 갑니다. 정리까지 끝나야 변경이 완료됩니다.
- **기본 용어을 실무에 적용할 때 주의할 점은 무엇일까요?**
