...
이 글에서 다룬 핵심은 세 가지입니다. 첫째 설계 원칙은 외워야 하는 규칙일까요, 진단 도구일, 둘째 SRP, OCP, LSP, ISP, DIP는 각각 어떤 냄새에 반응할, 셋째 KISS와 YAGNI는 언제 구조를 단순하게 붙잡아 줄입니다. 전체 그림에서 시작해 실무 적용까지 이어지는 흐름을 따라가면 이 주제의 전체 그림이 잡힙니다.

## 처음 질문으로 돌아가기

- **설계 원칙은 외워야 하는 규칙일까요, 진단 도구일까요?**
  - 설계 원칙은 외워야 하는 규칙일까요, 진단 도구일까요 — 본문에서 단계별로 설명합니다.
- **SRP, OCP, LSP, ISP, DIP는 각각 어떤 냄새에 반응할까요?**
  - SRP, OCP, LSP, ISP, DIP는 각각 어떤 냄새에 반응할까요 — 본문에서 단계별로 설명합니다.
- **KISS와 YAGNI는 언제 구조를 단순하게 붙잡아 줄까요?**
  - KISS와 YAGNI는 언제 구조를 단순하게 붙잡아 줄까요 — 본문에서 단계별로 설명합니다.
- **전체 그림에서 가장 흔한 실수는 무엇일까요?**
  - 코드 냄새를 먼저 보고, 어떤 원칙이 깨졌는지 짚은 뒤, 그 원칙에 맞춰 구조를 고치는 흐름이 실전 감각에 가깝습니다.
- **기본 용어을 실무에 적용할 때 주의할 점은 무엇일까요?**
