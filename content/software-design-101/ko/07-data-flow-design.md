...
이 글에서 다룬 핵심은 세 가지입니다. 첫째 데이터 흐름을 설계한다는 말은 구체적으로 무엇일, 둘째 입력과 출력 사이를 왜 한 방향으로만 흐르게 해야 할, 셋째 변환 단계와 부수효과는 어떻게 나누는 편이 좋을입니다. 전체 그림에서 시작해 실무 적용까지 이어지는 흐름을 따라가면 이 주제의 전체 그림이 잡힙니다.

## 처음 질문으로 돌아가기

- **데이터 흐름을 설계한다는 말은 구체적으로 무엇일까요?**
  - 데이터 흐름을 설계한다는 말은 구체적으로 무엇일까요 — 본문에서 단계별로 설명합니다.
- **입력과 출력 사이를 왜 한 방향으로만 흐르게 해야 할까요?**
  - 입력과 출력 사이를 왜 한 방향으로만 흐르게 해야 할까요 — 본문에서 단계별로 설명합니다.
- **변환 단계와 부수효과는 어떻게 나누는 편이 좋을까요?**
  - 변환 단계와 부수효과는 어떻게 나누는 편이 좋을까요 — 본문에서 단계별로 설명합니다.
- **전체 그림에서 가장 흔한 실수는 무엇일까요?**
  - 좋은 흐름은 짧고 분명합니다. 각 단계는 작은 책임만 맡고, 다음 단계로 값을 넘깁니다.
- **기본 용어을 실무에 적용할 때 주의할 점은 무엇일까요?**
