...
- **클로저는 바깥 스코프의 변수를 어떻게 기억할까요?**
  - 클로저는 바깥 스코프의 변수를 어떻게 기억할까요 — 본문에서 구체적으로 다룹니다.
- **자유 변수와 cell object는 디버깅에서 왜 중요한 단서일까요?**
  - 자유 변수와 cell object는 디버깅에서 왜 중요한 단서일까요 — 본문에서 구체적으로 다룹니다.
- **`functools.partial`은 어떤 상황에서 클로저보다 더 적합할까요?**
  - `functools.partial`은 어떤 상황에서 클로저보다 더 적합할까요 — 본문에서 구체적으로 다룹니다.
- **개념 개요에서 가장 흔한 실수는 무엇일까요?**
  - > 클로저의 핵심은 안쪽 함수가 바깥 변수에 대한 참조를 들고 있다는 사실입니다.
- **클로저와 `partial` 선택 흐름을 실무에 적용할 때 주의할 점은 무엇일까요?**
  - 클로저와 `partial` 선택 흐름을 실무에 적용할 때 주의할 점은 무엇일까요 — 본문에서 구체적으로 다룹니다.
- **핵심 개념의 핵심 원리를 한 문장으로 설명하면 무엇일까요?**
