...
이 글은 Functional Programming 101 시리즈의 4번째 글입니다.
...
- **고차 함수는 어떤 두 형태로 나타날까요?**
  - 고차 함수는 어떤 두 형태로 나타날까요 — 본문에서 구체적으로 다룹니다.
- **`sorted`, `map`, `filter`는 왜 고차 함수의 대표 예시일까요?**
  - `sorted`, `map`, `filter`는 왜 고차 함수의 대표 예시일까요 — 본문에서 구체적으로 다룹니다.
- **함수를 반환하는 팩토리 패턴은 어떤 상황에서 유용할까요?**
  - 함수를 반환하는 팩토리 패턴은 어떤 상황에서 유용할까요 — 본문에서 구체적으로 다룹니다.
- **개념 개요에서 가장 흔한 실수는 무엇일까요?**
  - > 고차 함수는 크게 두 가지입니다. 함수를 인자로 받거나, 함수를 반환합니다.
- **핵심 개념을 실무에 적용할 때 주의할 점은 무엇일까요?**
  - > 고차 함수는 크게 두 가지입니다. 함수를 인자로 받거나, 함수를 반환합니다.
...
- **Functional Programming 101 (4/10): 고차 함수 (현재 글)**
