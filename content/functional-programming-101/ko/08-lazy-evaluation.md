...
- **eager evaluation과 lazy evaluation은 무엇이 다를까요?**
  - eager evaluation과 lazy evaluation은 무엇이 다를까요 — 본문에서 구체적으로 다룹니다.
- **제너레이터 함수와 제너레이터 표현식은 어떤 상황에서 유용할까요?**
  - 제너레이터 함수와 제너레이터 표현식은 어떤 상황에서 유용할까요 — 본문에서 구체적으로 다룹니다.
- **무한 시퀀스와 큰 데이터를 Python에서는 어떻게 안전하게 다룰 수 있을까요?**
  - 무한 시퀀스와 큰 데이터를 Python에서는 어떻게 안전하게 다룰 수 있을까요 — 본문에서 구체적으로 다룹니다.
- **개념 개요에서 가장 흔한 실수는 무엇일까요?**
  - > eager는 값을 즉시 만들고, lazy는 필요해질 때까지 미룹니다.
- **핵심 개념을 실무에 적용할 때 주의할 점은 무엇일까요?**
  - > eager는 값을 즉시 만들고, lazy는 필요해질 때까지 미룹니다.
...
- **Functional Programming 101 (8/10): 지연 평가와 제너레이터 (현재 글)**
