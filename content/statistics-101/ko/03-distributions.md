...
- 긴 꼬리 분포에서는 어떤 지표를 먼저 봐야 할까요?

> 분포는 데이터의 성격표이며, 통계 도구는 그 성격에 맞춰 골라야 합니다.
...
![멘탈 모델](https://yeongseon-books.github.io/book-public-assets/assets/statistics-101/03/03-01-concept-at-a-glance.ko.png)
