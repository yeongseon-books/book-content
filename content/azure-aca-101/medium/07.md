...
- [Environment, Container App, Revision — ACA in three words](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-aca-101/en/02-environment-app-revision.md)
- [Your first deploy — Python/FastAPI](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-aca-101/en/03-first-deploy.md)
- [Ingress and traffic splitting — revision-based deployment strategies](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-aca-101/en/04-ingress-and-traffic-split.md)
- [Scaling — KEDA scalers and zero-to-N](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-aca-101/en/05-scaling-with-keda.md)
- [Dapr integration — what you get from a sidecar](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-aca-101/en/06-dapr-integration.md)
