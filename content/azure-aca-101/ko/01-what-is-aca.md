...
- 이 시리즈의 7개 글은 ACA의 각 부분을 어떤 순서로 확대해 나갈까요?
...
![Ingress and app layout in one ACA environment](../../../assets/azure-aca-101/01/01-01-the-big-picture-one-aca-environment-at-a.ko.png)
...
![Client request flow to an active revision](../../../assets/azure-aca-101/01/01-02-the-path-of-one-request.ko.png)
...
- Environment, Container App, Revision — ACA in three words (예정)
- Your first deploy — Python/FastAPI (예정)
