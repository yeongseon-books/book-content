...
- 핵심 개념 1 — 한 문장 정의의 핵심 원리를 한 문장으로 설명하면 무엇일까요?
...
- [ ] Azure Container Apps(ACA)는 다른 Azure 컨테이너 서비스(App Service, AKS, Functions)와 무엇이 다를까요
- [ ] ACA의 세 가지 핵심 구성 요소인 Environment, Container App, Revision은 각각 어떤 역할을 할 수 있다
- [ ] 어떤 워크로드는 ACA에 잘 맞고, 어떤 워크로드는 다른 서비스에 두는 편이 나을까요
...
이 글에서 다룬 핵심은 세 가지입니다. 첫째 Azure Container Apps(ACA)는 다른 Azure 컨테이너 서비스(App Service, AKS, Functions)와 무엇이 다를, 둘째 ACA의 세 가지 핵심 구성 요소인 Environment, Container App, Revision은 각각 어떤 역할을 할, 셋째 어떤 워크로드는 ACA에 잘 맞고, 어떤 워크로드는 다른 서비스에 두는 편이 나을입니다. 왜 이 글이 중요한가에서 시작해 실무 적용까지 이어지는 흐름을 따라가면 이 주제의 전체 그림이 잡힙니다.

## 처음 질문으로 돌아가기

- **Azure Container Apps(ACA)는 다른 Azure 컨테이너 서비스(App Service, AKS, Functions)와 무엇이 다를까요?**
  - Azure Container Apps(ACA)는 다른 Azure 컨테이너 서비스(App Service, AKS, Functions)와 무엇이 다를까요 — 본문에서 단계별로 설명합니다.
- **ACA의 세 가지 핵심 구성 요소인 Environment, Container App, Revision은 각각 어떤 역할을 할까요?**
  - ACA의 세 가지 핵심 구성 요소인 Environment, Container App, Revision은 각각 어떤 역할을 할까요 — 본문에서 단계별로 설명합니다.
- **어떤 워크로드는 ACA에 잘 맞고, 어떤 워크로드는 다른 서비스에 두는 편이 나을까요?**
  - 어떤 워크로드는 ACA에 잘 맞고, 어떤 워크로드는 다른 서비스에 두는 편이 나을까요 — 본문에서 단계별로 설명합니다.
- **왜 이 글이 중요한가에서 가장 흔한 실수는 무엇일까요?**
  - 컨테이너 하나 만드는 일은 누구나 할 수 있습니다. 노트북에서도 잘 뜹니다. 어려운 지점은 그다음부터입니다.
- **멘탈 모델을 실무에 적용할 때 주의할 점은 무엇일까요?**
  - 멘탈 모델을 실무에 적용할 때 주의할 점은 무엇일까요 — 본문에서 단계별로 설명합니다.
- **핵심 개념 1 — 한 문장 정의의 핵심 원리를 한 문장으로 설명하면 무엇일까요?**
  - 핵심 개념 1 — 한 문장 정의의 핵심 원리를 한 문장으로 설명하면 무엇일까요 — 본문에서 단계별로 설명합니다.
