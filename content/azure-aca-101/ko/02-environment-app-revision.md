...
![environment, container app, and revision hierarchy](../../../assets/azure-aca-101/02/02-01-start-with-the-hierarchy.ko.png)
...
- <strong>Environment, Container App, Revision — ACA in three words (현재 글)</strong>
