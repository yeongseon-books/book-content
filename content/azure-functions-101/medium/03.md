...
**Function App**
- What it is: The unit of deployment, billing, and scaling. A container concept that groups multiple functions
- Unit: The Azure resource you actually see

**Host**
- What it is: The .NET runtime process running on a Function App instance
- Unit: One per instance

**Worker**
- What it is: The language runtime process the Host spawns
- Unit: One or more per instance (tunable via `FUNCTIONS_WORKER_PROCESS_COUNT`)
