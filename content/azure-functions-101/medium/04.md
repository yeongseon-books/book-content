...
- Role: Local runs + deployment command (`func`)
- Install: `npm i -g azure-functions-core-tools@4`

**Azure CLI**
- Role: Create and manage Azure resources
- Install: OS-specific install ([official docs](https://learn.microsoft.com/en-us/cli/azure/install-azure-cli))

**Python 3.11+**
- Role: Worker runtime
- Install: pyenv or the official installer
...
**Resource Group**
- Role: Logical container for related resources

**Storage Account**
- Role: Required storage for host state, locks, and trigger metadata

**Function App**
- Role: The compute resource that runs your functions
