...
- **Tool**: **Azure Functions Core Tools** / **Role**: Local runs + deployment command (`func`) / **Install**: `npm i -g azure-functions-core-tools@4`
- **Tool**: **Azure CLI** / **Role**: Create and manage Azure resources / **Install**: OS-specific install ([official docs](https://learn.microsoft.com/en-us/cli/azure/install-azure-cli))
- **Tool**: **Python 3.11+** / **Role**: Worker runtime / **Install**: pyenv or the official installer
...
![Flow from local run to Azure](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-functions-101/04/04-01-the-full-flow-on-one-page.en.png)
---
...
- **Resource**: **Resource Group** / **Role**: Logical container for related resources
- **Resource**: **Storage Account** / **Role**: Required storage for host state, locks, and trigger metadata
- **Resource**: **Function App** / **Role**: The compute resource that runs your functions

![Required Azure resources before deployment](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-functions-101/04/04-02-4-create-azure-resources.en.png)
...
![Local code deployment into Function App](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-functions-101/04/04-03-5-deploy.en.png)
