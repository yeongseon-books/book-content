...
![Two scaling axes: instances and concurrency](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-functions-101/06/06-01-scaling-has-two-axes-instance-count-and.en.png)
...
![Plan reactions to a traffic spike](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-functions-101/06/06-02-how-the-plans-react-to-a-traffic-spike.en.png)
...
![Cold start stages before first invocation](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-functions-101/06/06-03-what-a-cold-start-actually-includes.en.png)
...
![Mismatch between function scale and downstream capacity](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-functions-101/06/06-04-1-downstream-systems-do-not-scale-with-y.en.png)
...
If you want the implementation details behind those behaviors, pair this chapter with [Deep Dive — Scaling internals](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-deep-dive/en/05-scaling-internals.md) and [Deep Dive — Cold starts and Placeholder Mode](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-deep-dive/en/06-cold-start-placeholder.md). The 101 series is about operational judgment; the deep-dive series shows how those behaviors are implemented in the host.
...
- [Triggers and Bindings — Everything About Function I/O](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-101/en/02-triggers-and-bindings.md)
- [Host and Worker — Who Actually Runs Your Functions?](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-101/en/03-host-and-worker.md)
- [Deploy a Function App — From Localhost to Azure](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-101/en/04-first-deploy.md)
- [Which Plan Should You Pick? — Consumption / Flex / Premium / Dedicated](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-101/en/05-choosing-a-plan.md)
...
**Related Series**
- [Azure Functions 101 — Choosing a plan](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-101/en/05-choosing-a-plan.md)
- [Azure Functions 101 — Monitoring and operations fundamentals](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-101/en/07-monitoring-and-ops.md)
- [Azure Functions Deep Dive — Scaling internals](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-deep-dive/en/05-scaling-internals.md)
- [Azure Functions Deep Dive — Cold starts and Placeholder Mode](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-deep-dive/en/06-cold-start-placeholder.md)
