...
If you want the implementation details behind those behaviors, pair this chapter with [Deep Dive — Scaling internals](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-deep-dive/en/05-scaling-internals.md) and [Deep Dive — Cold starts and Placeholder Mode](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-deep-dive/en/06-cold-start-placeholder.md). The 101 series is about operational judgment; the deep-dive series shows how those behaviors are implemented in the host.

---

## In this series

- [What Is Azure Functions? — A World Where Events Call Your Code](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-101/en/01-what-is-azure-functions.md)
- [Triggers and Bindings — Everything About Function I/O](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-101/en/02-triggers-and-bindings.md)
- [Host and Worker — Who Actually Runs Your Functions?](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-101/en/03-host-and-worker.md)
- [Deploy a Function App — From Localhost to Azure](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-101/en/04-first-deploy.md)
- [Which Plan Should You Pick? — Consumption / Flex / Premium / Dedicated](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-101/en/05-choosing-a-plan.md)
...
**Related Series**
- [Azure Functions 101 — Choosing a plan](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-101/en/05-choosing-a-plan.md)
- [Azure Functions 101 — Monitoring and operations fundamentals](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-101/en/07-monitoring-and-ops.md)
...
- [Azure Functions Deep Dive — Cold starts and Placeholder Mode](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-deep-dive/en/06-cold-start-placeholder.md)
