...
If you want the implementation details behind those behaviors, pair this post with [Deep Dive Part 5](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-deep-dive/en/05-scaling-internals.md) and [Part 6](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-deep-dive/en/06-cold-start-placeholder.md). The 101 series is about operational judgment; the deep-dive series shows how those behaviors are implemented in the host.
...
**Related Series**
- [Azure Functions 101 Part 5 — Choosing a plan](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-101/en/05-choosing-a-plan.md)
- [Azure Functions 101 Part 7 — Monitoring and operations fundamentals](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-101/en/07-monitoring-and-ops.md)
- [Azure Functions Deep Dive Part 5 — Scaling internals](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-deep-dive/en/05-scaling-internals.md)
- [Azure Functions Deep Dive Part 6 — Cold starts and Placeholder Mode](https://github.com/yeongseon/tech-blog/blob/e8dca42/content/azure-functions-deep-dive/en/06-cold-start-placeholder.md)
