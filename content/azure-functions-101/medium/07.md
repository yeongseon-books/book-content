...
If you want to go deeper into the implementation, continue with [Deep Dive Part 5](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-functions-deep-dive/en/05-scaling-internals.md) and [Part 6](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-functions-deep-dive/en/06-cold-start-placeholder.md). The 101 series is about making good engineering decisions quickly; the deep-dive series shows how those behaviors are built inside the host.
...
- [Scaling and Cold Starts — When Serverless Feels Fast and When It Doesn’t](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-functions-101/en/06-scaling-and-cold-start.md)
...
**Related Series**
- [Azure Functions 101 Part 6 — Scaling and cold starts](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-functions-101/en/06-scaling-and-cold-start.md)
