...
![Live Metrics signals for early triage](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-functions-101/07/07-01-the-first-screen-to-open-during-an-incid.en.png)
...
![First-response checks during an incident](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-functions-101/07/07-02-a-useful-3am-incident-order-of-operation.en.png)
...
If you want to go deeper into the implementation, continue with [Deep Dive — Scaling internals](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-deep-dive/en/05-scaling-internals.md) and [Deep Dive — Cold starts and Placeholder Mode](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-deep-dive/en/06-cold-start-placeholder.md). The 101 series is about making good engineering decisions quickly; the deep-dive series shows how those behaviors are built inside the host.
...
- [Scaling and Cold Starts — When Serverless Feels Fast and When It Doesn’t](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-101/en/06-scaling-and-cold-start.md)
...
**Related Series**
- [Azure Functions 101 — Scaling and cold starts](https://github.com/yeongseon/tech-writing/blob/f24a126/content/azure-functions-101/en/06-scaling-and-cold-start.md)
