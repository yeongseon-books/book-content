...
**Consumption**
- One-line definition: The simplest pay-per-use serverless plan. Today it is a legacy option and should be treated as Windows-first.

**Flex Consumption**
- One-line definition: Microsoft's recommended Linux-based pay-per-use plan for new serverless apps, with VNet support, selectable memory, and per-function scaling.

**Premium**
- One-line definition: A higher-end plan that reduces or avoids cold starts through Always Ready and prewarmed capacity, with VNet support and larger SKUs.

**Dedicated (App Service Plan)**
- One-line definition: Functions running on regular App Service infrastructure, where scaling is managed through App Service rules instead of event-driven platform scaling.
