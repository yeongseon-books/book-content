...
- **Plan**: **Consumption** / **One-line definition**: The simplest pay-per-use serverless plan. Today it is a legacy option and should be treated as Windows-first.
- **Plan**: **Flex Consumption** / **One-line definition**: Microsoft's recommended Linux-based pay-per-use plan for new serverless apps, with VNet support, selectable memory, and per-function scaling.
- **Plan**: **Premium** / **One-line definition**: A higher-end plan that reduces or avoids cold starts through Always Ready and prewarmed capacity, with VNet support and larger SKUs.
- **Plan**: **Dedicated (App Service Plan)** / **One-line definition**: Functions running on regular App Service infrastructure, where scaling is managed through App Service rules instead of event-driven platform scaling.
...
![Plan differences in billing, warm capacity, scaling](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-functions-101/05/05-01-big-picture.en.png)
...
- **Feature**: **Current status** / **Consumption**: Legacy / **Flex Consumption**: Default serverless recommendation / **Premium**: Advanced serverless / **Dedicated**: App Service family
- **Feature**: **Billing model** / **Consumption**: Execution-based pay-per-use / **Flex Consumption**: Execution-based pay-per-use, plus Always Ready capacity if enabled / **Premium**: Instance time and provisioned capacity / **Dedicated**: App Service Plan SKU
- **Feature**: **Cost at zero traffic** / **Consumption**: 0 / **Flex Consumption**: 0 if Always Ready stays at 0 / **Premium**: Minimum instance cost remains / **Dedicated**: Always billed
- **Feature**: **Cold starts** / **Consumption**: Present / **Flex Consumption**: Reduced when needed via Always Ready / **Premium**: Usually avoidable / **Dedicated**: Effectively absent when always running
- **Feature**: **OS** / **Consumption**: Windows legacy; Linux Consumption retired/retiring / **Flex Consumption**: Linux only / **Premium**: Windows / Linux / **Dedicated**: Windows / Linux
- **Feature**: **VNet integration** / **Consumption**: No / **Flex Consumption**: Yes / **Premium**: Yes / **Dedicated**: Yes
- **Feature**: **Max instances** / **Consumption**: Roughly 200; lower in some OS and platform cases / **Flex Consumption**: Up to 1000, subject to regional 250-core default quota / **Premium**: Roughly 20-100+, depending on OS, region, and restrictions / **Dedicated**: Defined by App Service Plan SKU and autoscale rules
- **Feature**: **Event-driven autoscale** / **Consumption**: Yes (event-driven) / **Flex Consumption**: Yes (per-function, target-based) / **Premium**: Yes (target-based optional) / **Dedicated**: Manual via App Service autoscale rules
- **Feature**: **Per-function scaling** / **Consumption**: No / **Flex Consumption**: Yes / **Premium**: No / **Dedicated**: No
- **Feature**: **Instance memory** / **Consumption**: Fixed at 1.5 GB / **Flex Consumption**: 512 / 2048 / 4096 MB / **Premium**: Varies by SKU / **Dedicated**: Depends on App Service Plan SKU
- **Feature**: **Deployment slots** / **Consumption**: Limited / **Flex Consumption**: No; use the rolling update path / **Premium**: Yes / **Dedicated**: Yes
- **Feature**: **Warmup trigger** / **Consumption**: No / **Flex Consumption**: Yes / **Premium**: Yes / **Dedicated**: Yes
...
![Hosting plan choice by requirements](https://raw.githubusercontent.com/yeongseon/tech-writing/f24a126/assets/azure-functions-101/05/05-02-decision-tree.en.png)
