...
**HTTP / Webhook**
- Trigger: HTTP, Event Grid
- Typical use case: REST APIs, receiving webhooks from external SaaS

**Schedule**
- Trigger: Timer
- Typical use case: Settlement batches, periodic cleanup jobs

**Storage**
- Trigger: Blob, Queue
- Typical use case: Post-processing uploaded files, async work queues

**Messaging**
- Trigger: Service Bus, Event Hub, Kafka
- Typical use case: Async messaging between microservices, telemetry ingestion

**Database**
- Trigger: Cosmos DB Change Feed, SQL
- Typical use case: Reacting to data changes (CDC pattern)
