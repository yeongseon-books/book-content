...
**Related Series**
- [Azure Functions Deep Dive](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-functions-deep-dive/en) — for the code-level view of how the Host and binding extensions behave
