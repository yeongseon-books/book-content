...
**Related Series**
- [Azure Functions Deep Dive](https://github.com/yeongseon/tech-blog/blob/e8dca42/azure-functions-deep-dive/en) — if you want the code-level version of the Host/Worker story
