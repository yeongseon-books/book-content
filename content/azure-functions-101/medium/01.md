...
![Start With the Smallest Example — Hello, Function](https://raw.githubusercontent.com/yeongseon/tech-writing/cb179c5/assets/azure-functions-101/01/01-01-start-with-the-smallest-example-hello-fu.en.png)
...
- **Aspect**: Deployment unit / **Always-on (App Service / VM)**: The whole application / **Event-driven (Functions)**: Per function (grouped in a Function App)
- **Aspect**: Run time / **Always-on (App Service / VM)**: Always running / **Event-driven (Functions)**: Only when an event arrives
- **Aspect**: Scaling unit / **Always-on (App Service / VM)**: Number of instances (VMs) / **Event-driven (Functions)**: Concurrent function executions
- **Aspect**: Billing model / **Always-on (App Service / VM)**: Per hour (instance uptime) / **Event-driven (Functions)**: Execution time + invocation count (or hybrid)
...
![How Is This Different From a Traditional Web App?](https://raw.githubusercontent.com/yeongseon/tech-writing/cb179c5/assets/azure-functions-101/01/01-02-how-is-this-different-from-a-traditional.en.png)
...
![The Four Core Concepts of Azure Functions](https://raw.githubusercontent.com/yeongseon/tech-writing/cb179c5/assets/azure-functions-101/01/01-03-the-four-core-concepts-of-azure-function.en.png)
...
**Related Series**
- [Azure Functions Deep Dive](https://github.com/yeongseon/tech-writing/blob/cb179c5/content/azure-functions-deep-dive/en) — if you want the code-level version of the Host/Worker story
