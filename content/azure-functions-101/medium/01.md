...
**Deployment unit**
- Always-on (App Service / VM): The whole application
- Event-driven (Functions): Per function (grouped in a Function App)

**Run time**
- Always-on (App Service / VM): Always running
- Event-driven (Functions): Only when an event arrives

**Scaling unit**
- Always-on (App Service / VM): Number of instances (VMs)
- Event-driven (Functions): Concurrent function executions

**Billing model**
- Always-on (App Service / VM): Per hour (instance uptime)
- Event-driven (Functions): Execution time + invocation count (or hybrid)
