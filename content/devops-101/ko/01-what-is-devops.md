...
- 실무에서 DevOps를 시작하려면 어떤 자동화부터 붙이는 편이 좋을까요?
- 팀이 DevOps를 한다고 착각하기 쉬운 대표적인 함정은 무엇일까요?

> **멘탈 모델**: DevOps는 Jenkins나 Kubernetes 같은 도구 이름이 아닙니다. 코드를 만드는 팀과 운영하는 팀이 같은 피드백 루프를 공유하면서, 함께 만들고 함께 배포하고 함께 책임지는 작업 방식입니다.
...
![한눈에 보는 개념](https://yeongseon-books.github.io/book-public-assets/assets/devops-101/01/01-01-diagram.ko.png)
