...
배포는 *가장 위험한 순간*입니다. 좋은 전략은 *영향 범위*를 줄이고 되돌리기를 쉽게 만듭니다.

> *배포 가능성*과 *기능 활성화*는 분리되어야 합니다.
...
- 스테이징은 *프로덕션과 동일 환경*이어야 합니다.
- Canary의 *기준 지표* 는 *사전 정의* 합니다.
- *Rollback 명령어* 는 *runbook* 에 박아둡니다.

## 자주 하는 실수 5가지

1. **CI는 자동인데 *CD는 수동*인 상태.** 사람이 끼면 실수가 끼어듭니다.
