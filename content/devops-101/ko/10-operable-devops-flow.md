...
- 주간, 월간, 분기별 팀 리듬은 DevOps를 어떻게 습관으로 만들까요?
- 이 시리즈 다음 단계로 Observability, SRE, Kubernetes를 어떻게 이어서 공부하면 좋을까요?

> **멘탈 모델**: DevOps는 개별 도구의 집합이 아니라 피드백 루프입니다. 코드 작성부터 배포, 모니터링, 장애 대응, 포스트모템이 다시 코드와 프로세스로 돌아와야 팀이 지속적으로 배웁니다.
...
![한눈에 보는 개념](https://yeongseon-books.github.io/book-public-assets/assets/devops-101/10/10-01-diagram.ko.png)
