...
- 메모리 지역성은 어떤 코드에서 드러날까요?
- 파이썬 `list`가 진짜 수치 배열과 다르게 느린 이유는 무엇일까요?

> 알고리즘 차수를 낮춘 뒤에도 성능 차이가 남는다면, 그다음 질문은 거의 항상 메모리 접근 패턴입니다. CPU는 빠르고 메모리는 느리며, 캐시는 그 간극을 메우기 위해 존재합니다.
...
![한눈에 보는 개념](https://yeongseon-books.github.io/book-public-assets/assets/computer-science-101/05/05-01-concept-at-a-glance.ko.png)
*위 계층일수록 빠르고 작으며, 아래 계층일수록 느리지만 큽니다*
