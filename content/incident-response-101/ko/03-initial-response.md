...
이 글은 Incident Response 101 시리즈의 3번째 글입니다.

incident가 발생했을 때 처음 몇 분은 유난히 짧고도 길게 느껴집니다. 알림은 이미 울렸고, 아직 정보는 부족하고, 누군가는 원인을 찾자고 하고 누군가는 고객 공지를 걱정합니다. 이때 무엇부터 할지 정해 두지 않으면 팀은 빠르게 분산됩니다.
