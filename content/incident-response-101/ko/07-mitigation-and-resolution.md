...
Mitigation은 즉각적인 영향 차단이고, Resolution은 근본 원인 수정입니다. 두 단계의 목적과 타이밍이 다릅니다.
...
- **불을 끄는 일과 원인을 없애는 일은 어떻게 다를까요?**
  ...
  - Mitigation은 즉각적인 영향 차단(circuit breaker, 트래픽 우회)입니다.
  - 예제와 그림에서는 어떤 값이 들어오고, 어느 단계에서 바뀌며, 어떤 기준으로 통과 또는 실패하는지를 먼저 확인해야 합니다.
  - Resolution은 근본 원인을 수정하는 건데, 이건 대응 중에 할 수도, 나중에 할 수도 있습니다.
