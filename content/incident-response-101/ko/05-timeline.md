...
- **incident가 끝난 뒤 무엇이 언제 일어났는지 어떻게 복원할까요?**
  - incident가 끝난 뒤 무엇이 언제 일어났는지 어떻게 복원할까요에 대해 본문에서 실무 예시와 함께 답합니다.
- **왜 사건 중간에 바로 기록해야 할까요?**
  - 왜 사건 중간에 바로 기록해야 할까요에 대해 본문에서 실무 예시와 함께 답합니다.
- **한 채널이 아니라 여러 채널을 함께 스크랩해야 하는 이유는 무엇일까요?**
  - timeline은 incident가 끝난 뒤 기억으로 쓰는 이야기가 아니라, 대응 중 남긴 사실을 시간순으로 정리한 기록입니다
- **왜 이 주제가 중요한가에서 가장 흔한 실수는 무엇일까요?**
  - 기억은 생각보다 빨리 왜곡됩니다. incident 직후에는 모두가 선명하게 기억한다고 믿지만, 며칠만 지나도 순서가 바뀌고, 나중에 알게 된 사실을 마치 당시에도 알고 있었던 것처럼 덧붙이기 쉽습니다.
- **한눈에 보는 구조을 실무에 적용할 때 주의할 점은 무엇일까요?**
  - 기록원은 하나가 아니어야 합니다. 채팅 채널, 호출 시스템, 배포 로그를 함께 모아 시간순으로 정리해야 사건의 실제 흐름이 드러납니다.
- **전후 비교의 핵심 원리를 한 문장으로 설명하면 무엇일까요?**
  - 이전: 사건이 끝난 뒤 기억에만 의존해 재구성합니다.
