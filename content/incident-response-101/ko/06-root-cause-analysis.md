...
이후 상태의 장점은 사고 재발 가능성을 더 정확히 줄일 수 있다는 사실입니다. 사람 한 명이나 마지막 이벤트 하나를 바꾸는 것보다, 사건을 가능하게 만든 구조를 바꾸는 편이 훨씬 오래 갑니다.
...
- **incident의 진짜 원인은 어떻게 찾아야 할까요?**
  - trigger만 고치면 같은 root cause는 다음 incident에서 다시 터집니다
- **왜 5 Whys가 여전히 유용할까요?**
  - trigger만 고치면 같은 root cause는 다음 incident에서 다시 터집니다
- **trigger와 root cause는 어디서 갈릴까요?**
  - 예를 들어 새 배포 직후 결제 장애가 났다고 가정해 보겠습니다. 이때 “배포가 원인”이라고 적는 것은 trigger 수준 설명에 가깝습니다. 조금 더 내려가 보면 이렇게 정리할 수 있습니다.
