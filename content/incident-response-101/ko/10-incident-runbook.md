...
이후 상태의 핵심은 최신성을 검증할 수 있다는 사실입니다. PR 리뷰를 걸 수 있고, 변경 이력을 볼 수 있고, 모의 훈련에서 실제로 써 본 뒤 부족한 부분을 바로 수정할 수 있습니다.
...
이 방식의 장점은 runbook 형식이 일관되고, 서비스가 추가될 때마다 config만 바꿔 빠르게 생성할 수 있다는 사실입니다. 템플릿을 수정하면 모든 runbook을 한 번에 업데이트할 수도 있습니다.
