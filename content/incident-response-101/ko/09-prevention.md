...
이후 상태에서 중요한 변화는 재발 방지의 결과물이 문서가 아니라 실행 가능한 산출물이 된다는 사실입니다. 나중에 새 팀원이 와도 문서를 읽기 전에 테스트가 먼저 실패하고, guardrail이 먼저 막아 줄 수 있습니다.
...
- **사후 분석 뒤에 왜 같은 incident가 다시 반복될까요?**
  - 먼저 사후 분석에서 나온 후속 조치를 열린 상태로 등록합니다
- **후속 조치 추적이 없으면 어떤 문제가 생길까요?**
  - 먼저 사후 분석에서 나온 후속 조치를 열린 상태로 등록합니다
- **회귀 테스트는 왜 재발 방지의 핵심일까요?**
  - 먼저 사후 분석에서 나온 후속 조치를 열린 상태로 등록합니다. 추적의 시작점은 무엇을 할지를 명시하는 일입니다.
