...
- profile은 언제 복잡성을 줄여 줄까요?
- `.env`와 변수 치환은 어떤 식으로 사용하는 편이 좋을까요?

> Compose의 핵심은 멀티 컨테이너 환경을 한 번의 명령으로 띄우는 데 있지 않습니다. 더 중요한 점은 그 환경의 구조와 의존 관계를 기억이 아니라 선언으로 남긴다는 데 있습니다.
