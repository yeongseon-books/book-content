...
이 관점에서 보면 손실 함수는 metric과 다릅니다. metric은 결과를 평가하는 데 초점이 있고, 손실 함수는 gradient를 제공해 학습을 가능하게 하는 데 초점이 있습니다. 물론 둘이 비슷할 수도 있지만, 실무에서는 “잘 측정되는 것”과 “잘 학습되는 것”을 구분해서 봐야 할 때가 많습니다.
