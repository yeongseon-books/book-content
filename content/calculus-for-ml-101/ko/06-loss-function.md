...
이 글은 Calculus for ML 101 시리즈의 6번째 글입니다.
...
이 gradient는 예측이 정답보다 크면 음의 방향, 작으면 양의 방향으로 업데이트 신호를 만듭니다. 여기서 중요한 것은 손실 함수가 단순히 “틀렸다”를 말하는 데서 끝나지 않고, “어느 쪽으로 얼마나 수정할지”까지 제공한다는 사실입니다.
