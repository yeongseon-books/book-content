...
- 중간 단계 중 하나의 gradient가 0이면 왜 전체 경로가 막힐 수 있을까요?
- 연쇄 법칙은 backpropagation과 어떤 관계를 가질까요?
...
## 연쇄 법칙을 이해하는 가장 좋은 방법: 각 단계를 따로 미분한 뒤 연결 경로를 따라 곱하는 것입니다
...
![핵심 개념](https://yeongseon-books.github.io/book-public-assets/assets/calculus-for-ml-101/05/05-01-concept-at-a-glance.ko.png)
