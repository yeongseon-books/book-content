...
- **머신러닝에서 말하는 학습은 왜 미분과 직접 연결될까요?**
  - 이 절에서는 미분이 실제 학습 루프에서 어떻게 사용되는지 처음부터 끝까지 추적합니다.
- **평균 변화율과 순간 변화율은 무엇이 다르고, 왜 둘을 구분해야 할까요?**
  - 평균 변화율과 순간 변화율은 무엇이 다르고, 왜 둘을 구분해야 할까요 — 본문에서 구체적으로 다룹니다.
- **접선의 기울기와 도함수는 어떤 관계로 이해하면 가장 실용적일까요?**
  - 접선의 기울기와 도함수는 어떤 관계로 이해하면 가장 실용적일까요 — 본문에서 구체적으로 다룹니다.
- **왜 이 글이 중요한가에서 가장 흔한 실수는 무엇일까요?**
  - 경사하강법은 손실을 줄이는 방향으로 이동하는 절차이고, 그 방향은 미분에서 나옵니다. 역전파는 거대한 합성함수의 미분을 효율적으로 계산하는 방법입니다.
- **핵심 관점을 실무에 적용할 때 주의할 점은 무엇일까요?**
  - 미분을 가장 실용적으로 이해하는 방법은 "한 점에서 함수값이 얼마인가"보다 "그 점 근처에서 조금 움직이면 함수가 어떻게 반응하는가"를 보는 것입니다.
- **핵심 개념의 핵심 원리를 한 문장으로 설명하면 무엇일까요?**
  - 미분을 가장 실용적으로 이해하는 방법은 "한 점에서 함수값이 얼마인가"보다 "그 점 근처에서 조금 움직이면 함수가 어떻게 반응하는가"를 보는 것입니다.
...
- **Calculus for ML 101 (1/10): 미분이란 무엇인가 (현재 글)**
