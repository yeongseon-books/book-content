...
앞 장에서는 **RAG 입문 — 내 데이터로 답하는 AI 만들기**을 다뤘습니다.
이 장을 마치면 다음 장에서 **AI 웹 앱 배포하기: Vercel과 Azure에 올리고 운영하기**으로 이어집니다.
<!-- ebook-only:end -->
...
<!-- blog-only:start -->
다음 글: [AI 웹 앱 배포하기: Vercel과 Azure에 올리고 운영하기](./06-deploy.md)
<!-- blog-only:end -->
<!-- toc:begin -->
## 시리즈 목차
