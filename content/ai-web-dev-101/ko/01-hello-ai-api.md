...
- 첫 호출이 실패하면 인증, 모델 이름, 요청 형식 중 무엇부터 봐야 할까요?

> AI API는 완성된 챗봇을 가져다 쓰는 기능이 아니라, 외부 모델을 내 애플리케이션의 한 컴포넌트처럼 호출하는 인터페이스입니다. 그래서 핵심은 “질문을 잘한다”보다 “요청과 응답의 계약을 읽을 수 있다”에 있습니다.
