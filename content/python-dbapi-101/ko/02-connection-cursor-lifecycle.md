...
- `close()`를 빼먹으면 운영에서는 어떤 증상으로 드러날까요?

> Connection은 통신 채널이자 transaction scope이고, cursor는 그 채널 위에서 한 번의 query를 실행하는 작업 단위입니다. 이 구분이 흐려지면 누수와 락이 함께 생깁니다.

## 1. Connection이란

![Connection이란](../../../assets/python-dbapi-101/02/02-02-1-what-a-connection-is.en.png)
...
![Context manager로 안전하게](../../../assets/python-dbapi-101/02/02-03-3-safe-use-with-context-managers.en.png)
...
![Connection 재사용 vs 매번 열기](../../../assets/python-dbapi-101/02/02-04-5-reusing-vs-reopening-a-connection.en.png)
