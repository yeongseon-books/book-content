...
![PEP 249 예외 계층과 SQLite 에러 처리](../../../assets/python-dbapi-101/07/07-01-pep-249-exception-hierarchy-and-sqlite-e.en.png)
...
![Mental Model - 예외는 에러 처리 방향의 신호](../../../assets/python-dbapi-101/07/07-02-mental-model-an-exception-is-a-signal-ab.en.png)
...
![핵심 개념: SQLite 에러 코드와 PEP 249 매핑](../../../assets/python-dbapi-101/07/07-03-core-concept-sqlite-error-codes-and-the.en.png)
...
![단계별 실습: 안전한 retry 데코레이터 만들기](../../../assets/python-dbapi-101/07/07-04-step-by-step-building-a-safe-retry-decor.en.png)
