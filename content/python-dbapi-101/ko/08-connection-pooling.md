...
![SQLite Connection 관리: thread-safety, check_same_thread, 그리고 풀링](../../../assets/python-dbapi-101/08/08-01-sqlite-connection-management-thread-safe.en.png)
...
![Mental Model: connection은 "파일을 연 핸들"이다](../../../assets/python-dbapi-101/08/08-02-mental-model-a-connection-is-a-file-hand.en.png)
...
![핵심 개념](../../../assets/python-dbapi-101/08/08-03-core-concepts.en.png)
...
![단계별 실습: FastAPI에서 SQLite를 안전하게 쥐기](../../../assets/python-dbapi-101/08/08-04-step-by-step-holding-sqlite-safely-in-fa.en.png)
