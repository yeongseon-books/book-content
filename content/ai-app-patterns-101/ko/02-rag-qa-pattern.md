...
질문: 파이썬은 누가 만들었나요?
답변: 파이썬은 귀도 반 로섬이 만든 고수준 프로그래밍 언어입니다.

질문: 파이썬의 단점은 무엇인가요?
답변: 제공된 문서에서 파이썬의 단점에 대한 내용은 없습니다.

질문: 파이썬 2는 언제 지원이 종료됐나요?
답변: 파이썬 2의 공식 지원이 2020년 1월에 종료되었습니다.

질문: 파이썬으로 iOS 앱을 만들 수 있나요?
답변: 제공된 문서에서 찾을 수 없습니다.

질문: 러스트 언어의 특징은 무엇인가요?
답변: 제공된 문서에서 찾을 수 없습니다.
```
...
```
출력 결과
답변: 파이썬은 귀도 반 로섬(Guido van Rossum)이 만든 고수준 프로그래밍 언어입니다.
출처: ['python_intro.txt', 'python_cons.txt']
```
