...
- 문서 요약에서 가장 흔한 실수는 무엇일까요?
- 긴 문서 요약 — Map-Reduce을 실무에 적용할 때 주의할 점은 무엇일까요?
- 정보 추출의 핵심 원리를 한 문장으로 설명하면 무엇일까요?
...
- **긴 문서는 언제 Map-Reduce 요약처럼 단계적으로 나눠야 할까요?**
  문서가 모델 컨텍스트를 넘으면 섹션별 의미가 중요하면 조각별 요약 후 합치는 Map-Reduce 구조가 필요합니다.
