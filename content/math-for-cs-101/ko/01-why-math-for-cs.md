...
이 글은 Math for CS 101 시리즈의 첫 번째 글입니다.
...
- 한 장으로 보는 Math for CS의 역할을 실무에 적용할 때 주의할 점은 무엇일까요?
- 다섯 단계로 보는 수학적 사고의 핵심 원리를 한 문장으로 설명하면 무엇일까요?

개발 현장에서 자주 벌어지는 오해가 하나 있습니다. 코드가 한 번 돌아가면 설계도 맞는 것처럼 느껴진다는 사실입니다. 하지만 실행 성공은 대개 일부 입력, 일부 시점, 일부 환경에 대한 확인일 뿐입니다. 보편적인 올바름, 성능의 상한, 데이터 모델의 경계는 따로 설명해야 합니다.
...
이 시리즈를 따라갈 때 가장 먼저 잡아 둘 문장은 이것입니다. **수학은 정답을 외우는 과목이 아니라 문제를 압축해서 보는 방법**이라는 사실입니다. 저는 이 감각이 잡히면 이후의 모든 주제가 훨씬 쉬워진다고 봅니다.
...
첫 글에서 꼭 남겨야 할 핵심은 수학이 한 과목이 아니라 문제 유형별 도구 모음이라는 사실입니다. 아래 표는 개발자가 자주 만나는 CS 영역을 어떤 수학 관점으로 읽을지 빠르게 연결합니다.
...
- **Math for CS 101 (1/10): CS에 수학이 필요한 이유 (현재 글)**
