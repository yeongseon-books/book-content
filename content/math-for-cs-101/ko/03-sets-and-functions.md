...
![한 장으로 보는 집합과 함수](https://yeongseon-books.github.io/book-public-assets/assets/math-for-cs-101/03/03-01-concept-at-a-glance.ko.png)
*집합은 경계를, 함수는 변환 규칙을 설명합니다. 두 축이 함께 있어야 데이터 구조와 흐름이 또렷해집니다.*
