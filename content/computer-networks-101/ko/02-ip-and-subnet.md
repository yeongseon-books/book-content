...
![CIDR가 네트워크와 호스트를 나누는 방식](https://yeongseon-books.github.io/book-public-assets/assets/computer-networks-101/02/02-01-concept-at-a-glance.ko.png)
*CIDR prefix가 주소를 네트워크 부분과 호스트 부분으로 나누고, 라우터가 그 경계를 기준으로 다음 홉을 고릅니다.*
