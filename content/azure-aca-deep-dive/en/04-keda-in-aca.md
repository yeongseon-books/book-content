...
The previous chapter covered **Revisions and traffic splitting — where Envoy weights come from**.
After this chapter, the next one moves on to **Dapr sidecar internals — the Go process that lives next to your container**.
<!-- ebook-only:end -->
