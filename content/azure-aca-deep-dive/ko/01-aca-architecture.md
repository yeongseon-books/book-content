---
title: "Azure Container Apps Deep Dive (1/6): ACA 아키텍처 — 사용자에게 보이지 않는 Kubernetes 위에 얹은 것"
...
이 그림에서는 ACA 아키텍처 — 사용자에게 보이지 않는 Kubernetes 위에 얹은 것를 운영 흐름 안에서 어디에 배치해야 하는지 봅니다. 핵심은 개념을 따로 외우는 것이 아니라 입력, 처리, 검증, 운영 신호가 어떤 경계로 이어지는지 확인하는 데 있습니다.

> ACA 아키텍처 — 사용자에게 보이지 않는 Kubernetes 위에 얹은 것의 핵심은 기능 이름이 아니라, 어떤 경계에서 무엇을 검증하고 어떤 신호를 남길지 정하는 데 있습니다.
...
![선언 계층과 런타임 번역 계층](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/01/01-02-a-simpler-model-aca-is-a-product-surface.ko.png)
...
![Environment가 묶는 네트워크·로그·Dapr 경계](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/01/01-03-what-the-environment-really-is.ko.png)
...
![Revision 중심 운영 제어 구조](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/01/01-05-revisions-are-the-operational-center-of.ko.png)
...
![ACA scale rule과 KEDA 번역 경로](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/01/01-06-why-keda-matters-even-if-you-never-see-a.ko.png)
...
![앱 컨테이너와 daprd 사이드카 결합 구조](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/01/01-07-dapr-in-aca-is-not-a-mock-integration.ko.png)
...
![Ingress 설정과 Envoy 라우팅 연결](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/01/01-08-envoy-is-where-ingress-becomes-runtime-r.ko.png)
...
![ACA control plane과 data plane 분리](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/01/01-09-control-plane-versus-data-plane-in-aca.ko.png)
...
- **ACA는 정확히 어떤 추상화 위에 어떤 추상화를 올린 서비스일까요?**
  - 본문의 기준은 ACA 아키텍처 — 사용자에게 보이지 않는 Kubernetes 위에 얹은 것를 한 덩어리 개념으로 보지 않고 입력, 처리, 검증, 운영 신호가 만나는 경계로 나누어 확인하는 것입니다.
- **AKS와 비교할 때 Microsoft가 대신 떠안는 운영 책임과 사용자가 여전히 이해해야 할 책임은 무엇일까요?**
...
- **Azure Container Apps Deep Dive (1/6): ACA 아키텍처 — 사용자에게 보이지 않는 Kubernetes 위에 얹은 것 (현재 글)**
- Azure Container Apps Deep Dive (2/6): Environment 내부 — 네트워크·관측·Dapr 스코프의 경계 (예정)
