...
- scale-to-zero Revision의 첫 요청이 느릴 수 있는 이유는 무엇일까요?
- Ingress 장애를 볼 때 어떤 순서로 경로를 따라가야 할까요?
...
## Ingress를 이해하는 가장 좋은 방법: 문서화된 ingress 표면과 추론된 런타임 경로를 분리해 보는 것입니다
...
![End-to-end ingress path to the pod](../../../assets/azure-aca-deep-dive/06/06-01-start-with-the-full-path-not-with-the-ap.ko.png)
...
![Managed edge and Envoy routing split](../../../assets/azure-aca-deep-dive/06/06-02-the-load-balancer-is-the-first-managed-e.ko.png)
...
![TLS termination and internal HTTP forwarding](../../../assets/azure-aca-deep-dive/06/06-03-tls-ends-at-ingress-not-at-your-containe.ko.png)
...
![Forwarded headers and original request context](../../../assets/azure-aca-deep-dive/06/06-04-forwarded-headers-are-part-of-the-ingres.ko.png)
...
![Revision routing before the service hop](../../../assets/azure-aca-deep-dive/06/06-05-the-routing-step-happens-before-the-serv.ko.png)
...
![Envoy weights across revision upstreams](../../../assets/azure-aca-deep-dive/06/06-06-envoy-weight-means-upstream-cluster-weig.ko.png)
...
![Service-style fan-out behind ingress routing](../../../assets/azure-aca-deep-dive/06/06-07-the-service-hop-is-easy-to-forget-becaus.ko.png)
...
![Revision readiness and ready replica availability](../../../assets/azure-aca-deep-dive/06/06-08-readiness-is-part-of-the-ingress-path-wh.ko.png)
...
![Wake-up path for a scale-to-zero revision](../../../assets/azure-aca-deep-dive/06/06-09-the-first-request-to-a-scale-to-zero-rev.ko.png)
...
![Hidden stages behind first-request latency](../../../assets/azure-aca-deep-dive/06/06-10-why-the-first-request-can-feel-slower-ev.ko.png)
...
![Dapr participation inside the target pod](../../../assets/azure-aca-deep-dive/06/06-11-dapr-adds-another-runtime-participant-be.ko.png)
...
![Internal ingress on the same routing shape](../../../assets/azure-aca-deep-dive/06/06-12-internal-ingress-follows-the-same-broad.ko.png)
...
![Ordered ingress debugging checks](../../../assets/azure-aca-deep-dive/06/06-13-a-practical-ingress-debugging-ladder.ko.png)
...
![Full ACA request path end to end](../../../assets/azure-aca-deep-dive/06/06-14-the-whole-request-path-in-one-diagram.ko.png)
