---
title: "Azure Container Apps Deep Dive (5/6): Dapr 사이드카 내부 — 컨테이너 옆에 뜨는 Go 프로세스"
...
![Azure Container Apps Deep Dive 5장 흐름 개요](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-01-the-shortest-accurate-sentence.ko.png)

*Azure Container Apps Deep Dive 5장 흐름 개요*

이 그림에서는 Dapr 사이드카 내부 — 컨테이너 옆에 뜨는 Go 프로세스를 운영 흐름 안에서 어디에 배치해야 하는지 봅니다. 핵심은 개념을 따로 외우는 것이 아니라 입력, 처리, 검증, 운영 신호가 어떤 경계로 이어지는지 확인하는 데 있습니다.
...
![Sidecar injection through pod mutation](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-02-start-with-the-pod-mutation-model.ko.png)
...
![Injected daprd process and container shape](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-01-the-sidecar-container-is-literally-daprd.ko.png)
...
![Bootstrap path from main.go to runtime](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-04-boot-path-main-go-to-app-run-to-runtime.ko.png)
...
![Dapr HTTP and gRPC ports](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-05-the-sidecar-ports-are-concrete-and-impor.ko.png)
...
![Localhost API boundary between app and sidecar](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-06-why-localhost-matters-so-much.ko.png)
...
![Environment components and sidecar loading scope](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-07-component-loading-is-where-aca-s-environ.ko.png)
...
![App-level enablement with environment dependencies](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-08-enabling-dapr-in-aca-is-an-app-level-swi.ko.png)
...
![Building-block and operational Dapr APIs](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-09-dapr-is-not-only-the-building-block-apis.ko.png)
...
![App calls and sidecar callbacks as dual channels](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-10-app-to-sidecar-and-sidecar-to-app-are-se.ko.png)
...
![Sidecar logs in the incident timeline](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-11-why-sidecar-logs-belong-in-your-incident.ko.png)
...
![Full lifecycle of the Dapr sidecar](https://yeongseon-books.github.io/book-public-assets/assets/azure-aca-deep-dive/05/05-12-putting-the-whole-sidecar-lifecycle-in-o.ko.png)
...
- **ACA에서 Dapr를 켠다는 것은 런타임에 정확히 무엇이 추가된다는 뜻일까요?**
  - 본문의 기준은 Dapr 사이드카 내부 — 컨테이너 옆에 뜨는 Go 프로세스를 한 덩어리 개념으로 보지 않고 입력, 처리, 검증, 운영 신호가 만나는 경계로 나누어 확인하는 것입니다.
- **sidecar injection은 어떤 upstream 모델로 이해하는 편이 가장 정확할까요?**
...
- **Azure Container Apps Deep Dive (5/6): Dapr 사이드카 내부 — 컨테이너 옆에 뜨는 Go 프로세스 (현재 글)**
