...
![서비스 레이어가 리포지토리, 외부 API, 이벤트를 조율하는 구조](https://yeongseon-books.github.io/book-public-assets/assets/backend-development-101/04/04-01-concept-at-a-glance.ko.png)

*서비스 레이어가 리포지토리, 외부 API, 이벤트를 조율하는 구조*
