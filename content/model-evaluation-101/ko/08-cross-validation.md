...
![여러 폴드 점수를 평균과 분산으로 읽는 교차 검증 구조](https://yeongseon-books.github.io/book-public-assets/assets/model-evaluation-101/08/08-01-concept-at-a-glance.ko.png)

*여러 폴드 점수를 평균과 분산으로 읽는 교차 검증 구조*
