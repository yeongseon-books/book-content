...
![한눈에 보는 개념](https://yeongseon-books.github.io/book-public-assets/assets/api-design-101/05/05-01-concept-at-a-glance.ko.png)
*입구에서는 입력을 검증하고, 출구에서는 내부 객체를 안정된 응답 형태로 직렬화합니다.*
