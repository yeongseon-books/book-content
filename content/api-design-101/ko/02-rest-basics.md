...
published_to:
  tistory:
    url: "https://yeongseonchoe.tistory.com/194"
...
이 글은 API Design 101 시리즈의 2번째 글입니다.
...
- REST의 탄생과 핵심 정의에서 가장 흔한 실수는 무엇일까요?
- 여섯 가지 아키텍처 제약을 실무에 적용할 때 주의할 점은 무엇일까요?
- 전후 비교: 같은 기능, 다른 설계의 핵심 원리를 한 문장으로 설명하면 무엇일까요?
...
- **REST는 어디서 나왔고 무엇을 뜻할까요?**
  - REST(Representational State Transfer)는 Roy Fielding이 2000년 박사 논문에서 정의한 아키텍처 스타일입니다.
- **REST를 이루는 여섯 가지 아키텍처 제약은 무엇일까요?**
  - REST를 구성하는 제약은 다음 여섯 가지입니다. 각각은 독립적인 이점을 주지만, 함께 적용될 때 웹 규모의 확장성을 만들어 냅니다.
- **리소스 중심 사고는 RPC 스타일과 어떻게 다를까요?**
  - REST의 핵심을 가장 빠르게 이해하는 방법은 RPC 스타일과 비교하는 것입니다.
...
- **API Design 101 (2/10): REST 기본 (현재 글)**
