...
- `docker run`은 실제로 어떤 흐름으로 첫 컨테이너를 띄울까요?
- 입문자가 가장 자주 헷갈리는 실수는 무엇일까요?

> 컨테이너는 작은 VM이 아니라, 호스트 커널을 공유하는 격리된 프로세스 묶음입니다. 이 한 문장을 먼저 잡아 두면 이미지, 런타임, 오케스트레이션까지 모두 같은 방향으로 이해할 수 있습니다.
