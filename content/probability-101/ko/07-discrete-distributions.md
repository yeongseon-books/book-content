...
- 시간당 도착 건수는 왜 포아송분포로 자주 모델링할까요?
- 같은 카운트 데이터라도 왜 분포 선택이 달라질 수 있을까요?

> 이산분포는 값을 세는 세계의 재사용 가능한 모델이며, 문제 상황을 어떤 분포에 매핑하느냐가 해석의 절반입니다.
...
![핵심 개념 한눈에 보기](https://yeongseon-books.github.io/book-public-assets/assets/probability-101/07/07-01-diagram.ko.png)
