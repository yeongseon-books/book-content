...
이 글은 Probability 101 시리즈의 10번째 글입니다. 여기서는 확률이 손실함수, 모델 출력, 보정 지표, 베이지안 추론 안에 어떻게 들어가 있는지 한 흐름으로 묶어 보겠습니다.
...
- 정확도와 확률 보정은 왜 다른 축일까요?
- 베이지안 관점은 ML에서 언제 특히 유용할까요?

> 머신러닝은 정답만 찍는 시스템이 아니라, 입력이 주어졌을 때 결과에 대한 불확실성을 정리하고 그 불확실성을 비용과 연결하는 시스템에 가깝습니다.
