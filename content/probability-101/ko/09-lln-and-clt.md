...
- 비정규 모집단에서도 왜 평균은 정규에 가까워질까요?
- CLT를 아무 상황에나 쓰면 왜 위험할까요?

> 대수의 법칙은 평균이 맞는 방향으로 간다는 사실을 말하고, 중심극한정리는 그 오차가 어떤 모양으로 흔들리는지 말합니다.
...
![핵심 개념 한눈에 보기](https://yeongseon-books.github.io/book-public-assets/assets/probability-101/09/09-01-diagram.ko.png)
