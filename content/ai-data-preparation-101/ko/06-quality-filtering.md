...
수집이 끝났다고 해서 곧바로 학습 가능한 데이터가 되는 것은 아닙니다. 광고, 스팸, 깨진 인코딩, 의미 없는 boilerplate를 얼마나 잘 걸러내느냐가 이후 학습 품질을 크게 좌우합니다.

이 글은 AI Data Preparation 101 시리즈의 6번째 글입니다. 여기서는 heuristic 규칙과 classifier 기반 접근을 함께 써서 학습 가치가 낮은 샘플을 걸러내는 방법을 다룹니다.
